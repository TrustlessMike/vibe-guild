...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(e,t,n){let r=new Float32Array(Ds),i=new H(0,1,0);return new Va({name:`SphericalGaussianBlur`,defines:{n:Ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ws(),fragmentShader:`
	...
	`}var Gs=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ya(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `+e.fragmentShader.replace(`#include <roughnessmap_fragment>`,`#include <roughnessmap_fragment>
        ...
        }`)},e.customProgramCacheKey=()=>`detail:${t}`,e.needsUpdate=!0}function Up(e){if(!e?.isMeshStandardMaterial)return;let t=Rp(e.name);t&&Hp(e,t)}function Wp(e){let t=0,n=new Set;return e.traverse(e=>{if(e.isMesh)for(let r of Array.isArray(e.material)?e.material:[e.material]){if(!r||!r.isMeshStandardMaterial)continue;let e=Rp(r.name);e?(Hp(r,e),t++):r.name&&!Lp.test(r.name)&&n.add(r.name)}}),{matched:t,missed:[...n]}}function Gp(e){return Object.keys(e.attributes).sort().join(`,`)+(e.index?`|i`:``)}function Kp(e,t=new Set){e.updateMatrixWorld(!0);let n=e=>{for(let n=e;n;n=n.parent)if(t.has(n))return!0;return!1},r=new Map,i=0;e.traverse(e=>{if(!e.isMesh||!e.geometry||(i++,n(e))||Array.isArray(e.material))return;let t=`${e.material.uuid}|${Gp(e.geometry)}|${+!!e.castShadow}${+!!e.receiveShadow}`,a=r.get(t);a||r.set(t,a={material:e.material,meshes:[]}),a.meshes.push(e)});let a=new En;a.name=`StaticBatch`;let o=0;for(let{material:e,meshes:t}of r.values()){if(t.length<2)continue;let n=t.map(e=>{let t=e.geometry.clone();return t.applyMatrix4(e.matrixWorld),t}),r;try{r=Au(n,!1)}catch{r=null}if(n.forEach(e=>e.dispose()),!r)continue;let i=new _i(r,e);i.castShadow=t[0].castShadow,i.receiveShadow=t[0].receiveShadow,i.matrixAutoUpdate=!1,i.updateMatrix(),a.add(i),o++;for(let e of t)e.parent?.remove(e),e.geometry.dispose()}e.traverse(e=>{e.isMesh&&!n(e)&&(e.matrixAutoUpdate=!1,e.updateMatrix())});let s=0;return e.traverse(e=>{e.isMesh&&s++}),a.traverse(e=>{e.isMesh&&s++}),{group:a,before:i,after:s,merged:o}}function qp(e){let t=new Map,n=0,r=0,i=e=>e&&e.isMeshStandardMaterial&&!e.map&&!e.normalMap&&!e.emissiveMap&&!e.transparent&&e.opacity===1&&(!e.emissive||e.emissive.getHex()===0);return e.traverse(e=>{if(!e.isMesh||!e.geometry||Array.isArray(e.material))return;let a=e.material;if(!i(a))return;let o=(e,t)=>(Math.round(e/t)*t).toFixed(2),s=`${Rp(a.name)||`plain`}|${o(a.roughness,.15)}|${o(a.metalness,.34)}|${+!!a.flatShading}|${a.side}`,c=t.get(s);c||(c=a.clone(),c.color.setRGB(1,1,1),c.vertexColors=!0,c.roughness=parseFloat(o(a.roughness,.15)),c.metalness=parseFloat(o(a.metalness,.34)),c.name=`${a.name}_folded`,c.userData={...a.userData},delete c.userData.detailed,Up(c),t.set(s,c),r++);let l=e.geometry,u=l.attributes.position.count;l.userData._foldedFor!==void 0&&l.userData._foldedFor!==a.uuid&&(e.geometry=l.clone());let d=e.geometry,f=new Float32Array(u*3),{r:p,b:m,g:h}=a.color;for(let e=0;e<u;e++)f[e*3]=p,f[e*3+1]=h,f[e*3+2]=m;d.setAttribute(`color`,new mr(f,3)),d.userData._foldedFor=a.uuid,e.material=c,n++}),{folded:n,families:r}}function Jp(e){let t=new G,n=new G,r=0,i=0,a=0;for(let o of e){o.updateMatrixWorld(!0);let e=[];if(o.traverse(t=>{t.isMesh&&t.geometry&&!Array.isArray(t.material)&&e.push(t)}),r+=e.length,e.length<2){i+=e.length;continue}t.copy(o.matrixWorld).invert();let s=new Map;for(let t of e){let e=`${t.material.uuid}|${Gp(t.geometry)}|${+!!t.castShadow}${+!!t.receiveShadow}`,n=s.get(e);n||s.set(e,n={material:t.material,meshes:[]}),n.meshes.push(t)}if(s.size===e.length){i+=e.length;continue}let c=!0,l=[];for(let{material:e,meshes:r}of s.values()){if(r.length<2){l.push(null);continue}let i=r.map(e=>{let r=e.geometry.clone();return n.multiplyMatrices(t,e.matrixWorld),r.applyMatrix4(n),r}),a=null;try{a=Au(i,!1)}catch{a=null}if(i.forEach(e=>e.dispose()),!a){c=!1;break}let o=new _i(a,e);o.castShadow=r[0].castShadow,o.receiveShadow=r[0].receiveShadow,l.push({mesh:o,replaced:r})}if(!c){l.forEach(e=>e?.mesh.geometry.dispose()),i+=e.length;continue}for(let e of l)if(e){for(let t of e.replaced)t.parent?.remove(t),t.geometry.dispose();o.add(e.mesh),a++}let u=0;o.traverse(e=>{e.isMesh&&u++}),i+=u}return{before:r,after:i,collapsed:a}}var Yp=.5,Xp=class{constructor(e,t){let n=1/0,r=1/0,i=-1/0,a=-1/0;for(let t of e)n=Math.min(n,t.x1,t.x2),i=Math.max(i,t.x1,t.x2),r=Math.min(r,t.z1,t.z2),a=Math.max(a,t.z1,t.z2);this.minX=n-2,this.minZ=r-2,this.nx=Math.ceil((i-n+4)/Yp),this.nz=Math.ceil((a-r+4)/Yp),this.ny=Math.ceil((t+1)/Yp),this.grid=new Uint8Array(this.nx*this.ny*this.nz);for(let t of e)this._stamp(t)}_idx(e,t,n){return(t*this.nz+n)*this.nx+e}_stamp(e){let t=e.x2-e.x1,n=e.z2-e.z1,r=Math.hypot(t,n);if(!r)return;let i=Math.ceil(r/(Yp*.5)),a=Math.max(Yp,e.thickness??.3),o=-n/r,s=t/r,c=e.yMin??0,l=e.yMax??3.4;for(let r=0;r<=i;r++){let u=r/i,d=e.x1+t*u,f=e.z1+n*u;for(let e=-1;e<=1;e++){let t=d+o*(e*a*.5),n=f+s*(e*a*.5),r=Math.floor((t-this.minX)/Yp),i=Math.floor((n-this.minZ)/Yp);if(!(r<0||i<0||r>=this.nx||i>=this.nz))for(let e=Math.floor(c/Yp);e<=Math.min(this.ny-1,Math.floor(l/Yp));e++)this.grid[this._idx(r,e,i)]=1}}}solid(e,t,n){if(t<0)return!0;let r=Math.floor((e-this.minX)/Yp),i=Math.floor((n-this.minZ)/Yp),a=Math.floor(t/Yp);return r<0||i<0||a<0||r>=this.nx||i>=this.nz||a>=this.ny?!1:this.grid[this._idx(r,a,i)]===1}};function Zp(e){let t=[],n=Math.PI*(3-Math.sqrt(5));for(let r=0;r<e;r++){let i=1-r/(e-1)*.85,a=Math.sqrt(Math.max(0,1-i*i)),o=n*r;t.push(new H(Math.cos(o)*a,i,Math.sin(o)*a))}return t}var Qp=Zp(10),$p=[.35,.8,1.5],em=[3,1.6,.7];function tm(e){let t=e.attributes.position;if(!t||t.count<12)return!0;e.computeBoundingBox();let n=new H;return e.boundingBox.getSize(n),2*(n.x*n.y+n.y*n.z+n.z*n.x)/t.count>nm}var nm=.6;function rm(e,t,n={}){let r=n.strength??.55,i=new Xp(t,n.wallHeight??3.4),a=performance.now(),o=new H,s=new H,c=new H,l=new H,u=new H,d=0,f=0,p=0;return e.updateMatrixWorld(!0),e.traverse(e=>{if(!e.isMesh||!e.geometry)return;let t=e.geometry,n=t.attributes.color,a=t.attributes.position,m=t.attributes.normal;if(!(!n||!a||!m)){if(tm(t)){p++;return}f++;for(let t=0;t<a.count;t++){o.fromBufferAttribute(a,t).applyMatrix4(e.matrixWorld),s.fromBufferAttribute(m,t).transformDirection(e.matrixWorld).normalize(),c.set(s.z,0,-s.x),c.lengthSq()<1e-6&&c.set(1,0,0),c.normalize(),l.crossVectors(s,c);let f=0,p=0;for(let e of Qp){u.set(c.x*e.x+s.x*e.y+l.x*e.z,c.y*e.x+s.y*e.y+l.y*e.z,c.z*e.x+s.z*e.y+l.z*e.z);for(let e=0;e<$p.length;e++){let t=$p[e],n=em[e];p+=n,i.solid(o.x+u.x*t+s.x*.12,o.y+u.y*t+s.y*.12,o.z+u.z*t+s.z*.12)&&(f+=n)}}let h=p?f/p:0,g=Math.max(1-r,1-h*r);n.setXYZ(t,n.getX(t)*g,n.getY(t)*g,n.getZ(t)*g),d++}n.needsUpdate=!0}}),{meshes:f,skipped:p,vertices:d,ms:+(performance.now()-a).toFixed(0)}}var im={vanguard:{name:`Vanguard`,blurb:`Balanced. Three-hit chains.`,detail:`No weakness, no trick. Chains light into light into heavy.`,mods:{chainDepth:3}},bulwark:{name:`Bulwark`,blurb:`Blocking costs nothing. Slow.`,detail:`Holds the line. Blocked heavies do not drain you, and a matched guard turns aside a fifth of the damage — but every swing is slower.`,mods:{windupMul:1.14,blockStaminaMul:0,guardReduction:.2,chainDepth:2,healthMul:1.08}},berserker:{name:`Berserker`,blurb:`Faster as you bleed.`,detail:`Swings 12% quicker, and hits harder the closer you are to death — but you have less to give.`,mods:{windupMul:.88,damageMul:1.05,healthMul:.86,woundedDamage:.35,chainDepth:3}},skirmisher:{name:`Skirmisher`,blurb:`Evasive. Cheap, long dodges.`,detail:`Longer invulnerability on a dodge at half the stamina, and quicker on your feet — but you hit lighter.`,mods:{dodgeIFrameMul:1.45,dodgeCostMul:.55,speedMul:1.08,damageMul:.9,chainDepth:2}},duellist:{name:`Duellist`,blurb:`Punishing parries.`,detail:`A far more forgiving parry window, and staggered opponents take much more from you — but you are fragile.`,mods:{parryWindowMul:1.5,staggeredDamageMul:1.4,healthMul:.92,chainDepth:2}}},am={none:{name:`—`,blurb:`No perk`,mods:{}},ironclad:{name:`Ironclad`,blurb:`Matched guard sheds 15% damage`,mods:{guardReduction:.15}},secondwind:{name:`Second Wind`,blurb:`A parry restores 25 stamina`,mods:{staminaOnParry:25}},sapper:{name:`Sapper`,blurb:`+1 breach charge`,mods:{gadgetBonus:{breach:1}}},quartermaster:{name:`Quartermaster`,blurb:`+1 barricade, +1 reinforcement`,mods:{gadgetBonus:{barricade:1,reinforce:1}}},executioner:{name:`Executioner`,blurb:`+30% damage to staggered foes`,mods:{staggeredDamageMul:1.3}},lightfoot:{name:`Lightfoot`,blurb:`+10% movement speed`,mods:{speedMul:1.1}},enduring:{name:`Enduring`,blurb:`+25% stamina recovery`,mods:{staminaRegenMul:1.25}},keeneye:{name:`Keen Eye`,blurb:`+25% parry window`,mods:{parryWindowMul:1.25}}},om={windupMul:1,damageMul:1,healthMul:1,speedMul:1,parryWindowMul:1,dodgeIFrameMul:1,dodgeCostMul:1,blockStaminaMul:1,staminaRegenMul:1,staggeredDamageMul:1,guardReduction:0,woundedDamage:0,staminaOnParry:0,chainDepth:2,gadgetBonus:{}};function sm(e,t=[]){let n={...om,gadgetBonus:{}},r=[im[e]?.mods].concat(t.map(e=>am[e]?.mods)).filter(Boolean);for(let e of r)for(let[t,r]of Object.entries(e))if(t===`gadgetBonus`)for(let[e,t]of Object.entries(r))n.gadgetBonus[e]=(n.gadgetBonus[e]||0)+t;else t===`guardReduction`?n.guardReduction=1-(1-n.guardReduction)*(1-r):t===`chainDepth`?n.chainDepth=Math.max(n.chainDepth,r):t.endsWith(`Mul`)?n[t]=(n[t]??1)*r:n[t]=(n[t]??0)+r;return n}var cm=Object.keys(im),lm=Object.keys(am),um=new H,dm=[{name:`Iron Blue`,hex:1781611},{name:`Blood Red`,hex:7214100},{name:`Forest`,hex:1983782},{name:`Imperial`,hex:4856924},{name:`Ash Grey`,hex:3356735},{name:`Ochre`,hex:9069080},{name:`Bone`,hex:10130044},{name:`Black`,hex:1184534}],fm=[`archetype`,`weapon`,`armour`,`perk1`,`perk2`,`heraldry`,`name`],pm=14,mm=class{constructor({armours:e,weapons:t,heraldry:n=dm}){this.armours=e,this.weapons=t,this.heraldry=n,this.armourIndex=0,this.weaponIndex=0,this.heraldIndex=0,this.archetypeIndex=0,this.perkIndex=[1,2],this.name=`Warden`,this.category=0,this.done=!1,this.dirty=!0,this.time=0,this.spin=0,this.flash=0}get armour(){return this.armours[this.armourIndex]}get weapon(){return this.weapons[this.weaponIndex]}get herald(){return this.heraldry[this.heraldIndex]}get archetypeKey(){return cm[this.archetypeIndex]}get archetype(){return im[this.archetypeKey]}perkKeyAt(e){return lm[this.perkIndex[e]]}get perkKeys(){return[this.perkKeyAt(0),this.perkKeyAt(1)]}handle(e){this._consumeText(e);let t=!1;for(let n of e.keys||[])switch(n){case`ArrowDown`:case`KeyS`:this.category=(this.category+1)%fm.length;break;case`ArrowUp`:case`KeyW`:this.category=(this.category+fm.length-1)%fm.length;break;case`ArrowRight`:case`KeyD`:this._cycle(1);break;case`ArrowLeft`:case`KeyA`:this._cycle(-1);break;case`Enter`:case`NumpadEnter`:case`Space`:this.done=!0,t=!0;break;default:break}return t}_consumeText(e){if(!(fm[this.category]!==`name`||!e.typed)){for(let t of e.typed)t===`\b`?this.name=this.name.slice(0,-1):this.name.length<pm&&/[\w '-]/.test(t)&&(this.name+=t);this.name||=` `}}_cycle(e){let t=(t,n)=>(t+e+n)%n;switch(fm[this.category]){case`armour`:this.armourIndex=t(this.armourIndex,this.armours.length),this.dirty=!0;break;case`weapon`:this.weaponIndex=t(this.weaponIndex,this.weapons.length),this.dirty=!0;break;case`heraldry`:this.heraldIndex=t(this.heraldIndex,this.heraldry.length),this.dirty=!0;break;case`archetype`:this.archetypeIndex=t(this.archetypeIndex,cm.length),this.dirty=!0;break;case`perk1`:case`perk2`:{let e=fm[this.category]===`perk1`?0:1,n=this.perkIndex[1-e];do this.perkIndex[e]=t(this.perkIndex[e],lm.length);while(this.perkIndex[e]===n&&lm[n]!==`none`);this.dirty=!0;break}default:break}this.flash=.25}update(e){this.time+=e,this.spin+=e*.32,this.flash=Math.max(0,this.flash-e)}poseCamera(e,t){t.yaw=this.spin;let n=e.aspect||1.777,r=kt.clamp(.32*n-.12,.12,.45);um.set(t.pos.x+.85,1.52,t.pos.z-3.05),e.position.copy(um),e.lookAt(t.pos.x-r,1,t.pos.z)}draw(e,t){let n=e.ctx,r=e.s,i=e.w,a=e.h;n.save();let o=Math.min(i*.62,380*r),s=n.createLinearGradient(0,0,o,0);s.addColorStop(0,`rgba(6,8,12,0.88)`),s.addColorStop(.7,`rgba(6,8,12,0.72)`),s.addColorStop(1,`rgba(6,8,12,0)`),n.fillStyle=s,n.fillRect(0,0,o,a);let c=54*r,l=96*r;n.textAlign=`left`,n.font=`800 ${13*r}px ui-sans-serif, system-ui, sans-serif`,n.letterSpacing=`${6*r}px`,n.fillStyle=`rgba(224,138,60,0.95)`,n.fillText(`CHOOSE YOUR CHAMPION`,c,l),l+=40*r,[[`ARCHETYPE`,this.archetype.name,this.archetype.blurb],[`WEAPON`,this.weapon.name,`${this.weapon.damageMul*100|0}% damage`],[`ARMOUR`,this.armour.name,`${this.armour.health} hp · ${this.armour.speedMul*100|0}% speed`],[`PERK I`,am[this.perkKeyAt(0)].name,am[this.perkKeyAt(0)].blurb],[`PERK II`,am[this.perkKeyAt(1)].name,am[this.perkKeyAt(1)].blurb],[`HERALDRY`,this.herald.name,``],[`NAME`,this.name,``]].forEach(([e,t,i],a)=>{let o=a===this.category;if(n.letterSpacing=`${2*r}px`,n.font=`600 ${10*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=o?`rgba(215,222,233,0.7)`:`rgba(215,222,233,0.32)`,n.fillText(e,c,l),n.letterSpacing=`${1*r}px`,n.font=`${o?700:500} ${19*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=o?`#f0f4fa`:`rgba(215,222,233,0.5)`,n.fillText(t,c+22*r,l+26*r),o){if(n.fillStyle=`#e08a3c`,n.fillRect(c-12*r,l-9*r,3*r,46*r),fm[a]!==`name`){let e=.55+Math.sin(this.time*5)*.25;n.globalAlpha=e,n.font=`700 ${16*r}px ui-sans-serif, system-ui, sans-serif`,n.fillText(`‹`,c+4*r,l+26*r),n.fillText(`›`,c+250*r,l+26*r),n.globalAlpha=1}else if(Math.sin(this.time*6)>0){let e=n.measureText(this.name).width;n.fillRect(c+26*r+e,l+8*r,2*r,22*r)}}i&&(n.letterSpacing=`${.5*r}px`,n.font=`500 ${10*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=o?`rgba(224,138,60,0.85)`:`rgba(215,222,233,0.28)`,n.fillText(i,c+22*r,l+41*r)),l+=58*r});let u=fm.indexOf(`heraldry`),d=c+22*r,f=96*r+40*r+58*r*u+32*r;this.heraldry.forEach((e,t)=>{let i=d+t*26*r;n.fillStyle=`#${e.hex.toString(16).padStart(6,`0`)}`,n.fillRect(i,f,18*r,12*r),n.strokeStyle=t===this.heraldIndex?`#f0f4fa`:`rgba(215,222,233,0.25)`,n.lineWidth=t===this.heraldIndex?2*r:1,n.strokeRect(i+.5,f+.5,18*r-1,12*r-1)});let p=l+6*r;this._stats(n,r,c,p,t);let m=p+62*r;n.fillStyle=`rgba(215,222,233,0.16)`,n.fillRect(c,m-20*r,300*r,1),n.letterSpacing=`${1*r}px`,n.font=`500 ${12*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=`rgba(215,222,233,0.62)`,n.fillText(`W / S   choose a row`,c,m),n.fillText(`A / D   change it`,c,m+20*r),n.fillText(`ENTER / SPACE   take the field`,c,m+40*r),n.restore()}_stats(e,t,n,r,i){let a=this.armour,o=[[`REACH`,`${(i?.reach??0).toFixed(2)} m`],[`DAMAGE`,`${Math.round((this.weapon.damageMul??1)*100)}%`],[`HEALTH`,`${a.health}`],[`SPEED`,`${Math.round((a.speedMul??1)*100)}%`]];e.letterSpacing=`${2*t}px`,o.forEach(([i,a],o)=>{let s=n+o*92*t;e.font=`600 ${9*t}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`rgba(215,222,233,0.4)`,e.fillText(i,s,r),e.font=`700 ${17*t}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`#d7dee9`,e.fillText(a,s,r+22*t)})}};function hm(e,t,n){e.root.traverse(e=>{if(!e.isMesh||!e.material)return;let r=e.material.name||``;n.test(r)&&(e.material.userData.heraldClone||(e.material=e.material.clone(),e.material.userData.heraldClone=!0,Up(e.material)),e.material.color.setHex(t))})}var gm=new H,_m=new H,vm=new At,ym=new H(0,1,0),bm=.66,xm=26,Sm=.85,Cm=3.2,wm=.22,Tm=15,Em=22,Dm=class{constructor(e){this.name=e.name,this.rig=new of(e.model),this.rig.attachWeapon(e.weapon,e.grip),this.group=new En,this.group.add(e.model),this.profile=e.profile,this.calibratedReach=2.2,this.contact=null,this.pos=new H(e.x??0,0,e.z??0),this.yaw=e.yaw??0,this.maxHealth=e.health??130,this.health=this.maxHealth,this.stamina=100,this.staminaTimer=0,this.exhausted=0,this.guard=`right`,this.state=`idle`,this.stateTime=0,this.attack=null,this.clip=xf.right,this.clipTime=0,this.clipHold=!1,this.sample=ff(),this.prevSample=ff(),this.outSample=ff(),this.fade=1,this.fadeTime=.12,this.lastFwd=0,this.lastSide=0,this.velocity=new H,this.moveInput=new V,this.feet={L:km(this.pos,.19,.2,this.yaw),R:km(this.pos,-.17,-.22,this.yaw)},this.events=[],this.gbCounterWindow=0,this.hitFlash=0,this.charge=0,this.chargeHeld=!1,this.blockedRecently=0,this.swaySeed=Math.random()*10,this.stepSide=`L`,this.stepTimer=0,this.gaitPhase=0,this.hitstunTime=.4,this.staggerScale=1,this.gbResolved=!0,this.frozen=!1,this.caltropSlow=0,this.revealedUntil=0,this.collider=null,this.faceOverride=null,this.freeLook=!1,this.traits=e.traits||sm(`vanguard`,[]),this.chainWindow=0,this.chainStep=0,this._calibrate()}setLoadout({model:e,weapon:t,grip:n,profile:r}){if(e&&e!==this.rig.root){this.group.remove(this.rig.root);let r=!!this.rig.firstPerson;this.rig=new of(e),this.group.add(e),this.rig.attachWeapon(t,n),r&&this.rig.setFirstPerson(!0)}else t&&this.rig.attachWeapon(t,n);return r&&(this.profile=r),this._calibrate(),this}_calibrate(e=.38,t=1.12){let n={pos:this.pos.clone(),yaw:this.yaw,state:this.state,clip:this.clip,clipTime:this.clipTime,fade:this.fade,attack:this.attack,feet:{L:this.feet.L.world.clone(),R:this.feet.R.world.clone()}};this.pos.set(0,0,0),this.yaw=0,this.state=`attack`,this.attack=null;let r={};for(let e of[`light`,`heavy`]){r[e]={};for(let t of cf){let n=Df[e][t],i=[],a=n.windup*.6,o=n.impact+n.recover*.4;for(let e=a;e<=o;e+=.008)this.clip=n,this.clipTime=e,this.fade=1,this._poseRig(0),i.push({t:e,p:this.rig.bladeTip(new H)});r[e][t]=i,this.events.length=0}}let i=(e,n)=>{let r=1/0;for(let i of e)r=Math.min(r,Math.hypot(i.p.x,i.p.y-t,i.p.z-n));return r},a=1.3;for(let t=1.3;t<=3.6;t+=.02){let n=!0;for(let a of[`light`,`heavy`]){for(let o of cf)if(i(r[a][o],t)>e){n=!1;break}if(!n)break}n&&(a=t)}this.calibratedReach=a,this.contact={light:{},heavy:{}},this.contactMiss={light:{},heavy:{}};for(let e of[`light`,`heavy`])for(let n of cf){let i=1/0,o=Df[e][n].impact;for(let s of r[e][n]){let e=Math.hypot(s.p.x,s.p.y-t,s.p.z-a);e<i&&(i=e,o=s.t)}this.contact[e][n]=o,this.contactMiss[e][n]=+i.toFixed(3)}Object.assign(this,{yaw:n.yaw,state:n.state,clip:n.clip,clipTime:n.clipTime,fade:n.fade,attack:n.attack}),this.pos.copy(n.pos);for(let e of[`L`,`R`]){let t=this.feet[e];t.world.copy(n.feet[e]),t.desired.copy(n.feet[e]),t.from.copy(n.feet[e]),t.to.copy(n.feet[e]),t.stepping=!1,t.t=1,t.lift=0}this.events.length=0}get alive(){return this.state!==`dead`}get reach(){return this.calibratedReach}get canAct(){return this.frozen?!1:this.state===`idle`?!0:this.state===`attack`?this.attack?this.chainWindow>0?this.clipTime>this.attack.strike:this.clipTime>this.clip.duration-this.attack.recover*.28:!0:this.state===`blockReact`?this.stateTime>.16:this.state===`parryReact`?this.stateTime>.2:this.state===`gb`&&this.clipTime>.42}get canBlock(){return this.state===`idle`||this.state===`blockReact`?!0:this.state===`parryReact`?this.stateTime>.24:this.state===`attack`?!this.attack||this.clipTime>this.clip.duration-this.attack.recover*.45:!1}get invulnerable(){let e=.25*this.traits.dodgeIFrameMul;return this.state===`dodge`&&this.stateTime>.09&&this.stateTime<.09+e}get attackPhase(){if(this.state!==`attack`)return null;let e=this.attack;return this.clipTime<e.windup?`windup`:this.clipTime<e.strike+.02?`active`:`recover`}play(e,{fade:t=.12,hold:n=!1}={}){Am(this.outSample,this.prevSample),this.fade=0,this.fadeTime=Math.max(.001,t),this.clip=e,this.clipTime=0,this.clipHold=n||!!e.hold,this.lastFwd=0,this.lastSide=0}setState(e,t,n){this.state=e,this.stateTime=0,t&&this.play(t,n)}setGuard(e){return e===this.guard?!1:(this.guard=e,this.state===`idle`&&this.play(xf[e],{fade:.09}),!0)}spend(e){this.stamina=Math.max(0,this.stamina-e),this.staminaTimer=Sm,this.stamina<=0&&this.exhausted<=0&&(this.exhausted=Cm,this.events.push({type:`exhausted`}))}startAttack(e,t=this.guard){if(!this.canAct)return!1;let n=Tf[e].stamina;if(this.stamina<n*.5)return!1;this.guard=t;let r=Df[e][t],i=this.chainWindow>0&&this.chainStep<this.traits.chainDepth;this.chainStep=i?this.chainStep+1:1,this.chainWindow=0;let a=(this.exhausted>0?1.3:1)*this.traits.windupMul*(i?.62:1);return this.attack={type:e,dir:t,windup:r.windup,strike:this.contact[e][t],recover:r.recover,chained:i,damage:Tf[e].damage*(this.profile.damageMul??1)*this.traits.damageMul*(1+this.traits.woundedDamage*(1-this.health/this.maxHealth)),resolved:!1,unblockable:!1,timeScale:1/a},this.charge=0,this.chargeHeld=e===`heavy`,this.spend(n),this.setState(`attack`,r,{fade:.07}),this.events.push({type:`swing`,attack:this.attack}),!0}openChain(){this.chainStep>=this.traits.chainDepth||(this.chainWindow=.62)}releaseCharge(){this.chargeHeld=!1}feint(){return this.state!==`attack`||this.clipTime>this.attack.windup*.82||this.stamina<8?!1:(this.spend(8),this.attack=null,this.charge=0,this.setState(`idle`,xf[this.guard],{fade:.1}),this.events.push({type:`feint`}),!0)}startGuardBreak(){return!this.canAct||this.stamina<8?!1:(this.spend(9),this.gbResolved=!1,this.gbCounterWindow=.38,this.setState(`gb`,Mf,{fade:.07}),this.events.push({type:`guardbreak`}),!0)}startDodge(e,t){if(!this.canAct&&this.state!==`blockReact`||this.stamina<10)return!1;e===0&&t===0&&(t=-1);let n=Math.hypot(e,t);return this.spend(17*this.traits.dodgeCostMul),this.setState(`dodge`,Pf(e/n,t/n),{fade:.06}),this.events.push({type:`dodge`}),!0}onBlocked(e,t){this.setState(`blockReact`,Of[e],{fade:.04}),this.blockedRecently=.5,t&&this.spend(6*this.traits.blockStaminaMul),this.exhausted>0&&t&&this.onStagger(.7)}onParrySuccess(e){this.setState(`parryReact`,kf[e],{fade:.04})}onStagger(e=1){this.attack=null,this.setState(`stagger`,jf,{fade:.05}),this.staggerScale=e,this.spend(14)}onThrown(){this.attack=null,this.setState(`thrown`,Nf,{fade:.05})}takeDamage(e,t,n){if(this.alive){if(this.health=Math.max(0,this.health-e),this.hitFlash=.28,this.health<=0){this.attack=null,this.setState(`dead`,Ff,{fade:.06,hold:!0}),this.events.push({type:`death`});return}this.attack=null,this.setState(`hitstun`,Af(t,n),{fade:.04}),this.hitstunTime=n?.6:.4}}resetForRound(){this.health=this.maxHealth,this.stamina=100,this.staminaTimer=0,this.exhausted=0,this.hitFlash=0,this.charge=0,this.chargeHeld=!1,this.caltropSlow=0,this.revealedUntil=0,this.faceOverride=null,this.gbCounterWindow=0,this.gbResolved=!0,this.blockedRecently=0,this.attack=null,this.clipHold=!1,this.velocity.set(0,0,0),this.moveInput.set(0,0),this.lastFwd=0,this.lastSide=0,this.stepTimer=0,this.gaitPhase=0,this._ghost=1,this.setState(`idle`,xf[this.guard]||xf.right,{fade:.01})}celebrate(){this.state!==`dead`&&this.setState(`victory`,If,{fade:.2,hold:!0})}update(e,t){this.stateTime+=e,this.hitFlash=Math.max(0,this.hitFlash-e),this.blockedRecently=Math.max(0,this.blockedRecently-e),this.gbCounterWindow=Math.max(0,this.gbCounterWindow-e),this.caltropSlow=Math.max(0,this.caltropSlow-e*1.6),this.chainWindow>0&&(this.chainWindow-=e,this.chainWindow<=0&&(this.chainStep=0)),this.exhausted>0&&(this.exhausted-=e),this.staminaTimer>0?this.staminaTimer-=e:this.stamina<100&&(this.stamina=Math.min(100,this.stamina+xm*(this.exhausted>0?.55:1)*this.traits.staminaRegenMul*e)),this._advanceClip(e),this._updateState(e),t&&this.alive&&this._faceOpponent(t,e),this._applyMovement(e,t),this._poseRig(e)}_advanceClip(e){let t=this.attack;if(this.state===`attack`&&t&&t.type===`heavy`&&this.chargeHeld&&this.clipTime>=t.windup&&this.charge<.75){this.charge+=e,this.charge>.26&&!t.unblockable&&(t.unblockable=!0,t.damage*=1.35,this.events.push({type:`unblockable`})),this.clipTime=t.windup;return}let n=t&&this.state===`attack`?t.timeScale:1;this.clipTime+=e*n,this.clipHold||(this.clipTime=Math.min(this.clipTime,this.clip.duration)),this.fade=Math.min(1,this.fade+e/this.fadeTime)}_updateState(e){switch(this.state){case`attack`:this.attack&&this.clipTime>=this.clip.duration&&(this.attack=null,this.setState(`idle`,xf[this.guard],{fade:.14}));break;case`blockReact`:case`parryReact`:this.clipTime>=this.clip.duration&&this.setState(`idle`,xf[this.guard],{fade:.12});break;case`hitstun`:this.stateTime>=this.hitstunTime&&this.setState(`idle`,xf[this.guard],{fade:.14});break;case`stagger`:case`thrown`:case`dodge`:case`gb`:this.clipTime>=this.clip.duration&&this.setState(`idle`,xf[this.guard],{fade:.14});break}}_faceOpponent(e,t){if(this.freeLook&&!this.faceOverride)return;this.faceOverride?(gm.set(this.faceOverride.x-this.pos.x,0,this.faceOverride.z-this.pos.z),gm.lengthSq()<1e-6&&gm.subVectors(e.pos,this.pos)):gm.subVectors(e.pos,this.pos);let n=Math.atan2(gm.x,gm.z)-this.yaw;for(;n>Math.PI;)n-=Math.PI*2;for(;n<-Math.PI;)n+=Math.PI*2;let r=this.state===`idle`?11:6;this.yaw+=n*Math.min(1,r*t)}_applyMovement(e,t){let n=(this.state===`idle`||this.state===`blockReact`)&&!this.frozen,r=gm.set(0,0,0);if(n&&this.alive){let e=(this.exhausted>0?.72:1)*(1-this.caltropSlow)*(this.profile.speedMul??1)*this.traits.speedMul,t=(this.moveInput.y>=0?2.55:2.05)*e;r.set(this.moveInput.x*2.25*e,0,this.moveInput.y*t),r.applyAxisAngle(ym,this.yaw)}_m.subVectors(r,this.velocity);let i=(r.lengthSq()>this.velocity.lengthSq()?Tm:Em)*e;_m.lengthSq()>i*i&&_m.setLength(i),this.velocity.add(_m),this.velocity.lengthSq()<1e-4&&this.velocity.set(0,0,0),this.pos.addScaledVector(this.velocity,e);let a=this.outSample,o=a.fwd-this.lastFwd,s=a.side-this.lastSide;if(this.lastFwd=a.fwd,this.lastSide=a.side,(o||s)&&Number.isFinite(o)&&Number.isFinite(s)&&(gm.set(s,0,o).applyAxisAngle(ym,this.yaw),this.pos.add(gm)),t){gm.subVectors(this.pos,t.pos),gm.y=0;let e=gm.length(),n=bm*2;e<n&&e>1e-4&&this.pos.addScaledVector(gm.normalize(),(n-e)*.5)}this.collider&&this.collider.collide(this.pos,.42);let c=Math.hypot(this.pos.x,this.pos.z);c>30&&this.pos.multiplyScalar(30/c)}push(e,t){gm.copy(e).setY(0).normalize().multiplyScalar(t),this.pos.add(gm)}_poseRig(e){this.clip.sample(Math.min(this.clipTime,this.clip.duration),this.sample);let t=this.sample;if(this.fade<1?t=pf(this.prevSample,this.sample,this.fade,this.outSample):(Am(this.sample,this.outSample),t=this.outSample),this.state===`idle`){let e=Sf(this.stateTime+this.swaySeed);t.y+=e.py,t.pose.Torso[0]+=e.pitch,t.pose.Torso[1]+=e.yaw*.4,t.pose.Head[1]-=e.yaw*.3}if(this.velocity.lengthSq()>.01){gm.copy(this.velocity).applyAxisAngle(ym,-this.yaw);let e=Om(gm.z,-2.6,2.6),n=Om(gm.x,-2.4,2.4);t.pose.Torso[0]+=e*2.3,t.pose.Torso[2]+=-n*1.9,t.pose.Hips[1]+=-n*2.6,t.pose.Head[0]-=e*.9;let r=Math.min(1,this.velocity.length()/2.4);t.y+=Math.sin(this.gaitPhase*Math.PI*2)*.018*r,t.pose.Hips[2]+=Math.sin(this.gaitPhase*Math.PI)*2.4*r}this.group.position.copy(this.pos),this.group.rotation.set(0,this.yaw,0),this.group.updateMatrixWorld(!0);let n=this.rig;n.resetPose(),n.applyPose(t.pose);let r=n.joints.Hips;r&&r.position.set(0,af+t.y,0),n.root.updateMatrixWorld(!0),this._updateFeet(e,t),vm.setFromAxisAngle(ym,this.yaw);for(let e of[`L`,`R`])n.solveLeg(e,this.feet[e].world,vm,this.feet[e].lift*55);n.setWeapon(t.p,t.b,t.roll),n.weaponAnchor.updateMatrixWorld(!0),n.solveGrips(this.profile.leadHand??`R`),n.root.updateMatrixWorld(!0)}_updateFeet(e,t){let n=this.velocity.length(),r=(this.state===`idle`||this.state===`blockReact`)&&n>.45,i=Om(.6-n*.085,.25,.6),a=Om(.3-n*.05,.13,.3),o=.045+Math.min(.085,n*.032),s=r?i*.55:.09;for(let e of[`L`,`R`]){let n=this.feet[e],r=e===`L`?t.feetL:t.feetR;gm.copy(r).applyAxisAngle(ym,this.yaw).add(this.pos),n.desired.copy(gm)}let c=this.feet.L.stepping||this.feet.R.stepping;this.stepTimer-=e,r&&!c&&this.stepTimer<=0?(this._beginStep(this.stepSide,s),this.stepSide=this.stepSide===`L`?`R`:`L`,this.stepTimer=i):r||(this.stepTimer=0);for(let t of[`L`,`R`]){let n=this.feet[t];if(n.stepping){if(n.t+=e/a,n.t>=1)n.stepping=!1,n.t=1,n.world.copy(n.to).setY(0),n.lift=0,this.events.push({type:`footstep`,side:t});else{let e=n.t,t=e*e*(3-2*e);n.world.lerpVectors(n.from,n.to,t),n.lift=Math.sin(e*Math.PI)*o,n.world.y=n.lift}continue}let i=this.feet[t===`L`?`R`:`L`],c=n.world.distanceTo(n.desired),l=r?wm*1.9:wm;c>l&&(!i.stepping||c>l*2.1)?this._beginStep(t,s):n.world.y=0}r?this.gaitPhase+=e/Math.max(.12,i):this.gaitPhase+=e*.35}_beginStep(e,t){let n=this.feet[e];n.stepping=!0,n.t=0,n.from.copy(n.world),n.to.copy(n.desired).addScaledVector(this.velocity,t),n.to.y=0}};function Om(e,t,n){return e<t?t:e>n?n:e}function km(e,t,n,r){let i=new H(t,0,n).applyAxisAngle(ym,r).add(e);return{world:i.clone(),desired:i.clone(),from:i.clone(),to:i.clone(),stepping:!1,t:1,lift:0}}function Am(e,t){t.p.copy(e.p),t.b.copy(e.b),t.roll=e.roll;for(let n in e.pose)t.pose[n][0]=e.pose[n][0],t.pose[n][1]=e.pose[n][1],t.pose[n][2]=e.pose[n][2];t.y=e.y,t.fwd=e.fwd,t.side=e.side,t.feetL.copy(e.feetL),t.feetR.copy(e.feetR)}var jm={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},Mm=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Nm=new Ho(-1,1,1,-1,0,1),Pm=new class extends kr{constructor(){super(),this.setAttribute(`position`,new _r([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new _r([0,2,0,0,2,0],2))}},Fm=class{constructor(e){this._mesh=new _i(Pm,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Nm)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Im=class extends Mm{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Va?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ra.clone(e.uniforms),this.material=new Va({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Fm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Lm=class extends Mm{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Rm=class extends Mm{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},zm=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new V);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Im(jm),this.copyPass.material.blending=0,this.timer=new Qo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Lm!==void 0&&(r instanceof Lm?n=!0:r instanceof Rm&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new V);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Bm={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Vm.BlurDirectionX=new V(1,0),Vm.BlurDirectionY=new V(0,1);var Hm={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Gm={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},Km={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},Ym=class extends Im{constructor(){super(Jm)}setSize(e,t){this.material.uniforms.resolution.value.set(1/e,1/t)}},Xm=class extends Mm{constructor(e){super(),this.fx=e,this.needsSwap=!1}render(e,t,n){let r=this.fx,i=e.autoClear;if(e.setRenderTarget(this.renderToScreen?null:n),e.autoClear=!0,e.render(r.scene,r.camera),r.viewmodel){let t=r.scene.background;r.scene.background=null,e.autoClear=!1,e.clearDepth(),e.render(r.scene,r.viewCam),r.scene.background=t}e.autoClear=i}},Zm={name:`GradeShader`,uniforms:{tDiffuse:{value:null},uResolution:{value:new V(1,1)},uSeed:{value:new V(0,0)},uTime:{value:0},uGrainScale:{value:1},uAberration:{value:1.1},uGrain:{value:.055},uVignette:{value:.34},uDamage:{value:0},uLowHealth:{value:0},uHitFlash:{value:0},uSlowmo:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
}`,Xh=class{constructor(){let e=new Float32Array(Wh*3),t=new Float32Array(Wh*3),n=new Float32Array(Wh),r=new Float32Array(Wh);this.vel=new Float32Array(Wh*3),this.age=new Float32Array(Wh),this.ttl=new Float32Array(Wh),this.drag=new Float32Array(Wh),this.gravity=new Float32Array(Wh),this.head=0;let i=new kr;i.setAttribute(`position`,new mr(e,3)),i.setAttribute(`aColor`,new mr(t,3)),i.setAttribute(`aSize`,new mr(n,1)),i.setAttribute(`aLife`,new mr(r,1)),i.setDrawRange(0,Wh),i.boundingSphere=new xr(new H,60),this.points=new _a(i,new Va({vertexShader:Jh,fragmentShader:Yh,transparent:!0,depthWrite:!1,blending:2})),this.points.frustumCulled=!1,this.geo=i}spawn(e,t){let{count:n=16,speed:r=5,spread:i=1,color:a=new K(16756821),size:o=.09,ttl:s=.5,gravity:c=9,drag:l=2.6,dir:u=null,colorJitter:d=.2}=t,f=this.geo.attributes.position.array,p=this.geo.attributes.aColor.array,m=this.geo.attributes.aSize.array,h=this.geo.attributes.aLife.array;for(let t=0;t<n;t++){let t=this.head;this.head=(this.head+1)%Wh,f[t*3]=e.x,f[t*3+1]=e.y,f[t*3+2]=e.z,Kh.set(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1),Kh.lengthSq()<1e-5&&Kh.set(0,1,0),Kh.normalize(),u&&Kh.lerp(u,1-i*.5).normalize();let n=r*(.35+Math.random()*.9);this.vel[t*3]=Kh.x*n,this.vel[t*3+1]=Kh.y*n,this.vel[t*3+2]=Kh.z*n;let g=1+(Math.random()-.5)*d;p[t*3]=a.r*g,p[t*3+1]=a.g*g,p[t*3+2]=a.b*g,m[t]=o*(.6+Math.random()*.9),h[t]=1,this.age[t]=0,this.ttl[t]=s*(.65+Math.random()*.7),this.gravity[t]=c,this.drag[t]=l}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.aColor.needsUpdate=!0,this.geo.attributes.aSize.needsUpdate=!0,this.geo.attributes.aLife.needsUpdate=!0}update(e){let t=this.geo.attributes.position.array,n=this.geo.attributes.aLife.array,r=!1;for(let i=0;i<Wh;i++){if(n[i]<=0)continue;r=!0,this.age[i]+=e;let a=this.age[i]/this.ttl[i];if(a>=1){n[i]=0;continue}n[i]=1-a*a;let o=Math.max(0,1-this.drag[i]*e);this.vel[i*3]*=o,this.vel[i*3+1]=this.vel[i*3+1]*o-this.gravity[i]*e,this.vel[i*3+2]*=o,t[i*3]+=this.vel[i*3]*e,t[i*3+1]+=this.vel[i*3+1]*e,t[i*3+2]+=this.vel[i*3+2]*e,t[i*3+1]<.02&&(t[i*3+1]=.02,this.vel[i*3+1]*=-.28,this.vel[i*3]*=.6,this.vel[i*3+2]*=.6)}r&&(this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.aLife.needsUpdate=!0)}},Zh=class{constructor(e){let t=new kr,n=new Float32Array(Gh*2*3),r=new Float32Array(Gh*2*4),i=[];for(let e=0;e<Gh-1;e++){let t=e*2;i.push(t,t+1,t+2,t+1,t+3,t+2)}t.setAttribute(`position`,new mr(n,3)),t.setAttribute(`color`,new mr(r,4)),t.setIndex(i),t.boundingSphere=new xr(new H,60),this.mesh=new _i(t,new ai({vertexColors:!0,transparent:!0,depthWrite:!1,side:2,blending:2})),this.mesh.frustumCulled=!1,this.geo=t,this.color=new K(e),this.count=0,this.strength=0,this.tips=Array.from({length:Gh},()=>new H),this.bases=Array.from({length:Gh},()=>new H)}push(e,t,n){for(let e=Gh-1;e>0;e--)this.tips[e].copy(this.tips[e-1]),this.bases[e].copy(this.bases[e-1]);this.tips[0].copy(t),this.bases[0].copy(e),this.count=Math.min(Gh,this.count+1),this.strength=n}update(e){this.strength=Math.max(0,this.strength-e*5);let t=this.geo.attributes.position.array,n=this.geo.attributes.color.array,r=this.count;for(let e=0;e<Gh;e++){let i=Math.min(e,Math.max(0,r-1)),a=this.bases[i],o=this.tips[i];t[e*6]=a.x,t[e*6+1]=a.y,t[e*6+2]=a.z,t[e*6+3]=o.x,t[e*6+4]=o.y,t[e*6+5]=o.z;let s=(e<r?(1-e/Gh)**1.7:0)*this.strength;for(let t of[0,1]){let r=(e*2+t)*4;n[r]=this.color.r,n[r+1]=this.color.g,n[r+2]=this.color.b,n[r+3]=s*(t===1?.3:0)}}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.color.needsUpdate=!0,this.mesh.visible=this.strength>.01}clear(){this.count=0,this.strength=0}},Qh=class{constructor(){this.sprites=[],this.group=new En;for(let e=0;e<8;e++){let e=new _i(new ka(1,1),new ai({color:16777215,transparent:!0,opacity:0,blending:2,depthWrite:!1,fog:!1}));e.visible=!1,this.group.add(e),this.sprites.push({mesh:e,age:0,ttl:0,size:1})}this.head=0}spawn(e,t,n,r=.16){let i=this.sprites[this.head];this.head=(this.head+1)%this.sprites.length,i.mesh.position.copy(e),i.mesh.material.color.set(t),i.age=0,i.ttl=r,i.size=n,i.mesh.visible=!0}update(e,t){for(let n of this.sprites){if(!n.mesh.visible)continue;n.age+=e;let r=n.age/n.ttl;if(r>=1){n.mesh.visible=!1,n.mesh.material.opacity=0;continue}let i=n.size*(.5+r*1.5);n.mesh.scale.set(i,i,i),n.mesh.material.opacity=(1-r)*(1-r)*.9,n.mesh.quaternion.copy(t.quaternion)}}},$h=class{constructor(e){this.scene=e,this.sparks=new Xh,this.flash=new Qh,e.add(this.sparks.points),e.add(this.flash.group),this.trails=new Map,this._c=new K}trailFor(e,t){let n=this.trails.get(e);return n||(n=new Zh(t),this.trails.set(e,n),this.scene.add(n.mesh)),n}clash(e,t){this.sparks.spawn(e,{count:30,speed:7.5,spread:1.4,size:.075,ttl:.55,color:this._c.setHex(16767392),gravity:11,drag:1.8,dir:t,colorJitter:.35}),this.flash.spawn(e,16773328,1.5,.13)}parryBurst(e){this.sparks.spawn(e,{count:54,speed:10,spread:1.6,size:.095,ttl:.75,color:this._c.setHex(16774344),gravity:9,drag:1.4,colorJitter:.3}),this.flash.spawn(e,16777215,2.9,.24)}bloodHit(e,t,n){this.sparks.spawn(e,{count:n?34:20,speed:n?5.2:3.6,spread:1.1,size:n?.1:.075,ttl:.75,color:this._c.setHex(9311252),gravity:13,drag:2.2,dir:t,colorJitter:.4}),this.flash.spawn(e,16733491,n?1.5:1,.12)}dust(e,t=10,n=1.6){qh.set(0,1,0),this.sparks.spawn(e,{count:t,speed:n,spread:1.7,size:.16,ttl:.85,color:this._c.setHex(5260858),gravity:1.6,drag:3.4,dir:qh,colorJitter:.25})}unblockableTell(e){this.sparks.spawn(e,{count:26,speed:2.2,spread:1.8,size:.11,ttl:.7,color:this._c.setHex(16742928),gravity:-1.4,drag:1.6,colorJitter:.2})}updateTrail(e,t){let n=this.trailFor(e,t);e.state===`attack`&&e.attack&&e.clipTime>e.attack.windup*.82&&e.clipTime<e.attack.strike+.22?n.push(e.rig.bladePoint(.58,Kh),e.rig.bladeTip(qh),1):n.strength<=.02&&(n.clear(),n.push(e.rig.bladePoint(.58,Kh),e.rig.bladeTip(qh),0))}update(e,t){this.sparks.update(e),this.flash.update(e,t);for(let t of this.trails.values())t.update(e)}},eg=1316383,tg=null;function ng(){if(tg)return tg;let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.3,`rgba(255,196,120,0.62)`),n.addColorStop(1,`rgba(255,110,20,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),tg=new ba(e),tg.colorSpace=Ve,tg}function rg(){let e=new Aa(220,32,24),t=[],n=e.attributes.position,r=new K(658712),i=new K(2304573),a=new K(4864565),o=new K;for(let e=0;e<n.count;e++){let s=n.getY(e)/220;s>.05?o.copy(i).lerp(r,Math.min(1,s*1.5)):o.copy(a).lerp(i,Math.min(1,(s+.35)/.4)),t.push(o.r,o.g,o.b)}e.setAttribute(`color`,new _r(t,3));let s=new _i(e,new ai({vertexColors:!0,side:1,fog:!1,depthWrite:!1}));return s.renderOrder=-1e3,s}function ig(){let e=new Float32Array(900*3),t=new Float32Array(900);for(let n=0;n<900;n++){let r=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),a=Math.abs(Math.cos(i))*190;e[n*3]=Math.sin(i)*Math.cos(r)*190,e[n*3+1]=a*.9+12,e[n*3+2]=Math.sin(i)*Math.sin(r)*190,t[n]=Math.random()<.08?2.6:1.2}let n=new kr;n.setAttribute(`position`,new mr(e,3)),n.setAttribute(`aSize`,new mr(t,1));let r=new _a(n,new fa({color:12372192,size:1.1,sizeAttenuation:!1,transparent:!0,opacity:.75,fog:!1,depthWrite:!1}));return r.renderOrder=-999,r}function ag(e){let t=new Fn,n=new _i(new Aa(40,16,12),new ai({color:4477035,side:1}));t.add(n);let r=new _i(new Ta(38,24),new ai({color:1314828,side:2}));r.rotation.x=-Math.PI/2,r.position.y=-3,t.add(r);for(let e=0;e<5;e++){let n=e/5*Math.PI*2,r=new _i(new Aa(2.4,8,6),new ai({color:11029012}));r.position.set(Math.cos(n)*18,.8,Math.sin(n)*18),t.add(r)}let i=new _i(new Aa(5,12,10),new ai({color:13622517}));i.position.set(-14,24,-20),t.add(i);let a=new Is(e),o=a.fromScene(t,.04);return a.dispose(),o.texture}var og=class{constructor(e){this.position=e.clone(),this.group=new En,this.group.position.copy(e),this.light=new Vo(16747066,34,24,2),this.light.position.y=.35,this.light.castShadow=!1,this.group.add(this.light);let t=new Float32Array(138);this.seeds=new Float32Array(138);for(let e=0;e<46;e++)this.seeds[e*3]=Math.random(),this.seeds[e*3+1]=.4+Math.random()*.9,this.seeds[e*3+2]=Math.random()*Math.PI*2;let n=new kr;n.setAttribute(`position`,new mr(t,3)),this.flame=new _a(n,new fa({color:16753724,size:.3,transparent:!0,opacity:.8,map:ng(),blending:2,depthWrite:!1,fog:!0})),this.group.add(this.flame),this.phase=Math.random()*20}update(e){let t=this.flame.geometry.attributes.position,n=this.seeds;for(let r=0;r<t.count;r++){let i=(e*n[r*3+1]*.75+n[r*3])%1,a=.16*(1-i)+.03,o=Math.sin(e*5+n[r*3+2])*.09*i;t.setXYZ(r,Math.cos(n[r*3+2])*a+o,i*.95+.1,Math.sin(n[r*3+2])*a+o*.6)}t.needsUpdate=!0;let r=.78+Math.sin(e*11+this.phase)*.12+Math.sin(e*27.3+this.phase*2)*.08;this.light.intensity=34*r,this.flame.material.opacity=.7+r*.22}},sg=class{constructor(e=260,t=26,n=7){this.extent=t,this.height=n;let r=new Float32Array(e*3);this.drift=new Float32Array(e*3);for(let i=0;i<e;i++)r[i*3]=(Math.random()-.5)*t,r[i*3+1]=Math.random()*n,r[i*3+2]=(Math.random()-.5)*t,this.drift[i*3]=(Math.random()-.5)*.18,this.drift[i*3+1]=.02+Math.random()*.09,this.drift[i*3+2]=(Math.random()-.5)*.18;let i=new kr;i.setAttribute(`position`,new mr(r,3)),i.boundingSphere=new xr(new H,t),this.points=new _a(i,new fa({color:13154202,size:.035,transparent:!0,opacity:.5,depthWrite:!1,blending:2,fog:!0,map:ng(),sizeAttenuation:!0})),this.points.frustumCulled=!1,this.centre=new H}update(e,t,n){let r=this.points.geometry.attributes.position,i=r.array,a=this.extent/2;t&&this.centre.set(t.x,0,t.z);for(let t=0;t<r.count;t++){let r=t*3;i[r]+=(this.drift[r]+Math.sin(n*.3+t)*.05)*e,i[r+1]+=this.drift[r+1]*e,i[r+2]+=(this.drift[r+2]+Math.cos(n*.24+t)*.05)*e,i[r+1]>this.height&&(i[r+1]-=this.height);let o=i[r]-this.centre.x,s=i[r+2]-this.centre.z;o>a?i[r]-=this.extent:o<-a&&(i[r]+=this.extent),s>a?i[r+2]-=this.extent:s<-a&&(i[r+2]+=this.extent)}r.needsUpdate=!0}};function cg(e,t){let n=new Fn;n.fog=new Pn(eg,.017),n.background=new K(eg),n.environment=ag(e),n.environmentIntensity=.85,n.add(rg()),n.add(ig());let r=new To(4610431,2760467,.98);n.add(r);let i=new Wo(11585260,2.15);i.position.set(-16,22,-13),i.castShadow=!0,i.shadow.mapSize.set(2048,2048);let a=i.shadow.camera;a.left=-14,a.right=14,a.top=14,a.bottom=-14,a.near=1,a.far=60,i.shadow.bias=-7e-4,i.shadow.normalBias=.022,i.shadow.radius=3.2,n.add(i),n.add(i.target);let o=new Wo(16757626,.5);o.position.set(11,5,9),n.add(o);let s=[];if(t){t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)});let e=[];t.traverse(t=>{/^Light_Brazier/.test(t.name)&&e.push(t)}),t.updateMatrixWorld(!0);for(let t of e){let e=new og(new H().setFromMatrixPosition(t.matrixWorld));s.push(e),n.add(e.group)}n.add(t)}let c=new _i(new Ta(60,48),new Ua({color:1775392,roughness:1}));c.rotation.x=-Math.PI/2,c.position.y=-.02,c.receiveShadow=!0,n.add(c);let l=new sg;return n.add(l.points),{scene:n,moon:i,braziers:s,hemi:r,motes:l}}var lg={longsword:{file:`weapon_longsword.glb`,name:`Longsword`,lead:-.05,rear:-.16,tip:1.072,damageMul:1,trail:10470655},greatsword:{file:`weapon_greatsword.glb`,name:`Greatsword`,lead:-.075,rear:-.27,tip:1.2,damageMul:1.18,trail:13162239},daneaxe:{file:`weapon_daneaxe.glb`,name:`Dane Axe`,lead:0,rear:-.55,tip:.545,damageMul:1.12,trail:16757370},warhammer:{file:`weapon_warhammer.glb`,name:`War Hammer`,lead:.01,rear:-.42,tip:.52,damageMul:1.22,trail:16765066},spear:{file:`weapon_spear.glb`,name:`Winged Spear`,lead:.02,rear:-.4,tip:.86,damageMul:.9,trail:12576511},katana:{file:`weapon_katana.glb`,name:`Katana`,lead:-.06,rear:-.25,tip:.742,damageMul:1.05,trail:15267071}},ug={warden:{file:`knight_warden.glb`,name:`Warden`,health:130,speedMul:1,herald:/_accent$/},warden_heavy:{file:`knight_warden_heavy.glb`,name:`Warden — Plate`,health:152,speedMul:.9,herald:/_accent$/},warden_light:{file:`knight_warden_light.glb`,name:`Warden — Mail`,health:112,speedMul:1.1,herald:/_accent$/},raider:{file:`knight_raider.glb`,name:`Raider`,health:130,speedMul:1,herald:/_hide$/},raider_heavy:{file:`knight_raider_heavy.glb`,name:`Raider — Chieftain`,health:152,speedMul:.9,herald:/_hide$/},raider_light:{file:`knight_raider_light.glb`,name:`Raider — Berserker`,health:112,speedMul:1.1,herald:/_hide$/}},dg={compound:`models/compound.glb`,...Object.fromEntries(Object.entries(ug).map(([e,t])=>[`armour_${e}`,`models/${t.file}`])),...Object.fromEntries(Object.entries(lg).map(([e,t])=>[`weapon_${e}`,`models/${t.file}`]))},fg=new Set([`compound`]),pg=new H,mg=new H,hg=new H;function gg(){let e=Math.max(1,window.innerWidth||0),t=Math.max(1,window.innerHeight||0);return{w:e,h:t,aspect:e/t}}async function _g(){let e=new Fu;e.setMeshoptDecoder(Pd);let t=await Promise.all(Object.entries(dg).map(async([t,n])=>{try{return[t,await e.loadAsync(n)]}catch(e){if(fg.has(t))return console.warn(`[art-of-battle] ${n} missing — using stand-in`,e),[t,null];throw e}}));return Object.fromEntries(t)}var vg=class{constructor(e,t,n){this.renderer=t,this.assets=e;let r=cg(t,e.compound?.scene??null);this.scene=r.scene,this.braziers=r.braziers,this.motes=r.motes,this.moon=r.moon;let i=gg();this.camera=new Lo(72,i.aspect,.1,400),this.camera.layers.set(0),this.viewCam=new Lo(45,i.aspect,.02,14),this.viewCam.layers.set(1),this.viewCamBack=1.15;let a=new Vo(16769724,14,8,2);a.position.set(.55,.75,.9),a.layers.set(1);let o=new To(10335448,2760728,1.6);o.layers.set(1),this.viewCam.add(a,o),this.scene.add(this.viewCam),this.duelCam=new fp(this.camera),this.fpCam=new gp(this.camera),this.lockedOn=!1,this.lockOverride=!1,this.lostSight=0,this.post=new $m({renderer:t,scene:this.scene,camera:this.camera,viewCam:this.viewCam}),this.score=new _h,this.compound=new Tp(this.scene,e.compound?.scene??null);let s=e.compound?.scene;if(s&&!new URLSearchParams(location.search).has(`nobatch`)){let e=new Set;for(let t of this.compound.surfaces)t.node&&e.add(t.node);for(let t of this.compound.openings.values())t.node&&e.add(t.node);let t=qp(s),n=Kp(s,e);this.scene.add(n.group);let r=Jp(e),i=rm(s,this.compound.surfaces),a=rm(n.group,this.compound.surfaces);this.batchStats={...n,panels:r,fold:t,ao:i,aoBatch:a}}this.duelCam.collider=this.compound,this.vfx=new $h(this.scene),this.hud=new Rh(n),this.siegeHud=new Uh(this.hud),this.audio=new Rd,this.score.attach(this.audio),this.input=new Vh(t.domElement),this.gadgets=new Ah(this.scene,this.compound),this._buildFighters(),this.siege=new tp({player:this.player,enemy:this.enemy,compound:this.compound,duel:this.duel}),this.nav=new yh(this.compound),this.ai.siege=this.siege,this.ai.gadgets=this.gadgets,this.ai.compound=this.compound,this.ai.nav=this.nav,this.time=0,this.timeScale=1,this.slowmo=0,this.fx={damage:0,lowHealth:0,hitFlash:0,slowmo:0},this.started=!1,this.paused=!1,this._move={x:0,y:0},this._prepAngle=0,this._scout={yaw:0,pitch:.85,dist:23,focus:new H(0,.5,0),idle:0},this.creator=new mm({armours:Object.entries(ug).map(([e,t])=>({key:e,...t})),weapons:Object.entries(lg).map(([e,t])=>({key:e,...t}))}),this.mode=`create`,this.startMatch(),this.enterCreation()}_instance(e){let t=this.assets[e];return t?t.scene.clone(!0):null}_buildFighters(){let e=lg.longsword,t=lg.daneaxe,n=ug.warden_heavy,r=ug.raider_heavy;this.player=new Dm({name:`Warden`,model:this._instance(`armour_warden_heavy`),weapon:this._instance(`weapon_longsword`),grip:e,profile:{damageMul:e.damageMul,leadHand:`R`,trail:e.trail,speedMul:n.speedMul},x:0,z:-14,yaw:0,health:n.health}),this.enemy=new Dm({name:`Raider`,model:this._instance(`armour_raider_heavy`),weapon:this._instance(`weapon_daneaxe`),grip:t,profile:{damageMul:t.damageMul,leadHand:`R`,trail:t.trail,speedMul:r.speedMul},x:6,z:4,yaw:Math.PI,health:r.health}),this.player.collider=this.compound,this.enemy.collider=this.compound,this.player.rig.setFirstPerson(!0),this.player.freeLook=!0,this.scene.add(this.player.group,this.enemy.group),this.duel=new Sp(this.player,this.enemy),this.ai=new op(this.enemy,this.duel,`warrior`),this.fpCam.snap(this.player,this.enemy,!1)}enterCreation(){this.mode=`create`,this.siege.drain();let e=this.player;e.rig.setFirstPerson(!1),e.frozen=!0,e.freeLook=!0,e.pos.set(0,0,-15),e.velocity.set(0,0,0),e.setGuard(`right`),this.enemy.group.visible=!1,this.creator.dirty=!0}applyPlayerLoadout(){let e=this.creator,t=ug[e.armour.key],n=lg[e.weapon.key];this.player.setLoadout({model:this._instance(`armour_${e.armour.key}`),weapon:this._instance(`weapon_${e.weapon.key}`),grip:n,profile:{damageMul:n.damageMul,leadHand:`R`,trail:n.trail,speedMul:t.speedMul}}),hm(this.player.rig,e.herald.hex,t.herald),this.player.traits=sm(e.archetypeKey,e.perkKeys),this.player.archetypeName=e.archetype.name,this.player.maxHealth=Math.round(t.health*this.player.traits.healthMul),this.player.health=this.player.maxHealth,this.vfx.trails.delete(this.player)}beginMatch(){this.applyPlayerLoadout(),this.player.name=(this.creator.name||``).trim()||`Warden`,this.player.rig.setFirstPerson(!0),this.player.frozen=!1,this.enemy.group.visible=!0,this.mode=`match`,this.startMatch()}_updateCreate(e,t){this.creator.dirty&&(this.applyPlayerLoadout(),this.creator.dirty=!1);let n=this.creator.handle(t);this.creator.update(e),this.creator.poseCamera(this.camera,this.player),this.player.update(e,this.enemy),this.player.events.length=0,this._renderFrame(e),this.hud.ctx.clearRect(0,0,this.hud.w,this.hud.h),this.creator.draw(this.hud,this.player),n&&this.beginMatch()}_rollEnemyBuild(){let e=e=>e[Math.random()*e.length|0],t=e(cm),n=lm.filter(e=>e!==`none`),r=e(n),i=e(n);for(;i===r;)i=e(n);this.enemy.traits=sm(t,[r,i]),this.enemyArchetype=im[t].name;let a=ug.raider_heavy.health;this.enemy.maxHealth=Math.round(a*this.enemy.traits.healthMul),this.enemy.health=this.enemy.maxHealth,this.enemy.archetypeName=this.enemyArchetype}startMatch(){this.duel.over=!1,this.duel.winner=null,this._rollEnemyBuild(),this.siege.startMatch(),this.hud.messages.length=0,this.hud.floats.length=0;for(let e of this.vfx.trails.values())e.clear()}_onRoundStart(){this.duel.over=!1,this.duel.winner=null,this.gadgets.resetFor([this.player,this.enemy],e=>this.siege.roleOf(e)),this.ai.reset?.(),this.fpCam.snap(this.player,this.enemy,!1)}enemyVisible(){let e=this.player.pos,t=this.enemy.pos;return!(this.compound.losBlocked(e.x,e.z,t.x,t.z)||this.gadgets.smokeBlocks(e.x,e.z,t.x,t.z))}_gadgetTarget(e){let t=this.player,n=t.pos.x+Math.sin(t.yaw)*1.5,r=t.pos.z+Math.cos(t.yaw)*1.5;if(e===`barricade`){let e=null,t=2.6;for(let[i,a]of this.compound.openings){if(a.barricade)continue;let o=Math.hypot(n-a.cx,r-a.cz);o<t&&(t=o,e=i)}return e?{openingId:e}:null}if(e===`reinforce`){let e=this.compound.nearestSurface(n,r,2.2,e=>e.kind===`panel`&&e.soft&&!e.reinforced);return e?{surface:e.surface}:null}if(e===`breach`){let e=this.compound.nearestSurface(n,r,2.2,e=>e.kind===`panel`);return e?{surface:e.surface}:null}return{}}_updateLockOn(e){let t=this.player.pos.distanceTo(this.enemy.pos)<5.2;this.enemyVisible()?this.lostSight=0:this.lostSight+=e;let n=this.siege.phase===Q.ACTION&&this.player.alive&&this.enemy.alive&&!this.lockOverride&&t&&this.lostSight<.45;this.lockedOn=n,this.input.lockedOn=n,this.player.freeLook=!n,n?this.input.yaw=this.player.yaw:this.player.yaw=this.input.yaw}_handleInput(e,t=1/60){let n=this.input.move(this._move),r=this.player,i=this.siege.phase;if(e.gadgetSlot!=null&&this._useGadget(e.gadgetSlot),e.toggleLock&&(this.lockOverride=!this.lockOverride,this.hud.say(this.lockOverride?`FREE LOOK`:`LOCK ON`,`#c9d2de`,.8)),i===Q.PREP){r.moveInput.set(0,0),this._scoutInput(e,n,t);return}if(i!==Q.ACTION||!r.alive){r.moveInput.set(0,0);return}r.moveInput.set(n.x,n.y),this.lockedOn&&(r.setGuard(this.input.guard),e.guardChanged&&this.audio.play(`ui_stance`,{volume:.5})),e.light&&r.startAttack(`light`),e.heavy&&(this.duel.tryParry(r)||r.startAttack(`heavy`)),e.heavyReleased&&r.releaseCharge(),e.feint&&r.feint(),e.gb&&r.startGuardBreak(),e.dodge&&r.startDodge(n.x,n.y)}_useGadget(e){let t=this.siege.phase===Q.PREP?`prep`:`action`,n=this.gadgets.inventory.get(this.player)||{},r=Object.keys(n)[e];if(!r)return;let i=Ch[r];if(i.phase!==`any`&&i.phase!==t){this.hud.say(`${i.label} — WRONG PHASE`,Lh.dim,.8);return}if(this.gadgets.remaining(this.player,r)<=0){this.hud.say(`NONE LEFT`,Lh.dim,.7);return}let a=this._gadgetTarget(r);if(!a){this.hud.say(`NOTHING TO USE IT ON`,Lh.dim,.9);return}this.gadgets.use(this.player,r,a)?this.hud.say(i.label.toUpperCase(),`#c9d2de`,.8):this.hud.say(`CANNOT PLACE THERE`,Lh.dim,.9)}_pan(e){mg.setFromMatrixColumn(this.camera.matrixWorld,0),pg.subVectors(e,this.camera.position);let t=Math.max(1,pg.length());return kt.clamp(pg.dot(mg)/t*2.2,-1,1)}_processEvents(){let e=this.audio;for(let t of[this.player,this.enemy]){for(let n of t.events)switch(n.type){case`swing`:e.play(n.attack.type===`heavy`?`swing_heavy`:`swing_light`,{volume:.75,pan:this._pan(t.pos),rate:.94+Math.random()*.12});break;case`footstep`:{let r=t.feet[n.side];e.play(`footstep`,{volume:.28,pan:this._pan(r.world)}),t.velocity.lengthSq()>1.2&&this.vfx.dust(r.world,4,.8);break}case`dodge`:e.play(`dodge`,{volume:.6,pan:this._pan(t.pos)}),this.vfx.dust(pg.copy(t.pos).setY(.05),12,1.4);break;case`guardbreak`:e.play(`guardbreak`,{volume:.5,pan:this._pan(t.pos)});break;case`feint`:e.play(`ui_stance`,{volume:.7,rate:.7});break;case`unblockable`:this.vfx.unblockableTell(t.rig.bladeTip(pg)),e.play(`ui_stance`,{volume:.9,rate:.55}),t===this.enemy&&this.hud.say(`UNBLOCKABLE`,Lh.unblock,.9);break;case`exhausted`:e.play(`stamina_empty`,{volume:.7}),t===this.player&&this.hud.say(`EXHAUSTED`,Lh.staminaLow,1);break;case`death`:e.play(`death`,{volume:.9,pan:this._pan(t.pos)}),this.vfx.dust(pg.copy(t.pos).setY(.1),26,1.8);break}t.events.length=0}for(let t of this.duel.drain()){let n=t.point?this._pan(t.point):0;switch(t.type){case`hit`:t.defender===this.player?this.fx.damage=1:this.fx.hitFlash=1,e.play(`hit_flesh`,{volume:.95,pan:n}),pg.subVectors(t.defender.pos,t.attacker.pos).normalize(),this.vfx.bloodHit(t.point,pg,t.heavy),this.fpCam.kick(t.heavy?.55:.3,t.heavy?4:1.5),this.hud.float(t.point,`${t.damage}`,t.defender===this.player?`#ff6b5e`:`#ffe9c9`),e.duckMusic(.5,.4);break;case`block`:e.play(`hit_block`,{volume:.85,pan:n,rate:.92+Math.random()*.16}),pg.subVectors(t.defender.pos,t.attacker.pos).normalize(),this.vfx.clash(t.point,pg),this.fpCam.kick(t.heavy?.3:.16,t.heavy?1.5:0);break;case`parry`:this.fx.hitFlash=1,e.play(`parry`,{volume:1,pan:n}),this.vfx.parryBurst(t.point),this.fpCam.kick(.7,5),this.hud.say(`PARRY`,Lh.parry,1,!0),this.score.sting(`parry`),this.slowmo=.34,e.duckMusic(.8,.6);break;case`gbhit`:e.play(`guardbreak`,{volume:.95,pan:n}),this.fpCam.kick(.35,2),this.hud.say(`GUARD BROKEN`,`#e8d9b0`,.9),this.vfx.dust(pg.copy(t.defender.pos).setY(.05),14,1.5);break;case`gbcounter`:e.play(`parry`,{volume:.8,pan:n,rate:.8}),this.hud.say(`COUNTERED`,Lh.parry,.9),this.fpCam.kick(.4,2);break;case`whiff`:this._swingHitsWorld(t);break;case`dodged`:this.hud.say(`MISS`,`rgba(220,228,240,0.75)`,.6);break}}for(let t of this.gadgets.drain())switch(t.type){case`breached`:e.play(`hit_block`,{volume:1,rate:.45}),e.play(`death`,{volume:.55,rate:1.5}),this.fpCam.kick(.85,6),this.vfx.dust(t.pos,40,3.2),this.vfx.clash(t.pos,pg.set(0,1,0)),this.hud.say(`BREACH`,Lh.unblock,1,!0),this.score.sting(`breach`);break;case`alarm`:e.play(`ui_stance`,{volume:1,rate:1.8}),this.hud.say(t.fighter===this.player?`ALARM TRIPPED`:`ALARM — THEY ARE CLOSE`,Lh.unblock,1);break;case`caltrophit`:e.play(`hit_flesh`,{volume:.4,rate:1.6});break;case`gadget`:e.play(`ui_stance`,{volume:.6,rate:.9});break}for(let t of this.siege.drain())switch(t.type){case`roundstart`:this._onRoundStart(),this.hud.say(`ROUND ${t.round} — ${t.playerRole===Zf.ATTACK?`ATTACK`:`DEFEND`}`,t.playerRole===Zf.ATTACK?`#e08a3c`:`#6fb3ff`,2,!0);break;case`phase`:t.phase===Q.ACTION&&(this.hud.say(`FIGHT`,`#e8eef8`,1.2,!0),e.play(`victory`,{volume:.5,rate:.7}));break;case`objectivehit`:e.play(`hit_block`,{volume:.7,rate:.7}),this.vfx.clash(this.compound.objective.pos.clone().setY(1.4),pg.set(0,1,0)),t.broke&&(this.score.sting(`objective`),this.hud.say(`BANNER DOWN`,Lh.unblock,1.4,!0),this.fpCam.kick(.7,4));break;case`roundend`:this.score.sting(t.winner===`player`?`roundwin`:`roundloss`),e.play(t.winner===`player`?`victory`:`defeat`,{volume:.9}),this.slowmo=1;break;case`matchend`:e.play(t.winner===`player`?`victory`:`defeat`,{volume:1});break}}_swingHitsWorld(e){let t=e.attacker,n=t.rig.bladeTip(new H),r=e.heavy;if(this.siege.strikeObjective(t,r?22:10))return;let i=this.compound.damageAt(n.x,n.z,.85,r?46:18);if(i.length){this.audio.play(`hit_block`,{volume:.5,rate:1.25});for(let e of i){let t=this.compound.centre(e.surface,new H);e.broken?(this.vfx.dust(t,22,2.4),this.vfx.clash(t,pg.set(0,1,0)),this.fpCam.kick(.3,1.5)):this.vfx.dust(t,5,1.2)}}}update(e){let t=this.input.flush();this.time+=e;for(let e of this.braziers)e.update(this.time);if(this.motes?.update(e,this.player.pos,this.time),this.mode===`create`){this._updateCreate(e,t),this._driveScore(e);return}if(t.pause&&(this.paused=!this.paused),t.restart&&this.siege.phase===Q.MATCH_OVER&&(this.startMatch(),this.paused=!1),t.cycleQuality&&this.post){let e=[`high`,`medium`,`off`],t=e[(e.indexOf(this.post.quality)+1)%e.length];this.post.setQuality(t),this.post.enabled=t!==`off`,this.hud.say(`GRAPHICS — ${t.toUpperCase()}`,`#c9d2de`,1.2)}t.difficulty&&!this.started&&(this.ai.setDifficulty(t.difficulty),this.hud.say(t.difficulty.toUpperCase(),`#c9d2de`,1.1));let n=!this.started||this.paused;if(n)this.player.update(0,this.enemy),this.enemy.update(0,this.player);else{this._updateLockOn(e),this._handleInput(t,e),this.slowmo>0&&(this.slowmo-=e);let n=this.slowmo>0?.28:1;this.timeScale+=(n-this.timeScale)*Math.min(1,e*(this.slowmo>0?22:6));let r=e*this.timeScale;this.duel.hitStop>0&&(this.duel.hitStop-=e,r*=.06),this.siege.update(r),this.ai.update(r),this.player.update(r,this.enemy),this.enemy.update(r,this.player),this.siege.phase===Q.ACTION&&this.duel.update(),this.gadgets.update(r,[this.player,this.enemy],this.time)}this._processEvents(),this.fx.damage=Math.max(0,this.fx.damage-e*1.8),this.fx.hitFlash=Math.max(0,this.fx.hitFlash-e*6),this.fx.slowmo+=(+(this.slowmo>0)-this.fx.slowmo)*Math.min(1,e*8);let r=this.player.health/Math.max(1,this.player.maxHealth);this.fx.lowHealth+=(Math.max(0,1-r/.35)-this.fx.lowHealth)*Math.min(1,e*3),this.post&&(this.post.damage=this.fx.damage,this.post.lowHealth=this.fx.lowHealth,this.post.hitFlash=this.fx.hitFlash,this.post.slowmo=this.fx.slowmo),this._driveScore(e),this.vfx.updateTrail(this.player,this.player.profile.trail),this.vfx.updateTrail(this.enemy,this.enemy.profile.trail),this.vfx.update(e,this.camera),this._updateCamera(e),this.moon.target.position.lerp(pg.copy(this.player.pos).lerp(this.enemy.pos,.5),.1),this.moon.position.copy(this.moon.target.position).add(pg.set(-16,22,-13)),this._renderFrame(e);let i=this.enemyVisible();this.hud.draw(e,{player:this.player,enemy:this.enemy,camera:this.camera,duel:this.duel,paused:n,started:this.started,showIndicator:i&&this.siege.phase===Q.ACTION}),this.siegeHud.draw(e,{siege:this.siege,compound:this.compound,gadgets:this.gadgets,player:this.player,enemy:this.enemy,camera:this.camera,enemyVisible:i,time:this.time})}_driveScore(e){if(!this.score)return;let t=`menu`,n=.15;if(this.mode===`match`){let e=this.siege.phase;if(e===Q.PREP)t=`prep`,n=.3;else if(e===Q.ACTION){let e=this.player.pos.distanceTo(this.enemy.pos),r=this.lockedOn||e<6;t=r?`combat`:`stalk`;let i=1-this.player.health/Math.max(1,this.player.maxHealth),a=kt.clamp(1-(e-2)/14,0,1);n=kt.clamp((r?.55:.2)+a*.25+i*.3,0,1)}else(e===Q.RESOLVE||e===Q.MATCH_OVER)&&(t=this.siege.lastResult?.winner===`player`?`victory`:`defeat`,n=.4)}this.score.setState(t),this.score.setIntensity(n),this.score.update(e)}_renderFrame(e=.016){let t=!!this.player.rig.firstPerson;if(t&&(this.viewCam.position.copy(this.camera.position).addScaledVector(this.camera.getWorldDirection(hg),-this.viewCamBack),this.viewCam.quaternion.copy(this.camera.quaternion),this.viewCam.updateMatrixWorld(!0)),this.post?.enabled){this.post.viewmodel=t,this.post.render(e);return}let n=this.renderer;if(n.render(this.scene,this.camera),!t)return;let r=this.scene.background;this.scene.background=null,n.autoClear=!1,n.clearDepth(),n.render(this.scene,this.viewCam),n.autoClear=!0,this.scene.background=r}_scoutInput(e,t,n){let r=this._scout,i=t.x||t.y,a=this.input.yaw,o=this.input.pitch;if(a!==r._lastYaw||o!==r._lastPitch?r.idle=0:r.idle+=n,r._lastYaw=a,r._lastPitch=o,r.yaw=a,r.pitch=kt.clamp(.35+o*.9,.22,1.32),i){r.idle=0;let e=Math.cos(r.yaw),i=Math.sin(r.yaw),a=7*n;r.focus.x=kt.clamp(r.focus.x-(t.x*e+t.y*i)*a,-16,16),r.focus.z=kt.clamp(r.focus.z-(t.y*e-t.x*i)*a,-16,16)}(e.keys?.includes(`Enter`)||e.dodge)&&this.siege.skipPrep()&&this.hud.say(`THE HORN SOUNDS`,`#e0c45a`,1.2)}_updateCamera(e){if(this.siege.phase===Q.PREP){let t=this._scout;t.idle>1.5&&(this._prepAngle+=e*.12);let n=t.yaw+this._prepAngle,r=t.dist*Math.cos(t.pitch*.55);pg.set(t.focus.x+Math.sin(n)*r,6+Math.sin(t.pitch)*19,t.focus.z+Math.cos(n)*r),this.camera.position.lerp(pg,1-Math.exp(-6*e)),this.camera.lookAt(t.focus.x,.5,t.focus.z);return}this.fpCam.update(e,this.player,this.enemy,this.lockedOn)}};async function yg(){let e=document.getElementById(`view`),t=document.getElementById(`hud`),n=document.getElementById(`loading`),r=new ku({canvas:e,antialias:!0,powerPreference:`high-performance`});r.setPixelRatio(Math.min(2,window.devicePixelRatio));let i=gg();r.setSize(i.w,i.h),r.shadowMap.enabled=!0,r.shadowMap.type=1,r.toneMapping=4,r.toneMappingExposure=1.12;let a;try{a=await _g()}catch(e){throw n.textContent=`Failed to load assets: ${e.message}`,e}{let e=0,t=new Set;for(let n of Object.values(a)){if(!n?.scene)continue;let r=Wp(n.scene);e+=r.matched,r.missed.forEach(e=>t.add(e))}t.size&&console.warn(`[art-of-battle] no surface family for: ${[...t].join(`, `)}`),console.info(`[art-of-battle] surface detail on ${e} materials`)}let o=new vg(a,r,t);window.__game=o,n.classList.add(`gone`),e.addEventListener(`click`,()=>{o.audio.unlock(),o.audio.startAmbience(),o.score.start(),o.started=!0,o.paused=!1}),window.addEventListener(`resize`,()=>{let{w:e,h:t,aspect:n}=gg();o.camera.aspect=n,o.camera.updateProjectionMatrix(),o.viewCam.aspect=n,o.viewCam.updateProjectionMatrix(),r.setSize(e,t),o.post?.setSize(e,t)});let s=performance.now();r.setAnimationLoop(e=>{let t=Math.min(.05,(e-s)/1e3);s=e,o.update(t)})}yg();