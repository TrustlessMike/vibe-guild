...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(e,t,n){let r=new Float32Array(Ds),i=new V(0,1,0);return new Va({name:`SphericalGaussianBlur`,defines:{n:Ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new Va({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(){return new Va({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ws(),fragmentShader:`
	...
	`}var Gs=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ya(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `+e.fragmentShader.replace(`#include <roughnessmap_fragment>`,`#include <roughnessmap_fragment>
        ...
        roughnessFactor = clamp(
          roughnessFactor + (gDetail.a - 0.5) * 2.0 * uRoughAmp, 0.04, 1.0);`).replace(`#include <normal_fragment_maps>`,`#include <normal_fragment_maps>
        {
        ...
        }`)},e.customProgramCacheKey=()=>`detail:${t}`,e.needsUpdate=!0}function Up(e){if(!e?.isMeshStandardMaterial)return;let t=Rp(e.name);t&&Hp(e,t)}function Wp(e){let t=0,n=new Set;return e.traverse(e=>{if(e.isMesh)for(let r of Array.isArray(e.material)?e.material:[e.material]){if(!r||!r.isMeshStandardMaterial)continue;let e=Rp(r.name);e?(Hp(r,e),t++):r.name&&!Lp.test(r.name)&&n.add(r.name)}}),{matched:t,missed:[...n]}}function Gp(e){return Object.keys(e.attributes).sort().join(`,`)+(e.index?`|i`:``)}function Kp(e){for(let[t,n]of Object.entries(e.attributes)){if(n.array instanceof Float32Array&&!n.normalized)continue;let r=new Float32Array(n.count*n.itemSize);for(let e=0;e<n.count;e++)for(let t=0;t<n.itemSize;t++)r[e*n.itemSize+t]=n.getComponent(e,t);e.setAttribute(t,new hr(r,n.itemSize))}}function qp(e,t=new Set){e.updateMatrixWorld(!0);let n=e=>{for(let n=e;n;n=n.parent)if(t.has(n))return!0;return!1},r=new Map,i=0;e.traverse(e=>{if(!e.isMesh||!e.geometry||(i++,n(e))||Array.isArray(e.material))return;let t=`${e.material.uuid}|${Gp(e.geometry)}|${+!!e.castShadow}${+!!e.receiveShadow}`,a=r.get(t);a||r.set(t,a={material:e.material,meshes:[]}),a.meshes.push(e)});let a=new Dn;a.name=`StaticBatch`;let o=0;for(let{material:e,meshes:t}of r.values()){if(t.length<2)continue;let n=t.map(e=>{let t=e.geometry.clone();return Kp(t),t.applyMatrix4(e.matrixWorld),t}),r;try{r=Au(n,!1)}catch{r=null}if(n.forEach(e=>e.dispose()),!r)continue;let i=new K(r,e);i.castShadow=t[0].castShadow,i.receiveShadow=t[0].receiveShadow,i.matrixAutoUpdate=!1,i.updateMatrix(),a.add(i),o++;for(let e of t)e.parent?.remove(e),e.geometry.dispose()}e.traverse(e=>{e.isMesh&&!n(e)&&(e.matrixAutoUpdate=!1,e.updateMatrix())});let s=0;return e.traverse(e=>{e.isMesh&&s++}),a.traverse(e=>{e.isMesh&&s++}),{group:a,before:i,after:s,merged:o}}function Jp(e){let t=new Map,n=0,r=0,i=e=>e&&e.isMeshStandardMaterial&&!e.map&&!e.normalMap&&!e.emissiveMap&&!e.transparent&&e.opacity===1&&(!e.emissive||e.emissive.getHex()===0);return e.traverse(e=>{if(!e.isMesh||!e.geometry||Array.isArray(e.material))return;let a=e.material;if(!i(a))return;let o=(e,t)=>(Math.round(e/t)*t).toFixed(2),s=`${Rp(a.name)||`plain`}|${o(a.roughness,.15)}|${o(a.metalness,.34)}|${+!!a.flatShading}|${a.side}`,c=t.get(s);c||(c=a.clone(),c.color.setRGB(1,1,1),c.vertexColors=!0,c.roughness=parseFloat(o(a.roughness,.15)),c.metalness=parseFloat(o(a.metalness,.34)),c.name=`${a.name}_folded`,c.userData={...a.userData},delete c.userData.detailed,Up(c),t.set(s,c),r++);let l=e.geometry,u=l.attributes.position.count;l.userData._foldedFor!==void 0&&l.userData._foldedFor!==a.uuid&&(e.geometry=l.clone());let d=e.geometry,f=new Float32Array(u*3),{r:p,b:m,g:h}=a.color;for(let e=0;e<u;e++)f[e*3]=p,f[e*3+1]=h,f[e*3+2]=m;d.setAttribute(`color`,new hr(f,3)),d.userData._foldedFor=a.uuid,e.material=c,n++}),{folded:n,families:r}}function Yp(e){let t=new W,n=new W,r=0,i=0,a=0;for(let o of e){o.updateMatrixWorld(!0);let e=[];if(o.traverse(t=>{t.isMesh&&t.geometry&&!Array.isArray(t.material)&&e.push(t)}),r+=e.length,e.length<2){i+=e.length;continue}t.copy(o.matrixWorld).invert();let s=new Map;for(let t of e){let e=`${t.material.uuid}|${Gp(t.geometry)}|${+!!t.castShadow}${+!!t.receiveShadow}`,n=s.get(e);n||s.set(e,n={material:t.material,meshes:[]}),n.meshes.push(t)}if(s.size===e.length){i+=e.length;continue}let c=!0,l=[];for(let{material:e,meshes:r}of s.values()){if(r.length<2){l.push(null);continue}let i=r.map(e=>{let r=e.geometry.clone();return Kp(r),n.multiplyMatrices(t,e.matrixWorld),r.applyMatrix4(n),r}),a=null;try{a=Au(i,!1)}catch{a=null}if(i.forEach(e=>e.dispose()),!a){c=!1;break}let o=new K(a,e);o.castShadow=r[0].castShadow,o.receiveShadow=r[0].receiveShadow,l.push({mesh:o,replaced:r})}if(!c){l.forEach(e=>e?.mesh.geometry.dispose()),i+=e.length;continue}for(let e of l)if(e){for(let t of e.replaced)t.parent?.remove(t),t.geometry.dispose();o.add(e.mesh),a++}let u=0;o.traverse(e=>{e.isMesh&&u++}),i+=u}return{before:r,after:i,collapsed:a}}var Xp=.5,Zp=class{constructor(e,t){let n=1/0,r=1/0,i=-1/0,a=-1/0;for(let t of e)n=Math.min(n,t.x1,t.x2),i=Math.max(i,t.x1,t.x2),r=Math.min(r,t.z1,t.z2),a=Math.max(a,t.z1,t.z2);this.minX=n-2,this.minZ=r-2,this.nx=Math.ceil((i-n+4)/Xp),this.nz=Math.ceil((a-r+4)/Xp),this.ny=Math.ceil((t+1)/Xp),this.grid=new Uint8Array(this.nx*this.ny*this.nz);for(let t of e)this._stamp(t)}_idx(e,t,n){return(t*this.nz+n)*this.nx+e}_stamp(e){let t=e.x2-e.x1,n=e.z2-e.z1,r=Math.hypot(t,n);if(!r)return;let i=Math.ceil(r/(Xp*.5)),a=Math.max(Xp,e.thickness??.3),o=-n/r,s=t/r,c=e.yMin??0,l=e.yMax??3.4;for(let r=0;r<=i;r++){let u=r/i,d=e.x1+t*u,f=e.z1+n*u;for(let e=-1;e<=1;e++){let t=d+o*(e*a*.5),n=f+s*(e*a*.5),r=Math.floor((t-this.minX)/Xp),i=Math.floor((n-this.minZ)/Xp);if(!(r<0||i<0||r>=this.nx||i>=this.nz))for(let e=Math.floor(c/Xp);e<=Math.min(this.ny-1,Math.floor(l/Xp));e++)this.grid[this._idx(r,e,i)]=1}}}solid(e,t,n){if(t<0)return!0;let r=Math.floor((e-this.minX)/Xp),i=Math.floor((n-this.minZ)/Xp),a=Math.floor(t/Xp);return r<0||i<0||a<0||r>=this.nx||i>=this.nz||a>=this.ny?!1:this.grid[this._idx(r,a,i)]===1}};function Qp(e){let t=[],n=Math.PI*(3-Math.sqrt(5));for(let r=0;r<e;r++){let i=1-r/(e-1)*.85,a=Math.sqrt(Math.max(0,1-i*i)),o=n*r;t.push(new V(Math.cos(o)*a,i,Math.sin(o)*a))}return t}var $p=Qp(10),em=[.35,.8,1.5],tm=[3,1.6,.7];function nm(e){let t=e.attributes.position;if(!t||t.count<12)return!0;e.computeBoundingBox();let n=new V;return e.boundingBox.getSize(n),2*(n.x*n.y+n.y*n.z+n.z*n.x)/t.count>rm}var rm=.6,im=.2,am=2;function om(e){let t=e.attributes.position,n=e.index,r=t.count,i=new Float32Array(r),a=new Float32Array(r),o=n?n.count/3:r/3,s=new V,c=new V,l=new V,u=new V,d=new V;for(let e=0;e<o;e++){let r=n?n.getX(e*3):e*3,o=n?n.getX(e*3+1):e*3+1,f=n?n.getX(e*3+2):e*3+2;s.fromBufferAttribute(t,r),c.fromBufferAttribute(t,o),l.fromBufferAttribute(t,f);let p=u.subVectors(c,s).cross(d.subVectors(l,s)).length()*.5;i[r]+=p,i[o]+=p,i[f]+=p,a[r]++,a[o]++,a[f]++}let f=new Float32Array(r);for(let e=0;e<r;e++){let t=((a[e]?i[e]/a[e]:am)-im)/(am-im);f[e]=Math.min(1,Math.max(0,1-t))}return f}function sm(e,t,n={}){let r=n.strength??.55,i=new Zp(t,n.wallHeight??3.4),a=performance.now(),o=new V,s=new V,c=new V,l=new V,u=new V,d=0,f=0,p=0;return e.updateMatrixWorld(!0),e.traverse(e=>{if(!e.isMesh||!e.geometry)return;let t=e.geometry,n=t.attributes.color,a=t.attributes.position,m=t.attributes.normal;if(!n||!a||!m)return;if(nm(t)){p++;return}f++;let h=om(t);for(let t=0;t<a.count;t++){o.fromBufferAttribute(a,t).applyMatrix4(e.matrixWorld),s.fromBufferAttribute(m,t).transformDirection(e.matrixWorld).normalize(),c.set(s.z,0,-s.x),c.lengthSq()<1e-6&&c.set(1,0,0),c.normalize(),l.crossVectors(s,c);let f=0,p=0;for(let e of $p){u.set(c.x*e.x+s.x*e.y+l.x*e.z,c.y*e.x+s.y*e.y+l.y*e.z,c.z*e.x+s.z*e.y+l.z*e.z);for(let e=0;e<em.length;e++){let t=em[e],n=tm[e];p+=n,i.solid(o.x+u.x*t+s.x*.12,o.y+u.y*t+s.y*.12,o.z+u.z*t+s.z*.12)&&(f+=n)}}let g=p?f/p:0,_=r*h[t],v=Math.max(1-_,1-g*_);n.setXYZ(t,n.getX(t)*v,n.getY(t)*v,n.getZ(t)*v),d++}n.needsUpdate=!0}),{meshes:f,skipped:p,vertices:d,ms:+(performance.now()-a).toFixed(0)}}var cm={vanguard:{name:`Vanguard`,blurb:`Balanced. Three-hit chains.`,detail:`No weakness, no trick. Chains light into light into heavy.`,mods:{chainDepth:3}},bulwark:{name:`Bulwark`,blurb:`Blocking costs nothing. Slow.`,detail:`Holds the line. Blocked heavies do not drain you, and a matched guard turns aside a fifth of the damage — but every swing is slower.`,mods:{windupMul:1.14,blockStaminaMul:0,guardReduction:.2,chainDepth:2,healthMul:1.08}},berserker:{name:`Berserker`,blurb:`Faster as you bleed.`,detail:`Swings 12% quicker, and hits harder the closer you are to death — but you have less to give.`,mods:{windupMul:.88,damageMul:1.05,healthMul:.86,woundedDamage:.35,chainDepth:3}},skirmisher:{name:`Skirmisher`,blurb:`Evasive. Cheap, long dodges.`,detail:`Longer invulnerability on a dodge at half the stamina, and quicker on your feet — but you hit lighter.`,mods:{dodgeIFrameMul:1.45,dodgeCostMul:.55,speedMul:1.08,damageMul:.9,chainDepth:2}},duellist:{name:`Duellist`,blurb:`Punishing parries.`,detail:`A far more forgiving parry window, and staggered opponents take much more from you — but you are fragile.`,mods:{parryWindowMul:1.5,staggeredDamageMul:1.4,healthMul:.92,chainDepth:2}}},lm={none:{name:`—`,blurb:`No perk`,mods:{}},ironclad:{name:`Ironclad`,blurb:`Matched guard sheds 15% damage`,mods:{guardReduction:.15}},secondwind:{name:`Second Wind`,blurb:`A parry restores 25 stamina`,mods:{staminaOnParry:25}},sapper:{name:`Sapper`,blurb:`+1 breach charge`,mods:{gadgetBonus:{breach:1}}},quartermaster:{name:`Quartermaster`,blurb:`+1 barricade, +1 reinforcement`,mods:{gadgetBonus:{barricade:1,reinforce:1}}},executioner:{name:`Executioner`,blurb:`+30% damage to staggered foes`,mods:{staggeredDamageMul:1.3}},lightfoot:{name:`Lightfoot`,blurb:`+10% movement speed`,mods:{speedMul:1.1}},enduring:{name:`Enduring`,blurb:`+25% stamina recovery`,mods:{staminaRegenMul:1.25}},keeneye:{name:`Keen Eye`,blurb:`+25% parry window`,mods:{parryWindowMul:1.25}}},um={windupMul:1,damageMul:1,healthMul:1,speedMul:1,parryWindowMul:1,dodgeIFrameMul:1,dodgeCostMul:1,blockStaminaMul:1,staminaRegenMul:1,staggeredDamageMul:1,guardReduction:0,woundedDamage:0,staminaOnParry:0,chainDepth:2,gadgetBonus:{}};function dm(e,t=[]){let n={...um,gadgetBonus:{}},r=[cm[e]?.mods].concat(t.map(e=>lm[e]?.mods)).filter(Boolean);for(let e of r)for(let[t,r]of Object.entries(e))if(t===`gadgetBonus`)for(let[e,t]of Object.entries(r))n.gadgetBonus[e]=(n.gadgetBonus[e]||0)+t;else t===`guardReduction`?n.guardReduction=1-(1-n.guardReduction)*(1-r):t===`chainDepth`?n.chainDepth=Math.max(n.chainDepth,r):t.endsWith(`Mul`)?n[t]=(n[t]??1)*r:n[t]=(n[t]??0)+r;return n}var fm=Object.keys(cm),pm=Object.keys(lm),mm=new V,hm=[{name:`Iron Blue`,hex:1781611},{name:`Blood Red`,hex:7214100},{name:`Forest`,hex:1983782},{name:`Imperial`,hex:4856924},{name:`Ash Grey`,hex:3356735},{name:`Ochre`,hex:9069080},{name:`Bone`,hex:10130044},{name:`Black`,hex:1184534}],gm=[`archetype`,`weapon`,`armour`,`perk1`,`perk2`,`heraldry`,`name`],_m=14,vm=class{constructor({armours:e,weapons:t,heraldry:n=hm}){this.armours=e,this.weapons=t,this.heraldry=n,this.armourIndex=0,this.weaponIndex=0,this.heraldIndex=0,this.archetypeIndex=0,this.perkIndex=[1,2],this.name=`Warden`,this.category=0,this.done=!1,this.dirty=!0,this.time=0,this.spin=0,this.flash=0}get armour(){return this.armours[this.armourIndex]}get weapon(){return this.weapons[this.weaponIndex]}get herald(){return this.heraldry[this.heraldIndex]}get archetypeKey(){return fm[this.archetypeIndex]}get archetype(){return cm[this.archetypeKey]}perkKeyAt(e){return pm[this.perkIndex[e]]}get perkKeys(){return[this.perkKeyAt(0),this.perkKeyAt(1)]}handle(e){this._consumeText(e);let t=!1;for(let n of e.keys||[])switch(n){case`ArrowDown`:case`KeyS`:this.category=(this.category+1)%gm.length;break;case`ArrowUp`:case`KeyW`:this.category=(this.category+gm.length-1)%gm.length;break;case`ArrowRight`:case`KeyD`:this._cycle(1);break;case`ArrowLeft`:case`KeyA`:this._cycle(-1);break;case`Enter`:case`NumpadEnter`:case`Space`:this.done=!0,t=!0;break;default:break}return t}_consumeText(e){if(!(gm[this.category]!==`name`||!e.typed)){for(let t of e.typed)t===`\b`?this.name=this.name.slice(0,-1):this.name.length<_m&&/[\w '-]/.test(t)&&(this.name+=t);this.name||=` `}}_cycle(e){let t=(t,n)=>(t+e+n)%n;switch(gm[this.category]){case`armour`:this.armourIndex=t(this.armourIndex,this.armours.length),this.dirty=!0;break;case`weapon`:this.weaponIndex=t(this.weaponIndex,this.weapons.length),this.dirty=!0;break;case`heraldry`:this.heraldIndex=t(this.heraldIndex,this.heraldry.length),this.dirty=!0;break;case`archetype`:this.archetypeIndex=t(this.archetypeIndex,fm.length),this.dirty=!0;break;case`perk1`:case`perk2`:{let e=gm[this.category]===`perk1`?0:1,n=this.perkIndex[1-e];do this.perkIndex[e]=t(this.perkIndex[e],pm.length);while(this.perkIndex[e]===n&&pm[n]!==`none`);this.dirty=!0;break}default:break}this.flash=.25}update(e){this.time+=e,this.spin+=e*.32,this.flash=Math.max(0,this.flash-e)}poseCamera(e,t){t.yaw=this.spin;let n=e.aspect||1.777,r=At.clamp(.32*n-.12,.12,.45);mm.set(t.pos.x+.85,1.52,t.pos.z-3.05),e.position.copy(mm),e.lookAt(t.pos.x-r,1,t.pos.z)}draw(e,t){let n=e.ctx,r=e.s,i=e.w,a=e.h;n.save();let o=Math.min(i*.62,380*r),s=n.createLinearGradient(0,0,o,0);s.addColorStop(0,`rgba(6,8,12,0.88)`),s.addColorStop(.7,`rgba(6,8,12,0.72)`),s.addColorStop(1,`rgba(6,8,12,0)`),n.fillStyle=s,n.fillRect(0,0,o,a);let c=54*r,l=96*r;n.textAlign=`left`,n.font=`800 ${13*r}px ui-sans-serif, system-ui, sans-serif`,n.letterSpacing=`${6*r}px`,n.fillStyle=`rgba(224,138,60,0.95)`,n.fillText(`CHOOSE YOUR CHAMPION`,c,l),l+=40*r,[[`ARCHETYPE`,this.archetype.name,this.archetype.blurb],[`WEAPON`,this.weapon.name,`${this.weapon.damageMul*100|0}% damage`],[`ARMOUR`,this.armour.name,`${this.armour.health} hp · ${this.armour.speedMul*100|0}% speed`],[`PERK I`,lm[this.perkKeyAt(0)].name,lm[this.perkKeyAt(0)].blurb],[`PERK II`,lm[this.perkKeyAt(1)].name,lm[this.perkKeyAt(1)].blurb],[`HERALDRY`,this.herald.name,``],[`NAME`,this.name,``]].forEach(([e,t,i],a)=>{let o=a===this.category;if(n.letterSpacing=`${2*r}px`,n.font=`600 ${10*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=o?`rgba(215,222,233,0.7)`:`rgba(215,222,233,0.32)`,n.fillText(e,c,l),n.letterSpacing=`${1*r}px`,n.font=`${o?700:500} ${19*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=o?`#f0f4fa`:`rgba(215,222,233,0.5)`,n.fillText(t,c+22*r,l+26*r),o){if(n.fillStyle=`#e08a3c`,n.fillRect(c-12*r,l-9*r,3*r,46*r),gm[a]!==`name`){let e=.55+Math.sin(this.time*5)*.25;n.globalAlpha=e,n.font=`700 ${16*r}px ui-sans-serif, system-ui, sans-serif`,n.fillText(`‹`,c+4*r,l+26*r),n.fillText(`›`,c+250*r,l+26*r),n.globalAlpha=1}else if(Math.sin(this.time*6)>0){let e=n.measureText(this.name).width;n.fillRect(c+26*r+e,l+8*r,2*r,22*r)}}i&&(n.letterSpacing=`${.5*r}px`,n.font=`500 ${10*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=o?`rgba(224,138,60,0.85)`:`rgba(215,222,233,0.28)`,n.fillText(i,c+22*r,l+41*r)),l+=58*r});let u=gm.indexOf(`heraldry`),d=c+22*r,f=96*r+40*r+58*r*u+32*r;this.heraldry.forEach((e,t)=>{let i=d+t*26*r;n.fillStyle=`#${e.hex.toString(16).padStart(6,`0`)}`,n.fillRect(i,f,18*r,12*r),n.strokeStyle=t===this.heraldIndex?`#f0f4fa`:`rgba(215,222,233,0.25)`,n.lineWidth=t===this.heraldIndex?2*r:1,n.strokeRect(i+.5,f+.5,18*r-1,12*r-1)});let p=l+6*r;this._stats(n,r,c,p,t);let m=p+62*r;n.fillStyle=`rgba(215,222,233,0.16)`,n.fillRect(c,m-20*r,300*r,1),n.letterSpacing=`${1*r}px`,n.font=`500 ${12*r}px ui-sans-serif, system-ui, sans-serif`,n.fillStyle=`rgba(215,222,233,0.62)`,n.fillText(`W / S   choose a row`,c,m),n.fillText(`A / D   change it`,c,m+20*r),n.fillText(`ENTER / SPACE   take the field`,c,m+40*r),n.restore()}_stats(e,t,n,r,i){let a=this.armour,o=[[`REACH`,`${(i?.reach??0).toFixed(2)} m`],[`DAMAGE`,`${Math.round((this.weapon.damageMul??1)*100)}%`],[`HEALTH`,`${a.health}`],[`SPEED`,`${Math.round((a.speedMul??1)*100)}%`]];e.letterSpacing=`${2*t}px`,o.forEach(([i,a],o)=>{let s=n+o*92*t;e.font=`600 ${9*t}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`rgba(215,222,233,0.4)`,e.fillText(i,s,r),e.font=`700 ${17*t}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`#d7dee9`,e.fillText(a,s,r+22*t)})}};function ym(e,t,n){e.root.traverse(e=>{if(!e.isMesh||!e.material)return;let r=e.material.name||``;n.test(r)&&(e.material.userData.heraldClone||(e.material=e.material.clone(),e.material.userData.heraldClone=!0,Up(e.material)),e.material.color.setHex(t))})}var bm=new V,xm=new V,Sm=new jt,Cm=new V(0,1,0),wm=.66,Tm=26,Em=.85,Dm=3.2,Om=.22,km=15,Am=22,jm=class{constructor(e){this.name=e.name,this.rig=new of(e.model),this.rig.attachWeapon(e.weapon,e.grip),this.group=new Dn,this.group.add(e.model),this.profile=e.profile,this.calibratedReach=2.2,this.contact=null,this.pos=new V(e.x??0,0,e.z??0),this.yaw=e.yaw??0,this.maxHealth=e.health??130,this.health=this.maxHealth,this.stamina=100,this.staminaTimer=0,this.exhausted=0,this.guard=`right`,this.state=`idle`,this.stateTime=0,this.attack=null,this.clip=xf.right,this.clipTime=0,this.clipHold=!1,this.sample=ff(),this.prevSample=ff(),this.outSample=ff(),this.fade=1,this.fadeTime=.12,this.lastFwd=0,this.lastSide=0,this.velocity=new V,this.moveInput=new B,this.feet={L:Nm(this.pos,.19,.2,this.yaw),R:Nm(this.pos,-.17,-.22,this.yaw)},this.events=[],this.gbCounterWindow=0,this.hitFlash=0,this.charge=0,this.chargeHeld=!1,this.blockedRecently=0,this.swaySeed=Math.random()*10,this.stepSide=`L`,this.stepTimer=0,this.gaitPhase=0,this.hitstunTime=.4,this.staggerScale=1,this.gbResolved=!0,this.frozen=!1,this.caltropSlow=0,this.revealedUntil=0,this.collider=null,this.faceOverride=null,this.freeLook=!1,this.traits=e.traits||dm(`vanguard`,[]),this.chainWindow=0,this.chainStep=0,this._calibrate()}setLoadout({model:e,weapon:t,grip:n,profile:r}){if(e&&e!==this.rig.root){this.group.remove(this.rig.root);let r=!!this.rig.firstPerson;this.rig=new of(e),this.group.add(e),this.rig.attachWeapon(t,n),r&&this.rig.setFirstPerson(!0)}else t&&this.rig.attachWeapon(t,n);return r&&(this.profile=r),this._calibrate(),this}_calibrate(e=.38,t=1.12){let n={pos:this.pos.clone(),yaw:this.yaw,state:this.state,clip:this.clip,clipTime:this.clipTime,fade:this.fade,attack:this.attack,feet:{L:this.feet.L.world.clone(),R:this.feet.R.world.clone()}};this.pos.set(0,0,0),this.yaw=0,this.state=`attack`,this.attack=null;let r={};for(let e of[`light`,`heavy`]){r[e]={};for(let t of cf){let n=Df[e][t],i=[],a=n.windup*.6,o=n.impact+n.recover*.4;for(let e=a;e<=o;e+=.008)this.clip=n,this.clipTime=e,this.fade=1,this._poseRig(0),i.push({t:e,p:this.rig.bladeTip(new V)});r[e][t]=i,this.events.length=0}}let i=(e,n)=>{let r=1/0;for(let i of e)r=Math.min(r,Math.hypot(i.p.x,i.p.y-t,i.p.z-n));return r},a=1.3;for(let t=1.3;t<=3.6;t+=.02){let n=!0;for(let a of[`light`,`heavy`]){for(let o of cf)if(i(r[a][o],t)>e){n=!1;break}if(!n)break}n&&(a=t)}this.calibratedReach=a,this.contact={light:{},heavy:{}},this.contactMiss={light:{},heavy:{}};for(let e of[`light`,`heavy`])for(let n of cf){let i=1/0,o=Df[e][n].impact;for(let s of r[e][n]){let e=Math.hypot(s.p.x,s.p.y-t,s.p.z-a);e<i&&(i=e,o=s.t)}this.contact[e][n]=o,this.contactMiss[e][n]=+i.toFixed(3)}Object.assign(this,{yaw:n.yaw,state:n.state,clip:n.clip,clipTime:n.clipTime,fade:n.fade,attack:n.attack}),this.pos.copy(n.pos);for(let e of[`L`,`R`]){let t=this.feet[e];t.world.copy(n.feet[e]),t.desired.copy(n.feet[e]),t.from.copy(n.feet[e]),t.to.copy(n.feet[e]),t.stepping=!1,t.t=1,t.lift=0}this.events.length=0}get alive(){return this.state!==`dead`}get reach(){return this.calibratedReach}get canAct(){return this.frozen?!1:this.state===`idle`?!0:this.state===`attack`?this.attack?this.chainWindow>0?this.clipTime>this.attack.strike:this.clipTime>this.clip.duration-this.attack.recover*.28:!0:this.state===`blockReact`?this.stateTime>.16:this.state===`parryReact`?this.stateTime>.2:this.state===`gb`&&this.clipTime>.42}get canBlock(){return this.state===`idle`||this.state===`blockReact`?!0:this.state===`parryReact`?this.stateTime>.24:this.state===`attack`?!this.attack||this.clipTime>this.clip.duration-this.attack.recover*.45:!1}get invulnerable(){let e=.25*this.traits.dodgeIFrameMul;return this.state===`dodge`&&this.stateTime>.09&&this.stateTime<.09+e}get attackPhase(){if(this.state!==`attack`)return null;let e=this.attack;return this.clipTime<e.windup?`windup`:this.clipTime<e.strike+.02?`active`:`recover`}play(e,{fade:t=.12,hold:n=!1}={}){Pm(this.outSample,this.prevSample),this.fade=0,this.fadeTime=Math.max(.001,t),this.clip=e,this.clipTime=0,this.clipHold=n||!!e.hold,this.lastFwd=0,this.lastSide=0}setState(e,t,n){this.state=e,this.stateTime=0,t&&this.play(t,n)}setGuard(e){return e===this.guard?!1:(this.guard=e,this.state===`idle`&&this.play(xf[e],{fade:.09}),!0)}spend(e){this.stamina=Math.max(0,this.stamina-e),this.staminaTimer=Em,this.stamina<=0&&this.exhausted<=0&&(this.exhausted=Dm,this.events.push({type:`exhausted`}))}startAttack(e,t=this.guard){if(!this.canAct)return!1;let n=Tf[e].stamina;if(this.stamina<n*.5)return!1;this.guard=t;let r=Df[e][t],i=this.chainWindow>0&&this.chainStep<this.traits.chainDepth;this.chainStep=i?this.chainStep+1:1,this.chainWindow=0;let a=(this.exhausted>0?1.3:1)*this.traits.windupMul*(i?.62:1);return this.attack={type:e,dir:t,windup:r.windup,strike:this.contact[e][t],recover:r.recover,chained:i,damage:Tf[e].damage*(this.profile.damageMul??1)*this.traits.damageMul*(1+this.traits.woundedDamage*(1-this.health/this.maxHealth)),resolved:!1,unblockable:!1,timeScale:1/a},this.charge=0,this.chargeHeld=e===`heavy`,this.spend(n),this.setState(`attack`,r,{fade:.07}),this.events.push({type:`swing`,attack:this.attack}),!0}openChain(){this.chainStep>=this.traits.chainDepth||(this.chainWindow=.62)}releaseCharge(){this.chargeHeld=!1}feint(){return this.state!==`attack`||this.clipTime>this.attack.windup*.82||this.stamina<8?!1:(this.spend(8),this.attack=null,this.charge=0,this.setState(`idle`,xf[this.guard],{fade:.1}),this.events.push({type:`feint`}),!0)}startGuardBreak(){return!this.canAct||this.stamina<8?!1:(this.spend(9),this.gbResolved=!1,this.gbCounterWindow=.38,this.setState(`gb`,Mf,{fade:.07}),this.events.push({type:`guardbreak`}),!0)}startDodge(e,t){if(!this.canAct&&this.state!==`blockReact`||this.stamina<10)return!1;e===0&&t===0&&(t=-1);let n=Math.hypot(e,t);return this.spend(17*this.traits.dodgeCostMul),this.setState(`dodge`,Pf(e/n,t/n),{fade:.06}),this.events.push({type:`dodge`}),!0}onBlocked(e,t){this.setState(`blockReact`,Of[e],{fade:.04}),this.blockedRecently=.5,t&&this.spend(6*this.traits.blockStaminaMul),this.exhausted>0&&t&&this.onStagger(.7)}onParrySuccess(e){this.setState(`parryReact`,kf[e],{fade:.04})}onStagger(e=1){this.attack=null,this.setState(`stagger`,jf,{fade:.05}),this.staggerScale=e,this.spend(14)}onThrown(){this.attack=null,this.setState(`thrown`,Nf,{fade:.05})}takeDamage(e,t,n){if(this.alive){if(this.health=Math.max(0,this.health-e),this.hitFlash=.28,this.health<=0){this.attack=null,this.setState(`dead`,Ff,{fade:.06,hold:!0}),this.events.push({type:`death`});return}this.attack=null,this.setState(`hitstun`,Af(t,n),{fade:.04}),this.hitstunTime=n?.6:.4}}resetForRound(){this.health=this.maxHealth,this.stamina=100,this.staminaTimer=0,this.exhausted=0,this.hitFlash=0,this.charge=0,this.chargeHeld=!1,this.caltropSlow=0,this.revealedUntil=0,this.faceOverride=null,this.gbCounterWindow=0,this.gbResolved=!0,this.blockedRecently=0,this.attack=null,this.clipHold=!1,this.velocity.set(0,0,0),this.moveInput.set(0,0),this.lastFwd=0,this.lastSide=0,this.stepTimer=0,this.gaitPhase=0,this._ghost=1,this.setState(`idle`,xf[this.guard]||xf.right,{fade:.01})}celebrate(){this.state!==`dead`&&this.setState(`victory`,If,{fade:.2,hold:!0})}update(e,t){this.stateTime+=e,this.hitFlash=Math.max(0,this.hitFlash-e),this.blockedRecently=Math.max(0,this.blockedRecently-e),this.gbCounterWindow=Math.max(0,this.gbCounterWindow-e),this.caltropSlow=Math.max(0,this.caltropSlow-e*1.6),this.chainWindow>0&&(this.chainWindow-=e,this.chainWindow<=0&&(this.chainStep=0)),this.exhausted>0&&(this.exhausted-=e),this.staminaTimer>0?this.staminaTimer-=e:this.stamina<100&&(this.stamina=Math.min(100,this.stamina+Tm*(this.exhausted>0?.55:1)*this.traits.staminaRegenMul*e)),this._advanceClip(e),this._updateState(e),t&&this.alive&&this._faceOpponent(t,e),this._applyMovement(e,t),this._poseRig(e)}_advanceClip(e){let t=this.attack;if(this.state===`attack`&&t&&t.type===`heavy`&&this.chargeHeld&&this.clipTime>=t.windup&&this.charge<.75){this.charge+=e,this.charge>.26&&!t.unblockable&&(t.unblockable=!0,t.damage*=1.35,this.events.push({type:`unblockable`})),this.clipTime=t.windup;return}let n=t&&this.state===`attack`?t.timeScale:1;this.clipTime+=e*n,this.clipHold||(this.clipTime=Math.min(this.clipTime,this.clip.duration)),this.fade=Math.min(1,this.fade+e/this.fadeTime)}_updateState(e){switch(this.state){case`attack`:this.attack&&this.clipTime>=this.clip.duration&&(this.attack=null,this.setState(`idle`,xf[this.guard],{fade:.14}));break;case`blockReact`:case`parryReact`:this.clipTime>=this.clip.duration&&this.setState(`idle`,xf[this.guard],{fade:.12});break;case`hitstun`:this.stateTime>=this.hitstunTime&&this.setState(`idle`,xf[this.guard],{fade:.14});break;case`stagger`:case`thrown`:case`dodge`:case`gb`:this.clipTime>=this.clip.duration&&this.setState(`idle`,xf[this.guard],{fade:.14});break}}_faceOpponent(e,t){if(this.freeLook&&!this.faceOverride)return;this.faceOverride?(bm.set(this.faceOverride.x-this.pos.x,0,this.faceOverride.z-this.pos.z),bm.lengthSq()<1e-6&&bm.subVectors(e.pos,this.pos)):bm.subVectors(e.pos,this.pos);let n=Math.atan2(bm.x,bm.z)-this.yaw;for(;n>Math.PI;)n-=Math.PI*2;for(;n<-Math.PI;)n+=Math.PI*2;let r=this.state===`idle`?11:6;this.yaw+=n*Math.min(1,r*t)}_applyMovement(e,t){let n=(this.state===`idle`||this.state===`blockReact`)&&!this.frozen,r=bm.set(0,0,0);if(n&&this.alive){let e=(this.exhausted>0?.72:1)*(1-this.caltropSlow)*(this.profile.speedMul??1)*this.traits.speedMul,t=(this.moveInput.y>=0?2.55:2.05)*e;r.set(this.moveInput.x*2.25*e,0,this.moveInput.y*t),r.applyAxisAngle(Cm,this.yaw)}xm.subVectors(r,this.velocity);let i=(r.lengthSq()>this.velocity.lengthSq()?km:Am)*e;xm.lengthSq()>i*i&&xm.setLength(i),this.velocity.add(xm),this.velocity.lengthSq()<1e-4&&this.velocity.set(0,0,0),this.pos.addScaledVector(this.velocity,e);let a=this.outSample,o=a.fwd-this.lastFwd,s=a.side-this.lastSide;if(this.lastFwd=a.fwd,this.lastSide=a.side,(o||s)&&Number.isFinite(o)&&Number.isFinite(s)&&(bm.set(s,0,o).applyAxisAngle(Cm,this.yaw),this.pos.add(bm)),t){bm.subVectors(this.pos,t.pos),bm.y=0;let e=bm.length(),n=wm*2;e<n&&e>1e-4&&this.pos.addScaledVector(bm.normalize(),(n-e)*.5)}this.collider&&this.collider.collide(this.pos,.42);let c=Math.hypot(this.pos.x,this.pos.z);c>30&&this.pos.multiplyScalar(30/c)}push(e,t){bm.copy(e).setY(0).normalize().multiplyScalar(t),this.pos.add(bm)}_poseRig(e){this.clip.sample(Math.min(this.clipTime,this.clip.duration),this.sample);let t=this.sample;if(this.fade<1?t=pf(this.prevSample,this.sample,this.fade,this.outSample):(Pm(this.sample,this.outSample),t=this.outSample),this.state===`idle`){let e=Sf(this.stateTime+this.swaySeed);t.y+=e.py,t.pose.Torso[0]+=e.pitch,t.pose.Torso[1]+=e.yaw*.4,t.pose.Head[1]-=e.yaw*.3}if(this.velocity.lengthSq()>.01){bm.copy(this.velocity).applyAxisAngle(Cm,-this.yaw);let e=Mm(bm.z,-2.6,2.6),n=Mm(bm.x,-2.4,2.4);t.pose.Torso[0]+=e*2.3,t.pose.Torso[2]+=-n*1.9,t.pose.Hips[1]+=-n*2.6,t.pose.Head[0]-=e*.9;let r=Math.min(1,this.velocity.length()/2.4);t.y+=Math.sin(this.gaitPhase*Math.PI*2)*.018*r,t.pose.Hips[2]+=Math.sin(this.gaitPhase*Math.PI)*2.4*r}this.group.position.copy(this.pos),this.group.rotation.set(0,this.yaw,0),this.group.updateMatrixWorld(!0);let n=this.rig;n.resetPose(),n.applyPose(t.pose);let r=n.joints.Hips;r&&r.position.set(0,af+t.y,0),n.root.updateMatrixWorld(!0),this._updateFeet(e,t),Sm.setFromAxisAngle(Cm,this.yaw);for(let e of[`L`,`R`])n.solveLeg(e,this.feet[e].world,Sm,this.feet[e].lift*55);n.setWeapon(t.p,t.b,t.roll),n.weaponAnchor.updateMatrixWorld(!0),n.solveGrips(this.profile.leadHand??`R`),n.root.updateMatrixWorld(!0)}_updateFeet(e,t){let n=this.velocity.length(),r=(this.state===`idle`||this.state===`blockReact`)&&n>.45,i=Mm(.6-n*.085,.25,.6),a=Mm(.3-n*.05,.13,.3),o=.045+Math.min(.085,n*.032),s=r?i*.55:.09;for(let e of[`L`,`R`]){let n=this.feet[e],r=e===`L`?t.feetL:t.feetR;bm.copy(r).applyAxisAngle(Cm,this.yaw).add(this.pos),n.desired.copy(bm)}let c=this.feet.L.stepping||this.feet.R.stepping;this.stepTimer-=e,r&&!c&&this.stepTimer<=0?(this._beginStep(this.stepSide,s),this.stepSide=this.stepSide===`L`?`R`:`L`,this.stepTimer=i):r||(this.stepTimer=0);for(let t of[`L`,`R`]){let n=this.feet[t];if(n.stepping){if(n.t+=e/a,n.t>=1)n.stepping=!1,n.t=1,n.world.copy(n.to).setY(0),n.lift=0,this.events.push({type:`footstep`,side:t});else{let e=n.t,t=e*e*(3-2*e);n.world.lerpVectors(n.from,n.to,t),n.lift=Math.sin(e*Math.PI)*o,n.world.y=n.lift}continue}let i=this.feet[t===`L`?`R`:`L`],c=n.world.distanceTo(n.desired),l=r?Om*1.9:Om;c>l&&(!i.stepping||c>l*2.1)?this._beginStep(t,s):n.world.y=0}r?this.gaitPhase+=e/Math.max(.12,i):this.gaitPhase+=e*.35}_beginStep(e,t){let n=this.feet[e];n.stepping=!0,n.t=0,n.from.copy(n.world),n.to.copy(n.desired).addScaledVector(this.velocity,t),n.to.y=0}};function Mm(e,t,n){return e<t?t:e>n?n:e}function Nm(e,t,n,r){let i=new V(t,0,n).applyAxisAngle(Cm,r).add(e);return{world:i.clone(),desired:i.clone(),from:i.clone(),to:i.clone(),stepping:!1,t:1,lift:0}}function Pm(e,t){t.p.copy(e.p),t.b.copy(e.b),t.roll=e.roll;for(let n in e.pose)t.pose[n][0]=e.pose[n][0],t.pose[n][1]=e.pose[n][1],t.pose[n][2]=e.pose[n][2];t.y=e.y,t.fwd=e.fwd,t.side=e.side,t.feetL.copy(e.feetL),t.feetR.copy(e.feetR)}var Fm={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},Im=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Lm=new Ho(-1,1,1,-1,0,1),Rm=new class extends Ar{constructor(){super(),this.setAttribute(`position`,new vr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new vr([0,2,0,0,2,0],2))}},zm=class{constructor(e){this._mesh=new K(Rm,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Lm)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Bm=class extends Im{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Va?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ra.clone(e.uniforms),this.material=new Va({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new zm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Vm=class extends Im{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Hm=class extends Im{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Um=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new B);this._width=n.width,this._height=n.height,t=new Xt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Bm(Fm),this.copyPass.material.blending=0,this.timer=new Qo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Vm!==void 0&&(r instanceof Vm?n=!0:r instanceof Hm&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new B);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Wm={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new G(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},Gm=class e extends Im{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new B(256,256):new B(e.x,e.y),this.clearColor=new G(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Xt(i,a,{type:_}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Xt(i,a,{type:_});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Xt(i,a,{type:_});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=Wm;this.highPassUniforms=Ra.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new Va({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new B(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new V(1,1,1),new V(1,1,1),new V(1,1,1),new V(1,1,1),new V(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=Ra.clone(Fm.uniforms),this.blendMaterial=new Va({uniforms:this.copyUniforms,vertexShader:Fm.vertexShader,fragmentShader:Fm.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new G,this._oldClearAlpha=1,this._basic=new oi,this._fsQuad=new zm(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new B(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new Va({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new B(.5,.5)},direction:{value:new B(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}_getCompositeMaterial(e){return new Va({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};Gm.BlurDirectionX=new B(1,0),Gm.BlurDirectionY=new B(0,1);var Km={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Ym={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new B(1/1024,1/512)}},vertexShader:`
		...
		}`},Xm={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new B(1/1024,1/512)}},vertexShader:`
		...
		}`},$m=class extends Bm{constructor(){super(Qm)}setSize(e,t){this.material.uniforms.resolution.value.set(1/e,1/t)}},eh=class extends Im{constructor(e){super(),this.fx=e,this.needsSwap=!1}render(e,t,n){let r=this.fx,i=e.autoClear;if(e.setRenderTarget(this.renderToScreen?null:n),e.autoClear=!0,e.render(r.scene,r.camera),r.viewmodel){let t=r.scene.background;r.scene.background=null,e.autoClear=!1,e.clearDepth(),e.render(r.scene,r.viewCam),r.scene.background=t}e.autoClear=i}},th={name:`GradeShader`,uniforms:{tDiffuse:{value:null},uResolution:{value:new B(1,1)},uSeed:{value:new B(0,0)},uTime:{value:0},uGrainScale:{value:1},uAberration:{value:1.1},uGrain:{value:.055},uVignette:{value:.34},uDamage:{value:0},uLowHealth:{value:0},uHitFlash:{value:0},uSlowmo:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `},nh={high:{aa:`fxaa`,pixelRatioCap:1.5,bloomScale:1,bloomStrength:.62,bloomRadius:.58,bloomThreshold:1,aberration:1.1,grain:.055,vignette:.34},medium:{aa:`fxaa`,pixelRatioCap:1,bloomScale:.5,bloomStrength:.55,bloomRadius:.7,bloomThreshold:1.05,aberration:0,grain:.045,vignette:.32}},rh=class{constructor({renderer:e,scene:t,camera:n,viewCam:r,quality:i=`high`,enabled:a=!0,aa:o,pixelRatioCap:s}){this.renderer=e,this._aaOverride=o,this._prOverride=s,this.scene=t,this.camera=n,this.viewCam=r,this.enabled=a,this.viewmodel=!0,this.damage=0,this.lowHealth=0,this.hitFlash=0,this.slowmo=0,this.autoDecay=!0,this.damageDecay=2.2,this.hitFlashDecay=7;let c=e.getSize(new B);this.width=Math.max(1,Math.round(c.x)||1),this.height=Math.max(1,Math.round(c.y)||1),this._t=0,this._pixelRatio=1,this.quality=`off`,this.composer=null,this.setQuality(i)}setQuality(e){let t=nh[e]?e:`off`;if(t===this.quality||(this.quality=t,this._teardown(),t===`off`))return;let n=nh[t],r=new Xt(1,1,{type:_,depthBuffer:!0,stencilBuffer:!1});r.texture.name=`PostFX.scene`,this.composer=new Um(this.renderer,r),this.composer.renderToScreen=!0,this.worldPass=new eh(this),this.composer.addPass(this.worldPass),this.bloomPass=new Gm(new B(1,1),n.bloomStrength,n.bloomRadius,n.bloomThreshold),this.composer.addPass(this.bloomPass),this.outputPass=new qm,this.composer.addPass(this.outputPass);let i=this._aaOverride||n.aa;this.aaPass=i===`smaa`?new Zm:new $m,this.composer.addPass(this.aaPass),this.gradePass=new Bm(th),this.grade=this.gradePass.uniforms,this.grade.uAberration.value=n.aberration,this.grade.uGrain.value=n.grain,this.grade.uVignette.value=n.vignette,this.composer.addPass(this.gradePass),this._bloomScale=n.bloomScale,this._pixelRatioCap=this._prOverride??n.pixelRatioCap,this._resize()}dispose(){this._teardown()}_teardown(){if(this.composer){for(let e of this.composer.passes)e.dispose?.();this.composer.renderTarget1.dispose(),this.composer.renderTarget2.dispose(),this.composer.copyPass.dispose?.(),this.composer=null,this.worldPass=this.bloomPass=this.outputPass=null,this.aaPass=this.gradePass=this.grade=null}}setSize(e,t){this.width=Math.max(1,Math.round(e)||0),this.height=Math.max(1,Math.round(t)||0),this._resize()}_resize(){if(!this.composer)return;let e=Math.max(.5,Math.min(this._pixelRatioCap,this.renderer.getPixelRatio()||1));this._pixelRatio=e;let t=Math.max(1,Math.round(this.width*e)),n=Math.max(1,Math.round(this.height*e));this.composer.setPixelRatio(1),this.composer.setSize(t,n),this._bloomScale!==1&&this.bloomPass.setSize(Math.max(2,Math.round(t*this._bloomScale)),Math.max(2,Math.round(n*this._bloomScale))),this.grade.uResolution.value.set(t,n),this.grade.uGrainScale.value=Math.max(1,Math.round(e))}render(e){let t=Number.isFinite(e)&&e>0?Math.min(e,.1):1/60;if(!this.enabled||!this.composer){this._renderDirect(),this._tick(t);return}let n=Math.min(this._pixelRatioCap,this.renderer.getPixelRatio()||1);Math.abs(n-this._pixelRatio)>.001&&this._resize(),this._push(),this.composer.render(t),this._tick(t)}_renderDirect(){let e=this.renderer;if(e.setRenderTarget(null),e.render(this.scene,this.camera),!this.viewmodel)return;let t=this.scene.background;this.scene.background=null;let n=e.autoClear;e.autoClear=!1,e.clearDepth(),e.render(this.scene,this.viewCam),e.autoClear=n,this.scene.background=t}_tick(e){this._t=(this._t+e)%600,this.autoDecay&&(this.damage=Math.max(0,this.damage-e*this.damageDecay),this.hitFlash=Math.max(0,this.hitFlash-e*this.hitFlashDecay))}_push(){let e=this.grade,t=e=>e>1?1:e>0?e:0;e.uTime.value=this._t,e.uSeed.value.set(Math.random()*512,Math.random()*512),e.uDamage.value=t(this.damage),e.uLowHealth.value=t(this.lowHealth),e.uHitFlash.value=t(this.hitFlash),e.uSlowmo.value=t(this.slowmo)}},ih=(e,t,n)=>e<t?t:e>n?n:e,ah=(e,t)=>e+Math.random()*(t-e),oh=1e-4,sh=40,ch=.18,lh=8,uh=73.416,dh={aeolian:[0,2,3,5,7,8,10],phrygian:[0,1,3,5,7,8,10],dorian:[0,2,3,5,7,9,10]};function fh(e,t){let n=dh[e]||dh.aeolian,r=n.length,i=Math.floor(t/r);return n[(t%r+r)%r]+12*i}var ph=e=>uh*2**(e/12),mh={menu:{mode:`aeolian`,bpm:46,layers:{drone:.55,buzz:0,air:.14,pluck:.95,perc:0,ost:0,pulse:0,swell:.1}},prep:{mode:`aeolian`,bpm:62,layers:{drone:.62,buzz:.1,air:.2,pluck:.45,perc:.55,ost:0,pulse:1,swell:.06}},stalk:{mode:`phrygian`,bpm:50,layers:{drone:.42,buzz:.05,air:.62,pluck:.14,perc:.08,ost:0,pulse:.18,swell:.34}},combat:{mode:`phrygian`,bpm:96,layers:{drone:.92,buzz:.62,air:.1,pluck:0,perc:1,ost:1,pulse:.35,swell:.03}},victory:{mode:`dorian`,bpm:56,layers:{drone:.55,buzz:0,air:.12,pluck:.75,perc:.18,ost:0,pulse:0,swell:0}},defeat:{mode:`phrygian`,bpm:42,layers:{drone:.52,buzz:.06,air:.3,pluck:.5,perc:.04,ost:0,pulse:0,swell:.06}}},hh={drone:.34,buzz:.15,air:.28,pluck:.48,perc:.58,ost:.24,pulse:.46,swell:.32,fx:.85},gh={drone:.1,buzz:.05,air:.06,pluck:.34,perc:.16,ost:.09,pulse:.04,swell:.55,fx:.4},_h=[`drone`,`buzz`,`air`,`pluck`,`perc`,`ost`,`pulse`,`swell`,`fx`],vh=[0,4,2,4,7,4,2,-1,0,3,2,0],yh=[0,3,4,3,0,2,4,5],bh=[0,0,1,0,3,0,1,-2],xh=class{constructor(){this.ctx=null,this._engine=null,this._dest=null,this._offline=!1,this._supported=!0,this._built=!1,this._running=!1,this._gen=0,this._volume=.7,this._intTarget=.25,this._int=.25,this._state=`menu`,this._st=mh.menu,this._bpm=mh.menu.bpm,this._step=0,this._nextStep=0,this._mixAccum=1,this._phrase=0,this._nextSwell=0,this._activeVoices=0,this._nodes=[],this._sources=[],this._layer={},this._teardown=null,this._noiseWhite=null,this._noiseBrown=null,this._softCurve=null,this._droneLP=null,this._buzzBP=null}attach(e){if(this._supported)try{this._engine=e||null,this._resolveCtx()}catch{}}start(){if(!(!this._supported||this._running))try{if(this._running=!0,this._teardown&&=(clearTimeout(this._teardown),null),!this._ensure())return;this._beginTransport()}catch{}}stop(){if(!this._running)return;this._running=!1;let e=this.ctx;if(!(!e||!this._built))try{let t=e.currentTime,n=this._bus.gain;n.cancelScheduledValues(t),n.setValueAtTime(n.value,t),n.linearRampToValueAtTime(0,t+.7);let r=this._gen;this._teardown=setTimeout(()=>{r===this._gen&&this._dispose()},1100)}catch{this._dispose()}}setVolume(e){if(this._volume=ih(Number(e)||0,0,1),!(!this._built||!this.ctx))try{let e=this.ctx.currentTime,t=this._bus.gain;t.cancelScheduledValues(e),t.setValueAtTime(t.value,e),t.linearRampToValueAtTime(this._running?this._volume:0,e+.08)}catch{}}setIntensity(e){let t=Number(e);this._intTarget=ih(isFinite(t)?t:0,0,1)}setState(e){if(!(!mh[e]||e===this._state)&&(this._state=e,this._st=mh[e],this._phrase=0,this._nextSwell=0,this._mixAccum=1,this._built&&this._running&&(e===`victory`||e===`defeat`)))try{this._cadence(e,this.ctx.currentTime+.03)}catch{}}update(e){if(!this._running||!this._supported)return;let t=ih(Number(e)||.016,0,.25);try{if(!this._built){if(!this._ensure())return;this._beginTransport()}let e=this.ctx;if(!this._offline&&e.state===`suspended`){this._resume();return}if(e.state===`closed`)return;this._int+=(this._intTarget-this._int)*(1-Math.exp(-t*1.7));let n=this._targetBpm();this._bpm+=(n-this._bpm)*(1-Math.exp(-t*.9)),this._mixAccum+=t,this._mixAccum>=.1&&(this._applyMix(this._mixAccum),this._mixAccum=0),this._schedule()}catch{}}sting(e){if(this._supported)try{if(!this._ensure())return;let t=this.ctx;if(!this._offline&&t.state===`suspended`){this._resume();return}let n=t.currentTime+.02;switch(e){case`parry`:this._stingParry(n);break;case`breach`:this._stingBreach(n);break;case`roundwin`:this._cadence(`victory`,n);break;case`roundloss`:this._cadence(`defeat`,n);break;case`objective`:this._stingObjective(n);break;default:break}}catch{}}_resolveCtx(){if(this.ctx)return!0;let e=this._engine;if(!e)return!1;let t=e.ctx&&e.ctx.createGain&&e.ctx||e.context&&e.context.createGain&&e.context||e.createGain&&e.destination&&e;return t?(this.ctx=t,this._offline=!!(t.startRendering&&typeof t.length==`number`),this._dest=e._master&&e._master.gain&&e._master||e.master&&e.master.gain&&e.master||t.destination,!0):!1}_resume(){let e=this.ctx;if(!(!e||this._offline)&&!(!e.resume||e.state===`running`||e.state===`closed`))try{let t=e.resume();t&&t.catch&&t.catch(()=>{})}catch{}}_ensure(){if(this._built)return!0;if(!this._supported||!this._resolveCtx())return!1;try{return this._build(),this._built=!0,!0}catch{return this._supported=!1,this._dispose(),!1}}_build(){let e=this.ctx,t=e=>(this._nodes.push(e),e),n=e=>(this._nodes.push(e),this._sources.push(e),e);this._noiseWhite=this._makeNoise(e,2.5,`white`),this._noiseBrown=this._makeNoise(e,3,`brown`),this._softCurve=this._makeSoftCurve();let r=t(e.createGain());r.gain.value=this._running?this._volume:0,this._bus=r;let i=t(e.createBiquadFilter());i.type=`lowshelf`,i.frequency.value=140,i.gain.value=3.5;let a=t(e.createBiquadFilter());a.type=`highshelf`,a.frequency.value=1500,a.gain.value=-10;let o=t(e.createBiquadFilter());o.type=`lowpass`,o.frequency.value=7e3,o.Q.value=.5;let s=t(e.createDynamicsCompressor());s.threshold.value=-8,s.knee.value=6,s.ratio.value=3.5,s.attack.value=.01,s.release.value=.25,r.connect(i),i.connect(a),a.connect(o),o.connect(s),s.connect(this._dest);let c=t(e.createConvolver());c.buffer=this._makeImpulse(e,3.4,3.1);let l=t(e.createBiquadFilter());l.type=`lowpass`,l.frequency.value=2600;let u=t(e.createGain());u.gain.value=.9,c.connect(l),l.connect(u),u.connect(r),this._conv=c;for(let n of _h){let i=t(e.createGain());i.gain.value=0,i.connect(r);let a=t(e.createGain());a.gain.value=gh[n],i.connect(a),a.connect(c),this._layer[n]=i}this._layer.fx.gain.value=hh.fx;let d=t(e.createBiquadFilter());d.type=`lowpass`,d.frequency.value=260,d.Q.value=3,d.connect(this._layer.drone),this._droneLP=d;let f=e.currentTime,p=(r,i,a,o,s)=>{let c=n(e.createOscillator());c.type=r,c.frequency.value=i,c.detune.value=a;let l=t(e.createGain());return l.gain.value=o,c.connect(l),l.connect(s),c.start(f),c};p(`sawtooth`,uh,-4,.42,d),p(`sawtooth`,uh*1.002,7,.3,d),p(`triangle`,uh*1.5,3,.26,d),p(`sine`,uh*.5,0,.5,this._layer.drone),p(`triangle`,uh*2,-6,.16,d);let m=(r,i,a)=>{let o=n(e.createOscillator());o.type=`sine`,o.frequency.value=r;let s=t(e.createGain());return s.gain.value=i,o.connect(s),s.connect(a),o.start(f),o};m(.035,55,d.frequency);let h=t(e.createBiquadFilter());h.type=`bandpass`,h.frequency.value=300,h.Q.value=5.5;let g=t(e.createWaveShaper());g.curve=this._softCurve,h.connect(g),g.connect(this._layer.buzz),this._buzzBP=h,p(`sawtooth`,uh*2,5,.5,h),p(`sawtooth`,uh*3,-9,.34,h),m(.11,26,h.frequency);let _=n(e.createBufferSource());_.buffer=this._noiseBrown,_.loop=!0,_.playbackRate.value=.8;let v=t(e.createBiquadFilter());v.type=`bandpass`,v.frequency.value=230,v.Q.value=.6;let y=t(e.createGain());y.gain.value=.75,_.connect(v),v.connect(y),y.connect(this._layer.air),_.start(f,Math.random()*1.5),m(.047,110,v.frequency),m(.029,.22,y.gain);let b=n(e.createBufferSource());b.buffer=this._noiseWhite,b.loop=!0,b.playbackRate.value=.55;let x=t(e.createBiquadFilter());x.type=`bandpass`,x.frequency.value=820,x.Q.value=1.4;let S=t(e.createGain());S.gain.value=.05,b.connect(x),x.connect(S),S.connect(this._layer.air),b.start(f,Math.random()*1.5),m(.019,260,x.frequency)}_beginTransport(){let e=this.ctx;this._bpm=this._targetBpm(),this._step=0,this._nextStep=e.currentTime+.08,this._nextSwell=e.currentTime+ah(1.5,4),this._mixAccum=1;let t=this._bus.gain,n=e.currentTime;t.cancelScheduledValues(n),t.setValueAtTime(t.value,n),t.linearRampToValueAtTime(this._volume,n+1.4)}_dispose(){this._gen++,this._teardown&&=(clearTimeout(this._teardown),null);for(let e of this._sources){try{e.stop()}catch{}e.onended=null}for(let e of this._nodes)try{e.disconnect()}catch{}this._nodes.length=0,this._sources.length=0,this._layer={},this._bus=null,this._conv=null,this._droneLP=null,this._buzzBP=null,this._built=!1}_targetBpm(){let e=this._st.bpm;return this._state===`combat`?78+46*this._int:e*(.95+.12*this._int)}_applyMix(e){let t=this.ctx.currentTime,n=this._int,r=this._st.layers,i=Math.max(.12,Math.min(.5,e*3)),a={drone:r.drone*(.7+.45*n),buzz:r.buzz*(.14+1.05*n),air:r.air*(1.15-.4*n),pluck:r.pluck*(1-.3*n),perc:r.perc*(.24+.95*n),ost:r.ost*(.2+1*n),pulse:r.pulse*(.45+.75*n),swell:r.swell*(1-.5*n)};for(let e in a){let n=this._layer[e];if(!n)continue;let r=ih(a[e]*hh[e],0,2),o=n.gain;Math.abs(o.value-r)<8e-4||(o.cancelScheduledValues(t),o.setValueAtTime(o.value,t),o.linearRampToValueAtTime(r,t+i))}if(this._droneLP){let e=this._droneLP.frequency,r=190+780*n;e.cancelScheduledValues(t),e.setValueAtTime(e.value,t),e.linearRampToValueAtTime(r,t+i)}if(this._buzzBP){let e=this._buzzBP.frequency,r=230+480*n;e.cancelScheduledValues(t),e.setValueAtTime(e.value,t),e.linearRampToValueAtTime(r,t+i)}}_schedule(){let e=this.ctx.currentTime,t=30/this._bpm;if(this._nextStep<e-.05){let n=Math.ceil((e-this._nextStep)/t);this._nextStep+=n*t,this._step+=n}let n=e+ch,r=0;for(;this._nextStep<n&&r++<32;)this._scheduleStep(this._step,this._nextStep,t),this._nextStep+=t,this._step++,t=30/this._bpm;this._nextSwell&&this._nextSwell<n&&(this._st.layers.swell>.02&&this._swell(Math.max(this._nextSwell,e+.02)),this._nextSwell=Math.max(this._nextSwell,e)+ah(5,13))}_scheduleStep(e,t,n){if(this._activeVoices>=sh)return;let r=(e%lh+lh)%lh,i=Math.floor(e/lh),a=this._int,o=this._state,s=this._st.mode;if(this._st.layers.pulse>.05&&(r===0&&this._sub(t,.85,.5),r===0&&o!==`combat`&&this._sub(t+n*.62,.5,.42),o===`combat`&&r===4&&this._sub(t,.55,.42)),this._st.layers.perc>.02&&(o===`combat`?(r===0&&this._drum(t,1,.15),r===4&&this._drum(t,.82,.35),a>.22&&(r===2||r===6)&&this._drum(t,.45+.25*a,.6),a>.42&&(r===3||r===7)&&this._wood(t,.35+.35*a),a>.6&&r%2==1&&this._wood(t+n*.5,.18+.2*a),a>.7&&r===6&&i%2==1&&this._iron(t,.3+.3*a),a>.85&&r===0&&i%4==0&&this._iron(t,.5,300)):o===`prep`?(r===0&&this._drum(t,.55,.4),r===4&&this._wood(t,.22),i%4==3&&r===6&&this._iron(t,.16)):o===`stalk`?Math.random()<.05&&this._wood(t,ah(.06,.16)):o===`victory`&&r===0&&i%2==0&&this._drum(t,.5,.3)),this._st.layers.ost>.02){let e=bh[r],i=a>.55?1:a>.3?r%2==0:r===0||r===4;if(e!=null&&i){let i=fh(s,e);this._reed(t,ph(i+12),n*(r%2==0?1.05:.85),.5+.4*a)}}if(this._st.layers.pluck>.05)if(o===`menu`&&r===0&&i%2==0){let e=vh[this._phrase%vh.length];this._phrase++,this._phrase%4!=0&&(this._pluck(t+ah(0,.03),ph(fh(s,e)+12),.34,2.6),Math.random()<.3&&this._pluck(t+ah(.28,.5),ph(fh(s,e+4)),.16,2.2))}else if(o===`prep`&&(r===0||r===5)){let e=yh[this._phrase%yh.length];this._phrase++,this._pluck(t,ph(fh(s,e)+12),r===0?.3:.18,1.8)}else o===`stalk`&&r===0&&Math.random()<.18?this._pluck(t,ph(fh(s,Math.random()<.5?0:1)+12),.16,3):o===`defeat`&&r===0&&i%2==0?(this._pluck(t,ph(fh(s,[1,0,-3,0][this._phrase%4])+12),.26,3.2),this._phrase++):o===`victory`&&r===0&&(this._pluck(t,ph(fh(s,[0,4,7,4][this._phrase%4])+12),.28,2.6),this._phrase++)}_voice(e){let t=this.ctx.createGain();t.gain.value=1,t.connect(e||this._layer.fx),this._activeVoices++;let n=[t],r={out:t,nodes:n,sources:[],dead:!1,timer:null,add(e){return n.push(e),e},src(e){return n.push(e),r.sources.push(e),e}};return r}_reap(e,t){let n=()=>{if(!e.dead){e.dead=!0,this._activeVoices--;for(let t of e.sources)t.onended=null;for(let t of e.nodes)try{t.disconnect()}catch{}e.nodes.length=0,e.sources.length=0,e.timer&&=(clearTimeout(e.timer),null)}},r=e.sources.length;if(r===0){n();return}let i=()=>{--r<=0&&n()};for(let t of e.sources)t.onended=i;let a=Math.max(0,(t-this.ctx.currentTime)*1e3)+600;typeof setTimeout==`function`&&(e.timer=setTimeout(n,a))}_osc(e,t,n,r,i){let a=this.ctx.createOscillator();return a.type=t,a.frequency.setValueAtTime(n,r),e.src(a),a.start(r),a.stop(i),a}_noise(e,t,n,r,i){let a=r?this._noiseBrown:this._noiseWhite,o=this.ctx.createBufferSource();return o.buffer=a,o.loop=!0,o.playbackRate.value=i||1,e.src(o),o.start(t,Math.random()*(a.duration-.6)),o.stop(n),o}_gain(e,t){let n=this.ctx.createGain();return n.gain.value=t===void 0?0:t,e.add(n),n}_filter(e,t,n,r,i){let a=this.ctx.createBiquadFilter();return a.type=t,a.frequency.value=n,r!==void 0&&(a.Q.value=r),i!==void 0&&(a.gain.value=i),e.add(a),a}_env(e,t,n,r,i){e.setValueAtTime(oh,t),e.linearRampToValueAtTime(Math.max(n,oh*2),t+r),e.exponentialRampToValueAtTime(oh,t+Math.max(i,r+.01))}_drum(e,t,n,r){let i=this._voice(r||this._layer.perc),a=n===void 0?.4:n,o=(108-44*a)*ah(.96,1.05),s=.5-.22*a,c=e+s+.12,l=this._osc(i,`sine`,o*1.85,e,c);l.frequency.exponentialRampToValueAtTime(o*.62,e+.075);let u=this._gain(i,0);this._env(u.gain,e,t*.95,.004,s);let d=this.ctx.createWaveShaper();d.curve=this._softCurve,i.add(d),l.connect(u),u.connect(d),d.connect(i.out);let f=this._noise(i,e,e+.2,!0,ah(.85,1.2)),p=this._filter(i,`lowpass`,620,.9);p.frequency.exponentialRampToValueAtTime(190,e+.1);let m=this._gain(i,0);this._env(m.gain,e,t*.4,.002,.1),f.connect(p),p.connect(m),m.connect(i.out),this._reap(i,c)}_wood(e,t){let n=this._voice(this._layer.perc),r=e+.14,i=ah(380,780),a=this._osc(n,`triangle`,i,e,r);a.frequency.exponentialRampToValueAtTime(i*.8,e+.04);let o=this._gain(n,0);this._env(o.gain,e,t*.7,.001,.055),a.connect(o),o.connect(n.out);let s=this._noise(n,e,e+.05,!1,1),c=this._filter(n,`bandpass`,ah(900,1300),3.2),l=this._gain(n,0);this._env(l.gain,e,t*.22,8e-4,.012),s.connect(c),c.connect(l),l.connect(n.out),this._reap(n,r)}_iron(e,t,n,r){let i=this._voice(r||this._layer.perc),a=ah(.5,.9),o=e+a+.15,s=this._filter(i,`lowpass`,2400,.7);s.connect(i.out);let c=(n||ah(330,520))*ah(.97,1.04),l=[1,1.71,2.39,3.11,4.07];for(let n=0;n<l.length;n++){let r=c*l[n]*ah(.995,1.006),o=a*(1/(1+n*.5)),u=this._osc(i,n<2?`triangle`:`sine`,r,e,e+o+.05);u.detune.value=ah(-10,10);let d=this._gain(i,0);this._env(d.gain,e,t*(.34/(1+n*.6)),.002,o),u.connect(d),d.connect(s)}this._reap(i,o)}_sub(e,t,n,r){let i=this._voice(r||this._layer.pulse),a=e+.42,o=this._osc(i,`sine`,74,e,a);o.frequency.exponentialRampToValueAtTime(74*(1-.5*(n||.4)),e+.13);let s=this._gain(i,0);this._env(s.gain,e,t*.75,.012,.3),o.connect(s),s.connect(i.out),this._reap(i,a)}_pluck(e,t,n,r,i){let a=this.ctx,o=132.5/a.sampleRate,s=ih(t,70,Math.min(300,.95/o)),c=this._voice(i||this._layer.pluck),l=r||2.4,u=e+l+.1,d=ih(10**(-3/Math.max(1,l*s)),.85,.985),f=.9*(1-d),p=this._noise(c,e,u,!1,1),m=this._gain(c,0);m.gain.setValueAtTime(0,e),m.gain.setValueAtTime(f,e+4e-4),m.gain.setValueAtTime(0,e+Math.min(.014,2.5/s));let h=this._filter(c,`lowpass`,2600,.7),g=a.createDelay(.05);c.add(g),g.delayTime.value=Math.max(0,1/s-o);let _=-3.01,v=this._filter(c,`lowpass`,1900,_),y=this._filter(c,`highpass`,60,_),b=a.createWaveShaper();b.curve=this._softCurve,c.add(b);let x=this._gain(c,d);p.connect(m),m.connect(h),h.connect(g),g.connect(v),v.connect(y),y.connect(b),b.connect(x),x.connect(g);let S=this._gain(c,0);S.gain.setValueAtTime(oh,e),S.gain.linearRampToValueAtTime(n,e+.005),S.gain.exponentialRampToValueAtTime(oh,e+l),g.connect(S),S.connect(c.out);let C=this._osc(c,`triangle`,s,e,e+Math.min(l,1.2)),w=this._gain(c,0);this._env(w.gain,e,n*.25,.008,Math.min(l,1.1)),C.connect(w),w.connect(c.out),this._reap(c,u)}_reed(e,t,n,r){let i=this._voice(this._layer.ost),a=Math.max(.08,n*.95),o=e+a+.08,s=this._filter(i,`lowpass`,340+700*this._int,4.5);s.connect(i.out);let c=[{f:t,type:`sawtooth`,lvl:.55},{f:t*1.5,type:`square`,lvl:.22},{f:t*.5,type:`triangle`,lvl:.3}];for(let t of c){let n=this._osc(i,t.type,t.f,e,o);n.detune.value=ah(-8,8);let c=this._gain(i,0);c.gain.setValueAtTime(oh,e),c.gain.linearRampToValueAtTime(r*t.lvl,e+.008),c.gain.setValueAtTime(r*t.lvl*.8,e+a*.55),c.gain.exponentialRampToValueAtTime(oh,e+a),n.connect(c),c.connect(s)}this._reap(i,o)}_swell(e){let t=this._voice(this._layer.swell),n=ah(2,4),r=ah(2.5,4.5),i=e+n+r+.2,a=this._filter(t,`lowpass`,700,1.2);a.frequency.setValueAtTime(300,e),a.frequency.linearRampToValueAtTime(900,e+n),a.frequency.linearRampToValueAtTime(280,e+n+r),a.connect(t.out);let o=this._st.mode,s=[fh(o,0)+12,fh(o,1)+12,fh(o,4)+12];for(let o=0;o<s.length;o++){let c=this._osc(t,o===1?`sawtooth`:`triangle`,ph(s[o]),e,i);c.detune.value=ah(-12,12);let l=this._gain(t,0),u=(o===1?.18:.3)*ah(.85,1.1);l.gain.setValueAtTime(oh,e),l.gain.linearRampToValueAtTime(u,e+n),l.gain.exponentialRampToValueAtTime(oh,e+n+r),c.connect(l),l.connect(a)}this._reap(t,i)}_stingParry(e){let t=this._voice(this._layer.fx),n=e+.85,r=ph(fh(`dorian`,4));for(let i=0;i<2;i++){let a=this._osc(t,i?`triangle`:`sawtooth`,r*(i?2:1),e,n);a.frequency.setValueAtTime(r*(i?2:1)*.97,e),a.frequency.linearRampToValueAtTime(r*(i?2:1),e+.09);let o=this._gain(t,0);this._env(o.gain,e,i?.3:.5,.006,.55);let s=this._filter(t,`lowpass`,1400,1.4);a.connect(s),s.connect(o),o.connect(t.out)}this._iron(e+.01,.45,420,this._layer.fx),this._reap(t,n)}_stingBreach(e){let t=this._voice(this._layer.fx),n=e+1.7,r=this._osc(t,`sine`,96,e,n);r.frequency.exponentialRampToValueAtTime(26,e+1.1);let i=this._gain(t,0);this._env(i.gain,e,.8,.02,1.4);let a=this.ctx.createWaveShaper();a.curve=this._softCurve,t.add(a),r.connect(i),i.connect(a),a.connect(t.out);let o=this._noise(t,e,e+1,!0,.9),s=this._filter(t,`lowpass`,900,.9);s.frequency.exponentialRampToValueAtTime(150,e+.8);let c=this._gain(t,0);this._env(c.gain,e,.45,.02,.85),o.connect(s),s.connect(c),c.connect(t.out),this._drum(e,1,0,this._layer.fx),this._drum(e+.16,.7,.2,this._layer.fx),this._iron(e+.04,.55,260,this._layer.fx),this._reap(t,n)}_stingObjective(e){this._iron(e,.5,220,this._layer.fx),this._iron(e+.42,.36,440,this._layer.fx);let t=this._voice(this._layer.fx),n=e+2.2,r=this._osc(t,`triangle`,ph(fh(`dorian`,4))*.5,e,n),i=this._gain(t,0);this._env(i.gain,e,.28,.08,1.9);let a=this._filter(t,`lowpass`,900,.9);r.connect(a),a.connect(i),i.connect(t.out),this._reap(t,n)}_cadence(e,t){let n=e===`victory`,r=n?`dorian`:`phrygian`,i=this._voice(this._layer.fx),a=n?2.6:3.4,o=t+a+.3,s=n?[{at:t,degs:[3,7],lvl:.26,len:.9},{at:t+.85,degs:[0,4,7],lvl:.34,len:a-.85}]:[{at:t,degs:[1,5],lvl:.24,len:1.2},{at:t+1.1,degs:[0,4],lvl:.32,len:a-1.1}],c=this._filter(i,`lowpass`,n?1500:800,1);c.connect(i.out);for(let e of s)for(let t=0;t<e.degs.length;t++){let a=ph(fh(r,e.degs[t])),o=this._osc(i,t===0?`sawtooth`:`triangle`,a,e.at,e.at+e.len+.1);o.detune.value=ah(-7,7),n||o.frequency.linearRampToValueAtTime(a*.985,e.at+e.len);let s=this._gain(i,0);s.gain.setValueAtTime(oh,e.at),s.gain.linearRampToValueAtTime(e.lvl/(1+t*.6),e.at+(n?.03:.12)),s.gain.exponentialRampToValueAtTime(oh,e.at+e.len),o.connect(s),s.connect(c)}this._reap(i,o);let l=n?[7,9,11]:[1,0];for(let e=0;e<l.length;e++)this._pluck(t+.1+e*(n?.24:.5),ph(fh(r,l[e])),.26,2.2,this._layer.fx);this._drum(t,n?.7:.5,n?.2:0,this._layer.fx),n||this._sub(t+.05,.6,.6,this._layer.fx)}_makeNoise(e,t,n){let r=Math.max(1,Math.floor(e.sampleRate*t)),i=e.createBuffer(1,r,e.sampleRate),a=i.getChannelData(0);if(n===`brown`){let e=0;for(let t=0;t<r;t++){let n=Math.random()*2-1;e=(e+.02*n)/1.02,a[t]=e*3.2}}else for(let e=0;e<r;e++)a[e]=Math.random()*2-1;return i}_makeImpulse(e,t,n){let r=e.sampleRate,i=Math.max(1,Math.floor(r*t)),a=e.createBuffer(2,i,r);for(let e=0;e<2;e++){let t=a.getChannelData(e),o=0;for(let e=0;e<i;e++){let r=(1-e/i)**n,a=(Math.random()*2-1)*r;o+=(a-o)*.22,t[e]=o*1.6}for(let n=0;n<9;n++){let n=Math.floor(ah(.012,.13)*r)+e*53;n<i&&(t[n]+=ah(-.5,.5))}}return a}_makeSoftCurve(){let e=1024,t=new Float32Array(e);for(let n=0;n<e;n++){let r=n/(e-1)*2-1;t[n]=Math.tanh(r*1.8)/Math.tanh(1.8)}return t}},Sh=3.2,Ch=class{constructor(e){this.compound=e,this.nodes=new Map,this.edges=new Map,this._build()}_add(e,t,n,r){return this.nodes.set(e,{id:e,x:t,z:n,kind:r}),this.edges.has(e)||this.edges.set(e,new Set),e}_link(e,t){e===t||!this.nodes.has(e)||!this.nodes.has(t)||(this.edges.get(e).add(t),this.edges.get(t).add(e))}_build(){for(let e of Yf)this._add(`room:${e.id}`,(e.x1+e.x2)/2,(e.z1+e.z2)/2,`room`);let e=wh(),t=[[e.x1-Sh,e.z1-Sh],[0,e.z1-Sh],[e.x2+Sh,e.z1-Sh],[e.x2+Sh,0],[e.x2+Sh,e.z2+Sh],[0,e.z2+Sh],[e.x1-Sh,e.z2+Sh],[e.x1-Sh,0]];this.ring=t.map(([e,t],n)=>this._add(`out:${n}`,e,t,`outside`));for(let e=0;e<this.ring.length;e++)this._link(this.ring[e],this.ring[(e+1)%this.ring.length]);for(let e of this.compound.surfaces){let t=e.kind===`opening`?`open:${e.id}`:`gap:${e.id}`,n=(e.x1+e.x2)/2,r=(e.z1+e.z2)/2;this._add(t,n,r,e.kind===`opening`?`opening`:`gap`),e._navId=t;let[i,a,o,s]=Th(e),c=this._sideNode(i,a),l=this._sideNode(o,s);e._navSides=[c,l],e.kind===`opening`&&(this._link(t,c),this._link(t,l))}}_sideNode(e,t){let n=Xf(e,t);if(n)return`room:${n.id}`;let r=this.ring[0],i=1/0;for(let n of this.ring){let a=this.nodes.get(n),o=(a.x-e)**2+(a.z-t)**2;o<i&&(i=o,r=n)}return r}refresh(){for(let e of this.compound.surfaces){if(!e._navId)continue;let[t,n]=e._navSides;e.kind===`opening`&&!e.barricade||e.broken?(this._link(e._navId,t),this._link(e._navId,n)):(this.edges.get(e._navId)?.delete(t),this.edges.get(e._navId)?.delete(n),this.edges.get(t)?.delete(e._navId),this.edges.get(n)?.delete(e._navId))}}_nodeAt(e,t){let n=Xf(e,t);return n?`room:${n.id}`:this._sideNode(e,t)}closestReachable(e,t,n,r){this.refresh();let i=this._nodeAt(e,t),a=new Set([i]),o=[i],s=null,c=1/0;for(;o.length;){let e=o.shift(),t=this.nodes.get(e),i=(t.x-n)**2+(t.z-r)**2;i<c&&(c=i,s=t);for(let t of this.edges.get(e)||[])a.has(t)||(a.add(t),o.push(t))}return s}path(e,t,n,r){this.refresh();let i=this._nodeAt(e,t),a=this._nodeAt(n,r);if(i===a)return[];let o=new Map([[i,null]]),s=[i],c=!1;for(;s.length;){let e=s.shift();if(e===a){c=!0;break}for(let t of this.edges.get(e)||[])o.has(t)||(o.set(t,e),s.push(t))}if(!c)return null;let l=[],u=a;for(;u;){let e=this.nodes.get(u);l.unshift({x:e.x,z:e.z,kind:e.kind,id:e.id}),u=o.get(u)}return l.shift(),l}};function wh(){let e=1/0,t=1/0,n=-1/0,r=-1/0;for(let i of Gf)e=Math.min(e,i.x1),t=Math.min(t,i.z1),n=Math.max(n,i.x2),r=Math.max(r,i.z2);return{x1:e,z1:t,x2:n,z2:r}}function Th(e,t=1){let n=e.x2-e.x1,r=e.z2-e.z1,i=Math.hypot(n,r)||1,a=-r/i,o=n/i,s=(e.x1+e.x2)/2,c=(e.z1+e.z2)/2;return[s+a*t,c+o*t,s-a*t,c-o*t]}var Eh=new V,Dh={barricade:{role:Zf.DEFEND,phase:`prep`,charges:3,label:`Barricade`,hint:`Board a door or window`},reinforce:{role:Zf.DEFEND,phase:`prep`,charges:2,label:`Reinforce`,hint:`Harden a timber wall`},caltrops:{role:Zf.DEFEND,phase:`any`,charges:2,label:`Caltrops`,hint:`Slows and bleeds`},alarm:{role:Zf.DEFEND,phase:`prep`,charges:1,label:`Alarm Bell`,hint:`Reveals the attacker`},breach:{role:Zf.ATTACK,phase:`action`,charges:2,label:`Breach Charge`,hint:`Blow open any wall`},smoke:{role:Zf.ATTACK,phase:`action`,charges:2,label:`Smoke Pot`,hint:`Blocks line of sight`}},Oh=11,kh=2.6,Ah=1.5,jh=2.2,Mh=1.7,Nh=3.4,Ph=class{constructor(e,t){this.scene=e,this.compound=t,this.group=new Dn,this.group.name=`Gadgets`,e.add(this.group),this.deployed=[],this.inventory=new Map,this.events=[],this._mats={iron:new Ua({color:4935768,metalness:.85,roughness:.45}),wood:new Ua({color:7031334,roughness:.85}),brass:new Ua({color:11569970,metalness:.9,roughness:.35}),fuse:new Ua({color:2759954,roughness:.9})},this._smokeTex=Ih()}emit(e){return this.events.push(e),e}drain(){let e=this.events;return this.events=[],e}resetFor(e,t){for(let e of this.deployed)this.group.remove(e.node),e.node.traverse?.(e=>e.geometry?.dispose?.());this.deployed.length=0,this.inventory.clear();for(let n of e){let e=t(n),r={},i=n.traits?.gadgetBonus||{};for(let[t,n]of Object.entries(Dh))n.role===e&&(r[t]=n.charges+(i[t]||0));this.inventory.set(n,r)}}remaining(e,t){return this.inventory.get(e)?.[t]??0}available(e,t){let n=this.inventory.get(e)||{};return Object.keys(n).filter(e=>{if(n[e]<=0)return!1;let r=Dh[e];return r.phase===`any`||r.phase===t})}_spend(e,t){let n=this.inventory.get(e);return!n||!n[t]?!1:(n[t]--,!0)}use(e,t,n){if(!Dh[t]||this.remaining(e,t)<=0)return!1;switch(t){case`barricade`:if(!n?.openingId||!this.compound.barricade(n.openingId,`plank`))return!1;break;case`reinforce`:if(!n?.surface||!this.compound.reinforcePanel(n.surface))return!1;break;case`caltrops`:this._deployCaltrops(e);break;case`alarm`:this._deployAlarm(e);break;case`smoke`:this._deploySmoke(e);break;case`breach`:if(!n?.surface)return!1;this._deployBreach(e,n.surface);break;default:return!1}return this._spend(e,t),this.emit({type:`gadget`,kind:t,fighter:e}),!0}_front(e,t=.8){return new V(e.pos.x+Math.sin(e.yaw)*t,0,e.pos.z+Math.cos(e.yaw)*t)}_deployCaltrops(e){let t=this._front(e,1),n=new Dn;for(let e=0;e<14;e++){let e=new K(new ja(.075),this._mats.iron),t=Math.random()*Math.PI*2,r=Math.random()*Ah*.85;e.position.set(Math.cos(t)*r,.05,Math.sin(t)*r),e.rotation.set(Math.random()*3,Math.random()*3,Math.random()*3),e.castShadow=!0,n.add(e)}n.position.copy(t),this.group.add(n),this.deployed.push({kind:`caltrops`,owner:e,node:n,pos:t.clone(),radius:Ah,life:1/0,tick:0})}_deployAlarm(e){let t=this._front(e,.9),n=new Dn,r=new K(new Ea(.05,.06,1.5,8),this._mats.wood);r.position.y=.75;let i=new K(new Da(.17,.28,10),this._mats.brass);i.position.y=1.42,n.add(r,i),n.position.copy(t),n.traverse(e=>{e.castShadow=!0}),this.group.add(n),this.deployed.push({kind:`alarm`,owner:e,node:n,bell:i,pos:t.clone(),radius:Nh,life:1/0,triggered:0})}_deploySmoke(e){let t=this._front(e,1.4),n=new Dn,r=[];for(let e=0;e<16;e++){let e=new Xr(new Ir({map:this._smokeTex,color:12172482,transparent:!0,opacity:0,depthWrite:!1,fog:!0})),t=Math.random()*Math.PI*2,i=Math.random()*kh*.7;e.position.set(Math.cos(t)*i,.4+Math.random()*1.5,Math.sin(t)*i);let a=1.8+Math.random()*1.6;e.scale.set(a,a,a),n.add(e),r.push({sprite:e,seed:Math.random()*10,rise:.1+Math.random()*.2})}n.position.copy(t),this.group.add(n),this.deployed.push({kind:`smoke`,owner:e,node:n,puffs:r,pos:t.clone(),radius:kh,life:Oh,age:0})}_deployBreach(e,t){let n=this.compound.centre(t,new V);n.y=1.2;let r=new Dn,i=new K(new wa(.34,.34,.14),this._mats.wood),a=new K(new Ma(.2,.03,6,12),this._mats.iron);a.rotation.y=Math.PI/2,r.add(i,a),r.position.copy(n),r.traverse(e=>{e.castShadow=!0}),this.group.add(r),this.deployed.push({kind:`breach`,owner:e,node:r,surface:t,pos:n.clone(),fuse:jh,life:jh})}update(e,t,n){for(let r=this.deployed.length-1;r>=0;r--){let i=this.deployed[r];if(i.kind===`breach`){i.fuse-=e;let t=1-i.fuse/jh;if(i.node.scale.setScalar(1+Math.sin(n*22)*.05*t),i.fuse<=0){let e=this.compound.damageAt(i.pos.x,i.pos.z,Mh,400,{breach:!0});this.emit({type:`breached`,pos:i.pos.clone(),hits:e}),this._remove(r);continue}}if(i.kind===`smoke`){i.age+=e;let t=Math.min(1,i.age/.7)*Math.min(1,Math.max(0,(i.life-i.age)/2.2));for(let r of i.puffs)r.sprite.material.opacity=t*.62,r.sprite.position.y+=r.rise*e,r.sprite.position.x+=Math.sin(n*.6+r.seed)*.06*e;if(i.age>=i.life){this._remove(r);continue}}if(i.kind===`caltrops`){i.tick-=e;for(let e of t)e===i.owner||!e.alive||e.frozen||Eh.copy(e.pos).sub(i.pos).setY(0).length()>i.radius||(e.caltropSlow=.35,i.tick<=0&&(e.takeDamage?.(4,e.guard,!1),this.emit({type:`caltrophit`,fighter:e,pos:i.pos.clone()}),i.tick=.85))}if(i.kind===`alarm`){i.triggered=Math.max(0,i.triggered-e);for(let e of t)e===i.owner||!e.alive||e.frozen||Eh.copy(e.pos).sub(i.pos).setY(0).length()>i.radius||(i.triggered<=0&&(i.triggered=4,this.emit({type:`alarm`,fighter:e,pos:i.pos.clone()})),e.revealedUntil=Math.max(e.revealedUntil||0,n+6));i.bell&&(i.bell.rotation.z=i.triggered>0?Math.sin(n*26)*.22*Math.min(1,i.triggered):0)}}}_remove(e){let t=this.deployed[e];this.group.remove(t.node),t.node.traverse?.(e=>e.geometry?.dispose?.()),this.deployed.splice(e,1)}smokeBlocks(e,t,n,r){for(let i of this.deployed)if(!(i.kind!==`smoke`||i.age<.35)&&Fh(e,t,n,r,i.pos.x,i.pos.z)<i.radius)return!0;return!1}};function Fh(e,t,n,r,i,a){let o=n-e,s=r-t,c=o*o+s*s,l=c>1e-9?((i-e)*o+(a-t)*s)/c:0;return l=l<0?0:l>1?1:l,Math.hypot(i-(e+o*l),a-(t+s*l))}function Ih(){let e=document.createElement(`canvas`);e.width=e.height=128;let t=e.getContext(`2d`),n=t.createRadialGradient(64,64,4,64,64,64);n.addColorStop(0,`rgba(230,232,236,0.85)`),n.addColorStop(.55,`rgba(200,203,210,0.45)`),n.addColorStop(1,`rgba(180,184,192,0)`),t.fillStyle=n,t.fillRect(0,0,128,128);let r=new ba(e);return r.colorSpace=Ve,r}var Lh=new V,Rh={top:-90,right:30,left:150},zh=40,Bh=Math.PI/180,Vh={steel:`#c9d2de`,dim:`rgba(201,210,222,0.22)`,attack:`#e0392b`,unblock:`#ff8a12`,parry:`#ffe27a`,player:`#6fb3ff`,health:`#d8dee8`,healthLost:`#5c2323`,stamina:`#8ad6a0`,staminaLow:`#d8a03a`},Hh=class{constructor(e){this.canvas=e,this.ctx=e.getContext(`2d`),this.messages=[],this.floats=[],this.time=0,this.hintTimer=0,this.hintsPinned=!1,this.resize(),window.addEventListener(`resize`,()=>this.resize())}resize(){let e=Math.min(2,window.devicePixelRatio||1);this.w=Math.max(1,window.innerWidth||0),this.h=Math.max(1,window.innerHeight||0),this.canvas.width=this.w*e,this.canvas.height=this.h*e,this.canvas.style.width=`${this.w}px`,this.canvas.style.height=`${this.h}px`,this.ctx.setTransform(e,0,0,e,0,0),this.dpr=e,this.s=Math.max(.58,Math.min(1,Math.min(this.w/1180,this.h/780)))}say(e,t=Vh.steel,n=1.1,r=!1){this.messages.unshift({text:e,color:t,ttl:n,age:0,big:r}),this.messages.length>4&&this.messages.pop()}float(e,t,n){this.floats.push({p:e.clone(),text:t,color:n,age:0,ttl:1,drift:(Math.random()-.5)*30})}project(e,t){return Lh.copy(e).project(t),{x:(Lh.x*.5+.5)*this.w,y:(-Lh.y*.5+.5)*this.h,behind:Lh.z>1}}draw(e,t){let{player:n,enemy:r,camera:i,duel:a,paused:o,showIndicator:s=!0}=t;this.time+=e,this.hintTimer>0&&(this.hintTimer-=e);let c=this.ctx;c.clearRect(0,0,this.w,this.h),s&&this._drawIndicator(c,n,r,i,a),this._drawBars(c,n,r),this._drawFloats(c,e,i),this._drawMessages(c,e),(this.hintTimer>0||this.hintsPinned)&&this._drawHints(c),o&&this._drawPaused(c,t.started)}_drawIndicator(e,t,n,r,i){if(!n.alive||!t.alive)return;Lh.copy(n.pos).setY(1.25);let a=this.project(Lh,r);if(a.behind)return;e.save(),e.translate(a.x,a.y),e.lineCap=`butt`;let o=n.state===`attack`&&n.attack&&!n.attack.resolved?n.attack:null,s=o?o.dir:null,c=o?.unblockable;for(let t of[`top`,`left`,`right`]){let r=(Rh[t]-zh)*Bh,i=(Rh[t]+zh)*Bh,a=n.guard===t,l=s===t;if(e.beginPath(),e.arc(0,0,62,r,i),l){let t=o.strike-n.clipTime,r=Math.min(1,1-Math.max(0,t)/Math.max(.1,o.strike));e.strokeStyle=c?Vh.unblock:Vh.attack,e.lineWidth=8+r*7,e.shadowColor=e.strokeStyle,e.shadowBlur=14+r*18,e.globalAlpha=c?.75+Math.sin(this.time*26)*.25:.6+r*.4}else e.strokeStyle=a?Vh.steel:Vh.dim,e.lineWidth=a?7:4,e.shadowBlur=a?8:0,e.shadowColor=Vh.steel,e.globalAlpha=a?.95:1;e.stroke(),e.shadowBlur=0,e.globalAlpha=1}if(o){let r=o.strike-n.clipTime;if(r>0&&r<.26&&t.guard===o.dir){let t=(Rh[o.dir]-zh)*Bh,n=(Rh[o.dir]+zh)*Bh;e.beginPath(),e.arc(0,0,73,t,n),e.strokeStyle=Vh.parry,e.lineWidth=2.5,e.globalAlpha=.85,e.shadowColor=Vh.parry,e.shadowBlur=12,e.stroke(),e.shadowBlur=0,e.globalAlpha=1}}for(let n of[`top`,`left`,`right`]){let r=(Rh[n]-zh+6)*Bh,i=(Rh[n]+zh-6)*Bh,a=t.guard===n;e.beginPath(),e.arc(0,0,40,r,i),e.strokeStyle=a?Vh.player:`rgba(111,179,255,0.16)`,e.lineWidth=a?5:3,a&&(e.shadowColor=Vh.player,e.shadowBlur=10),e.stroke(),e.shadowBlur=0}if(t.chainStep>0){let n=t.traits?.chainDepth??2,r=t.chainWindow>0;for(let i=0;i<n;i++){let a=(i-(n-1)/2)*13;e.beginPath(),e.arc(a,66,3.4,0,Math.PI*2),e.fillStyle=i<t.chainStep?r?`#ffc861`:`rgba(255,200,97,0.35)`:`rgba(215,222,233,0.16)`,e.fill()}}t.state===`attack`&&t.attack?.unblockable&&(e.beginPath(),e.arc(0,0,31,0,Math.PI*2),e.strokeStyle=Vh.unblock,e.lineWidth=2,e.globalAlpha=.5+Math.sin(this.time*22)*.4,e.stroke(),e.globalAlpha=1),e.restore()}_bar(e,t,n,r,i,a,o,s=`rgba(0,0,0,0.55)`){e.fillStyle=s,e.fillRect(t,n,r,i),e.fillStyle=o,e.fillRect(t,n,r*Math.max(0,Math.min(1,a)),i),e.strokeStyle=`rgba(255,255,255,0.20)`,e.lineWidth=1,e.strokeRect(t+.5,n+.5,r-1,i-1)}_vitals(e,t,n,r,i,a,o){let s=t.health/t.maxHealth,c=t.stamina/100,l=this.s,u=14*l,d=5*l,f=17*l;e.save(),e.font=`600 ${12*this.s}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`rgba(220,228,240,0.75)`,e.textAlign=a,e.letterSpacing=`2px`,e.fillText(o.toUpperCase(),a===`right`?n+i:n,r-9*l),t.archetypeName&&(e.font=`500 ${9*this.s}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`rgba(215,222,233,0.42)`,e.letterSpacing=`1px`,e.fillText(t.archetypeName.toUpperCase(),a===`right`?n+i:n,r-22*l)),e.letterSpacing=`0px`,e.restore(),t._ghost=t._ghost===void 0?s:t._ghost,t._ghost+=(s-t._ghost)*.06,e.fillStyle=Vh.healthLost,e.fillRect(n,r,i*Math.max(0,t._ghost),u),this._bar(e,n,r,i,u,s,t.hitFlash>0?`#ffffff`:Vh.health,`rgba(10,12,16,0.7)`),this._bar(e,n,r+f,i,d,c,t.exhausted>0?Vh.staminaLow:Vh.stamina,`rgba(10,12,16,0.7)`),t.exhausted>0&&(e.font=`700 ${10*this.s}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=Vh.staminaLow,e.textAlign=a,e.globalAlpha=.6+Math.sin(this.time*12)*.4,e.fillText(`EXHAUSTED`,a===`right`?n+i:n,r+36*l),e.globalAlpha=1)}_drawBars(e,t,n){let r=Math.min(320*this.s,this.w*.3),i=42*this.s,a=this.h-78*this.s;this._vitals(e,t,i,a,r,`left`,t.name),this._vitals(e,n,this.w-i-r,a,r,`right`,n.name)}_drawFloats(e,t,n){e.save(),e.textAlign=`center`;for(let r=this.floats.length-1;r>=0;r--){let i=this.floats[r];if(i.age+=t,i.age>i.ttl){this.floats.splice(r,1);continue}let a=i.age/i.ttl,o=this.project(i.p,n);o.behind||(e.globalAlpha=1-a*a,e.font=`700 ${26*this.s}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=i.color,e.shadowColor=`rgba(0,0,0,0.9)`,e.shadowBlur=6,e.fillText(i.text,o.x+i.drift*a,o.y-30-a*52))}e.restore()}_drawMessages(e,t){e.save(),e.textAlign=`center`;for(let n=this.messages.length-1;n>=0;n--){let r=this.messages[n];if(r.age+=t,r.age>r.ttl){this.messages.splice(n,1);continue}let i=r.age/r.ttl;e.globalAlpha=Math.min(1,(1-i)*2.5);let a=1+Math.max(0,.25-r.age)*1.4;e.font=`800 ${(r.big?42:24)*a*this.s}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=r.color,e.shadowColor=`rgba(0,0,0,0.85)`,e.shadowBlur=10,e.letterSpacing=`4px`,e.fillText(r.text,this.w/2,this.h*.29+n*34*this.s),e.letterSpacing=`0px`}e.restore()}showHints(e=8){this.hintsPinned||(this.hintTimer=e)}toggleHints(){return this.hintsPinned=!this.hintsPinned,this.hintTimer=0,this.hintsPinned}_drawHints(e){let t=this.s,n=[[`MOUSE`,`Look — sets your guard when locked on`],[`LEFT / RIGHT CLICK`,`Light / heavy — hold right to charge`],[`RIGHT CLICK on their swing`,`Parry`],[`E · SPACE · F`,`Guard break · dodge · feint`],[`Q · 1-4 · G`,`Free look · utility · graphics`],[`H`,`Show or hide these controls`]],r=16*t,i=20*t,a=178*t,o=470*t,s=r*2+n.length*i+20*t,c=(this.w-o)/2,l=this.h-168*t-s;e.save(),e.globalAlpha=this.hintsPinned?.96:Math.min(1,this.hintTimer/1.5),e.fillStyle=`rgba(10,13,19,0.72)`,e.strokeStyle=`rgba(215,222,233,0.14)`,e.lineWidth=1,e.roundRect?(e.beginPath(),e.roundRect(c,l,o,s,6*t),e.fill(),e.stroke()):(e.fillRect(c,l,o,s),e.strokeRect(c+.5,l+.5,o-1,s-1)),e.textAlign=`left`,e.font=`700 ${9.5*t}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${3*t}px`,e.fillStyle=`rgba(215,222,233,0.42)`,e.fillText(`CONTROLS`,c+r,l+r+8*t),e.letterSpacing=`0px`,n.forEach((n,o)=>{let s=l+r+30*t+o*i;e.font=`700 ${11*t}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`rgba(230,236,246,0.92)`,e.fillText(n[0],c+r,s),e.font=`500 ${11*t}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`rgba(196,206,222,0.66)`,e.fillText(n[1],c+r+a,s)}),e.restore()}_drawResult(e,t,n){let r=t.winner===n;e.save(),e.fillStyle=r?`rgba(12,18,28,0.45)`:`rgba(28,8,8,0.5)`,e.fillRect(0,0,this.w,this.h),e.textAlign=`center`,e.font=`800 ${76*this.s}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`10px`,e.fillStyle=r?`#f0e6d2`:`#e0554a`,e.shadowColor=`rgba(0,0,0,0.9)`,e.shadowBlur=20,e.fillText(r?`VICTORY`:`DEFEAT`,this.w/2,this.h/2-10*this.s),e.font=`500 ${16*this.s}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`3px`,e.fillStyle=`rgba(230,235,245,0.8)`,e.fillText(`PRESS R TO FIGHT AGAIN`,this.w/2,this.h/2+44*this.s),e.restore()}_drawPaused(e,t){e.save(),e.fillStyle=`rgba(8,10,14,0.6)`,e.fillRect(0,0,this.w,this.h),e.textAlign=`center`,e.font=`800 ${48*this.s}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`8px`,e.fillStyle=`#e8eef8`,e.fillText(t?`PAUSED`:`ART OF BATTLE`,this.w/2,this.h/2),e.font=`500 ${15*this.s}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`3px`,e.fillStyle=`rgba(220,228,240,0.72)`,e.fillText(t?`CLICK TO RESUME`:`CLICK TO TAKE THE FIELD`,this.w/2,this.h/2+38*this.s),e.font=`500 ${13*this.s}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=`rgba(200,210,226,0.5)`,e.fillText(`1 SQUIRE    2 WARRIOR    3 WARLORD`,this.w/2,this.h/2+74*this.s),e.restore()}},Uh=.42;function Wh(e){if(e.code)return e.code;let t=e.key;if(!t)return``;if(t===` `)return`Space`;if(t.length===1){if(/[a-z]/i.test(t))return`Key${t.toUpperCase()}`;if(/[0-9]/.test(t))return`Digit${t}`}return t}var Gh=class{constructor(e){this.canvas=e,this.keys=new Set,this.stick={x:.8,y:-.2},this.guard=`right`,this.guardChanged=!1,this.sensitivity=.0075,this.lookSensitivity=.0022,this.locked=!1,this.lockedOn=!1,this.yaw=0,this.pitch=0,this.maxPitch=1.15,this.pressed={light:!1,heavy:!1,feint:!1,gb:!1,dodge:!1,restart:!1,pause:!1,toggleLock:!1,cycleQuality:!1,toggleHints:!1,difficulty:null,gadgetSlot:null},this.heavyHeld=!1,this.heavyReleased=!1,this.anyInput=!1,this.justPressed=[],this.typed=``,this._bind()}_bind(){let e=this.canvas;e.addEventListener(`click`,()=>{this.locked||e.requestPointerLock()}),document.addEventListener(`pointerlockchange`,()=>{this.locked=document.pointerLockElement===e}),document.addEventListener(`mousemove`,e=>{if(this.locked){this.lockedOn?this._moveStick(e.movementX*this.sensitivity,-e.movementY*this.sensitivity):this._look(e.movementX,e.movementY);return}let t=window.innerWidth/2,n=window.innerHeight/2,r=(e.clientX-t)/(window.innerWidth*.22),i=-(e.clientY-n)/(window.innerHeight*.22);this.lockedOn?this._setStick(r,i):this._lastX!==void 0&&this._look(e.clientX-this._lastX,e.clientY-this._lastY),this._lastX=e.clientX,this._lastY=e.clientY}),e.addEventListener(`mousedown`,e=>{e.preventDefault(),this.anyInput=!0,e.button===0&&(this.pressed.light=!0),e.button===2&&(this.pressed.heavy=!0,this.heavyHeld=!0),e.button===1&&(this.pressed.gb=!0)}),e.addEventListener(`mouseup`,e=>{e.button===2&&this.heavyHeld&&(this.heavyHeld=!1,this.heavyReleased=!0)}),e.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`keydown`,e=>{if(e.repeat)return;let t=Wh(e);switch(this.keys.add(t),this.anyInput=!0,this.justPressed.push(t),e.key&&e.key.length===1?this.typed+=e.key:t===`Backspace`&&(this.typed+=`\b`),t){case`Space`:this.pressed.dodge=!0,e.preventDefault();break;case`KeyF`:this.pressed.feint=!0;break;case`KeyE`:this.pressed.gb=!0;break;case`KeyR`:this.pressed.restart=!0;break;case`KeyP`:this.pressed.pause=!0;break;case`KeyQ`:this.pressed.toggleLock=!0;break;case`KeyG`:this.pressed.cycleQuality=!0;break;case`KeyH`:this.pressed.toggleHints=!0;break;case`ArrowUp`:this._setStick(0,1);break;case`ArrowLeft`:this._setStick(-1,0);break;case`ArrowRight`:this._setStick(1,0);break;case`KeyJ`:this.pressed.light=!0;break;case`KeyK`:this.pressed.heavy=!0,this.heavyHeld=!0;break;case`Digit1`:this.pressed.difficulty=`squire`,this.pressed.gadgetSlot=0;break;case`Digit2`:this.pressed.difficulty=`warrior`,this.pressed.gadgetSlot=1;break;case`Digit3`:this.pressed.difficulty=`warlord`,this.pressed.gadgetSlot=2;break;case`Digit4`:this.pressed.gadgetSlot=3;break}}),window.addEventListener(`keyup`,e=>{let t=Wh(e);this.keys.delete(t),t===`KeyK`&&this.heavyHeld&&(this.heavyHeld=!1,this.heavyReleased=!0)}),window.addEventListener(`blur`,()=>this.keys.clear())}_look(e,t){this.yaw-=e*this.lookSensitivity,this.pitch-=t*this.lookSensitivity,this.pitch>this.maxPitch&&(this.pitch=this.maxPitch),this.pitch<-this.maxPitch&&(this.pitch=-this.maxPitch)}_moveStick(e,t){this.stick.x+=e,this.stick.y+=t;let n=Math.hypot(this.stick.x,this.stick.y);n>1&&(this.stick.x/=n,this.stick.y/=n),this._resolveGuard()}_setStick(e,t){let n=Math.hypot(e,t);this.stick.x=n>1?e/n:e,this.stick.y=n>1?t/n:t,this._resolveGuard()}_resolveGuard(){let{x:e,y:t}=this.stick;if(Math.hypot(e,t)<Uh)return;let n=t>Math.abs(e)*.85?`top`:e<0?`left`:`right`;n!==this.guard&&(this.guard=n,this.guardChanged=!0)}move(e={x:0,y:0}){let t=this.keys;e.x=!!t.has(`KeyA`)-+!!t.has(`KeyD`),e.y=!!t.has(`KeyW`)-+!!t.has(`KeyS`);let n=Math.hypot(e.x,e.y);return n>1&&(e.x/=n,e.y/=n),e}flush(){let e={...this.pressed,heavyReleased:this.heavyReleased,guardChanged:this.guardChanged};for(let e in this.pressed)e===`difficulty`||e===`gadgetSlot`?this.pressed[e]=null:this.pressed[e]=!1;return e.keys=this.justPressed,e.typed=this.typed,this.justPressed=[],this.typed=``,this.heavyReleased=!1,this.guardChanged=!1,e}},Kh=new V,$={text:`#d7dee9`,dim:`rgba(215,222,233,0.45)`,attack:`#e08a3c`,defend:`#6fb3ff`,objective:`#e0c45a`,danger:`#e0392b`,win:`#9ee08a`},qh=class{constructor(e){this.hud=e}get ctx(){return this.hud.ctx}get w(){return this.hud.w}get h(){return this.hud.h}get s(){return this.hud.s}draw(e,t){let{siege:n,compound:r,gadgets:i,player:a,camera:o,enemy:s,enemyVisible:c,time:l}=t,u=this.ctx;this._roundBar(u,n),this._role(u,n),this._objective(u,n,r,o,a),this._gadgets(u,n,i,a),n.phase===Q.PREP&&(this._matchup(u,n,a,s),this._prep(u,n,i,a)),n.phase===Q.RESOLVE&&this._roundResult(u,n),n.phase===Q.MATCH_OVER&&this._matchResult(u,n),this._enemyMarker(u,s,o,c,l)}_roundBar(e,t){let n=this.s,r=this.w/2;e.save(),e.textAlign=`center`;let i=t.phase===Q.ACTION&&t.timer<20;e.font=`700 ${30*n}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=i?$.danger:$.text,e.letterSpacing=`${2*n}px`,e.shadowColor=`rgba(0,0,0,0.85)`,e.shadowBlur=8,e.fillText(t.timeText,r,42*n),e.font=`600 ${11*n}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${3*n}px`,e.fillStyle=$.dim;let a={[Q.PREP]:`PREPARATION`,[Q.ACTION]:`ROUND ${t.round}`,[Q.RESOLVE]:`ROUND OVER`,[Q.MATCH_OVER]:`MATCH OVER`}[t.phase]||``;e.fillText(a,r,60*n);let o=9*n,s=6*n,c=t.winsNeeded;for(let i=0;i<c;i++)e.beginPath(),e.arc(r-74*n-i*(o+s),36*n,o/2,0,Math.PI*2),e.fillStyle=i<t.score.player?$.win:`rgba(215,222,233,0.18)`,e.fill(),e.beginPath(),e.arc(r+74*n+i*(o+s),36*n,o/2,0,Math.PI*2),e.fillStyle=i<t.score.enemy?$.danger:`rgba(215,222,233,0.18)`,e.fill();e.restore()}_role(e,t){let n=this.s,r=t.playerRole===Zf.ATTACK;e.save(),e.textAlign=`left`,e.font=`800 ${15*n}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${4*n}px`,e.fillStyle=r?$.attack:$.defend,e.shadowColor=`rgba(0,0,0,0.85)`,e.shadowBlur=6,e.fillText(r?`ATTACK`:`DEFEND`,42*n,44*n),e.font=`500 ${11*n}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${1*n}px`,e.fillStyle=$.dim,e.fillText(r?`Destroy the banner`:`Hold the chapel`,42*n,62*n),e.restore()}_objective(e,t,n,r,i){let a=this.s,o=n.objective,s=o.hp/o.maxHp,c=42*a,l=76*a,u=168*a,d=7*a;e.save(),e.fillStyle=`rgba(10,12,16,0.7)`,e.fillRect(c,l,u,d),e.fillStyle=o.destroyed?$.danger:$.objective,e.fillRect(c,l,u*Math.max(0,s),d),e.strokeStyle=`rgba(255,255,255,0.2)`,e.lineWidth=1,e.strokeRect(c+.5,l+.5,u-1,d-1),e.font=`600 ${9*a}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=$.dim,e.textAlign=`left`,e.fillText(`BANNER`,c,l-4*a),e.restore(),Kh.set(o.x,2.4,o.z);let f=this.hud.project(Kh,r),p=Math.hypot(i.pos.x-o.x,i.pos.z-o.z);if(e.save(),e.textAlign=`center`,!f.behind&&f.x>0&&f.x<this.w){e.globalAlpha=.85,e.strokeStyle=$.objective,e.lineWidth=2*a;let t=11*a;e.beginPath(),e.moveTo(f.x,f.y-t),e.lineTo(f.x+t,f.y),e.lineTo(f.x,f.y+t),e.lineTo(f.x-t,f.y),e.closePath(),e.stroke(),e.font=`600 ${10*a}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=$.objective,e.fillText(`${p.toFixed(0)}m`,f.x,f.y+26*a)}else{let t=Math.atan2(o.x-i.pos.x,o.z-i.pos.z)-Math.atan2(r.position.x-i.pos.x===0?1:i.pos.x-r.position.x,i.pos.z-r.position.z),n=this.w/2+Math.sin(t)*this.w*.42;e.globalAlpha=.7,e.fillStyle=$.objective,e.beginPath(),e.moveTo(n,96*a),e.lineTo(n-8*a,82*a),e.lineTo(n+8*a,82*a),e.closePath(),e.fill(),e.font=`600 ${10*a}px ui-sans-serif, system-ui, sans-serif`,e.fillText(`${p.toFixed(0)}m`,n,112*a)}e.restore()}_gadgets(e,t,n,r){let i=this.s,a=t.phase===Q.PREP?`prep`:`action`,o=n.inventory.get(r)||{},s=Object.keys(o);if(!s.length)return;let c=128*i,l=36*i,u=7*i,d=s.length*c+(s.length-1)*u,f=this.w/2-d/2,p=this.h-118*i;e.save(),s.forEach((t,n)=>{let r=Dh[t],s=o[t]>0&&(r.phase===`any`||r.phase===a);e.fillStyle=s?`rgba(16,20,27,0.78)`:`rgba(16,20,27,0.4)`,e.fillRect(f,p,c,l),e.strokeStyle=s?`rgba(215,222,233,0.35)`:`rgba(215,222,233,0.12)`,e.lineWidth=1,e.strokeRect(f+.5,p+.5,c-1,l-1),e.textAlign=`left`,e.font=`700 ${10*i}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=s?$.text:$.dim,e.fillText(`${n+1}`,f+7*i,p+14*i),e.font=`600 ${10*i}px ui-sans-serif, system-ui, sans-serif`,e.fillText(r.label.toUpperCase(),f+20*i,p+14*i),e.font=`500 ${9*i}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=$.dim,e.fillText(r.hint,f+7*i,p+28*i),e.textAlign=`right`,e.font=`700 ${12*i}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=s?$.text:$.dim,e.fillText(`${o[t]}`,f+c-7*i,p+15*i),f+=c+u}),e.restore()}_matchup(e,t,n,r){let i=this.s,a=this.w/2,o=this.h*.47,s=t.timer,c=Math.min(1,Math.min((25-s)/.8,s/2.5));if(c<=0)return;e.save(),e.globalAlpha=Math.max(0,c),e.textAlign=`center`,e.font=`600 ${10*i}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${5*i}px`,e.fillStyle=$.dim,e.shadowColor=`rgba(0,0,0,0.9)`,e.shadowBlur=10,e.fillText(`THE MATCHUP`,a,o-34*i);let l=(t,n,r,s)=>{e.textAlign=r;let c=a+n;e.font=`800 ${25*i}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${2*i}px`,e.fillStyle=s,e.fillText((t.archetypeName||`—`).toUpperCase(),c,o),e.font=`500 ${12*i}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${1*i}px`,e.fillStyle=$.text,e.fillText(t.name,c,o+22*i),e.font=`500 ${10*i}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=$.dim;let l=t.traits||{},u=[`${t.maxHealth} hp`,`chain ${l.chainDepth??2}`,l.parryWindowMul>1?`wide parry`:null,l.guardReduction>0?`hardened guard`:null,l.dodgeIFrameMul>1?`evasive`:null,l.woundedDamage>0?`rages when hurt`:null].filter(Boolean).join(`  ·  `);e.fillText(u,c,o+40*i)};l(n,-26*i,`right`,$.defend),l(r,26*i,`left`,$.attack),e.textAlign=`center`,e.font=`700 ${16*i}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=$.dim,e.fillText(`vs`,a,o),e.restore()}_prep(e,t,n,r){let i=this.s;e.save(),e.textAlign=`center`,e.font=`500 ${12*i}px ui-sans-serif, system-ui, sans-serif`,e.fillStyle=$.dim,e.shadowColor=`rgba(0,0,0,0.8)`,e.shadowBlur=5;let a=t.playerRole===Zf.ATTACK;e.fillText(a?`SCOUT THE COMPOUND — mouse looks · WASD pans · ENTER sounds the horn`:`FORTIFY — face a door, window or wall and press a number`,this.w/2,this.h-142*i),e.restore()}_roundResult(e,t){let n=this.s,r=t.lastResult;if(!r)return;let i=r.winner===`player`;e.save(),e.textAlign=`center`,e.font=`800 ${44*n}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${8*n}px`,e.fillStyle=i?$.win:$.danger,e.shadowColor=`rgba(0,0,0,0.9)`,e.shadowBlur=16,e.fillText(i?`ROUND WON`:`ROUND LOST`,this.w/2,this.h*.36),e.font=`500 ${14*n}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${3*n}px`,e.fillStyle=$.text;let a={objective:i?`The banner is down`:`They brought the banner down`,elimination:i?`Opponent slain`:`You were slain`,timeout:i?`You held the compound`:`Time ran out`}[r.reason]||``;e.fillText(a.toUpperCase(),this.w/2,this.h*.36+34*n),e.fillStyle=$.dim,e.fillText(`SIDES SWAP`,this.w/2,this.h*.36+58*n),e.restore()}_matchResult(e,t){let n=this.s,r=t.score.player>t.score.enemy;e.save(),e.fillStyle=r?`rgba(10,18,26,0.55)`:`rgba(26,8,8,0.55)`,e.fillRect(0,0,this.w,this.h),e.textAlign=`center`,e.font=`800 ${66*n}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${10*n}px`,e.fillStyle=r?`#f0e6d2`:`#e0554a`,e.shadowColor=`rgba(0,0,0,0.9)`,e.shadowBlur=20,e.fillText(r?`COMPOUND TAKEN`:`COMPOUND HELD`,this.w/2,this.h/2),e.font=`500 ${16*n}px ui-sans-serif, system-ui, sans-serif`,e.letterSpacing=`${3*n}px`,e.fillStyle=`rgba(230,235,245,0.8)`,e.fillText(`${t.score.player} — ${t.score.enemy}`,this.w/2,this.h/2+40*n),e.fillText(`PRESS R FOR A NEW MATCH`,this.w/2,this.h/2+68*n),e.restore()}_enemyMarker(e,t,n,r,i){let a=(t.revealedUntil||0)>i;if(!r&&!a)return;Kh.copy(t.pos).setY(2.15);let o=this.hud.project(Kh,n);if(o.behind)return;let s=this.s;e.save(),e.globalAlpha=r?.5:.85,e.strokeStyle=a&&!r?$.attack:`rgba(224,57,43,0.9)`,e.lineWidth=2*s;let c=8*s;e.beginPath(),e.moveTo(o.x-c,o.y+c),e.lineTo(o.x,o.y-c),e.lineTo(o.x+c,o.y+c),e.stroke(),a&&!r&&(e.font=`600 ${9*s}px ui-sans-serif, system-ui, sans-serif`,e.textAlign=`center`,e.fillStyle=$.attack,e.fillText(`HEARD`,o.x,o.y-14*s)),e.restore()}},Jh=900,Yh=14,Xh=new V,Zh=new V,Qh=`
...
}`,eg=class{constructor(){let e=new Float32Array(Jh*3),t=new Float32Array(Jh*3),n=new Float32Array(Jh),r=new Float32Array(Jh);this.vel=new Float32Array(Jh*3),this.age=new Float32Array(Jh),this.ttl=new Float32Array(Jh),this.drag=new Float32Array(Jh),this.gravity=new Float32Array(Jh),this.head=0;let i=new Ar;i.setAttribute(`position`,new hr(e,3)),i.setAttribute(`aColor`,new hr(t,3)),i.setAttribute(`aSize`,new hr(n,1)),i.setAttribute(`aLife`,new hr(r,1)),i.setDrawRange(0,Jh),i.boundingSphere=new Sr(new V,60),this.points=new _a(i,new Va({vertexShader:Qh,fragmentShader:$h,transparent:!0,depthWrite:!1,blending:2})),this.points.frustumCulled=!1,this.geo=i}spawn(e,t){let{count:n=16,speed:r=5,spread:i=1,color:a=new G(16756821),size:o=.09,ttl:s=.5,gravity:c=9,drag:l=2.6,dir:u=null,colorJitter:d=.2}=t,f=this.geo.attributes.position.array,p=this.geo.attributes.aColor.array,m=this.geo.attributes.aSize.array,h=this.geo.attributes.aLife.array;for(let t=0;t<n;t++){let t=this.head;this.head=(this.head+1)%Jh,f[t*3]=e.x,f[t*3+1]=e.y,f[t*3+2]=e.z,Xh.set(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1),Xh.lengthSq()<1e-5&&Xh.set(0,1,0),Xh.normalize(),u&&Xh.lerp(u,1-i*.5).normalize();let n=r*(.35+Math.random()*.9);this.vel[t*3]=Xh.x*n,this.vel[t*3+1]=Xh.y*n,this.vel[t*3+2]=Xh.z*n;let g=1+(Math.random()-.5)*d;p[t*3]=a.r*g,p[t*3+1]=a.g*g,p[t*3+2]=a.b*g,m[t]=o*(.6+Math.random()*.9),h[t]=1,this.age[t]=0,this.ttl[t]=s*(.65+Math.random()*.7),this.gravity[t]=c,this.drag[t]=l}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.aColor.needsUpdate=!0,this.geo.attributes.aSize.needsUpdate=!0,this.geo.attributes.aLife.needsUpdate=!0}update(e){let t=this.geo.attributes.position.array,n=this.geo.attributes.aLife.array,r=!1;for(let i=0;i<Jh;i++){if(n[i]<=0)continue;r=!0,this.age[i]+=e;let a=this.age[i]/this.ttl[i];if(a>=1){n[i]=0;continue}n[i]=1-a*a;let o=Math.max(0,1-this.drag[i]*e);this.vel[i*3]*=o,this.vel[i*3+1]=this.vel[i*3+1]*o-this.gravity[i]*e,this.vel[i*3+2]*=o,t[i*3]+=this.vel[i*3]*e,t[i*3+1]+=this.vel[i*3+1]*e,t[i*3+2]+=this.vel[i*3+2]*e,t[i*3+1]<.02&&(t[i*3+1]=.02,this.vel[i*3+1]*=-.28,this.vel[i*3]*=.6,this.vel[i*3+2]*=.6)}r&&(this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.aLife.needsUpdate=!0)}},tg=class{constructor(e){let t=new Ar,n=new Float32Array(Yh*2*3),r=new Float32Array(Yh*2*4),i=[];for(let e=0;e<Yh-1;e++){let t=e*2;i.push(t,t+1,t+2,t+1,t+3,t+2)}t.setAttribute(`position`,new hr(n,3)),t.setAttribute(`color`,new hr(r,4)),t.setIndex(i),t.boundingSphere=new Sr(new V,60),this.mesh=new K(t,new oi({vertexColors:!0,transparent:!0,depthWrite:!1,side:2,blending:2})),this.mesh.frustumCulled=!1,this.geo=t,this.color=new G(e),this.count=0,this.strength=0,this.tips=Array.from({length:Yh},()=>new V),this.bases=Array.from({length:Yh},()=>new V)}push(e,t,n){for(let e=Yh-1;e>0;e--)this.tips[e].copy(this.tips[e-1]),this.bases[e].copy(this.bases[e-1]);this.tips[0].copy(t),this.bases[0].copy(e),this.count=Math.min(Yh,this.count+1),this.strength=n}update(e){this.strength=Math.max(0,this.strength-e*5);let t=this.geo.attributes.position.array,n=this.geo.attributes.color.array,r=this.count;for(let e=0;e<Yh;e++){let i=Math.min(e,Math.max(0,r-1)),a=this.bases[i],o=this.tips[i];t[e*6]=a.x,t[e*6+1]=a.y,t[e*6+2]=a.z,t[e*6+3]=o.x,t[e*6+4]=o.y,t[e*6+5]=o.z;let s=(e<r?(1-e/Yh)**1.7:0)*this.strength;for(let t of[0,1]){let r=(e*2+t)*4;n[r]=this.color.r,n[r+1]=this.color.g,n[r+2]=this.color.b,n[r+3]=s*(t===1?.3:0)}}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.color.needsUpdate=!0,this.mesh.visible=this.strength>.01}clear(){this.count=0,this.strength=0}},ng=class{constructor(){this.sprites=[],this.group=new Dn;for(let e=0;e<8;e++){let e=new K(new ka(1,1),new oi({color:16777215,transparent:!0,opacity:0,blending:2,depthWrite:!1,fog:!1}));e.visible=!1,this.group.add(e),this.sprites.push({mesh:e,age:0,ttl:0,size:1})}this.head=0}spawn(e,t,n,r=.16){let i=this.sprites[this.head];this.head=(this.head+1)%this.sprites.length,i.mesh.position.copy(e),i.mesh.material.color.set(t),i.age=0,i.ttl=r,i.size=n,i.mesh.visible=!0}update(e,t){for(let n of this.sprites){if(!n.mesh.visible)continue;n.age+=e;let r=n.age/n.ttl;if(r>=1){n.mesh.visible=!1,n.mesh.material.opacity=0;continue}let i=n.size*(.5+r*1.5);n.mesh.scale.set(i,i,i),n.mesh.material.opacity=(1-r)*(1-r)*.9,n.mesh.quaternion.copy(t.quaternion)}}},rg=class{constructor(e){this.scene=e,this.sparks=new eg,this.flash=new ng,e.add(this.sparks.points),e.add(this.flash.group),this.trails=new Map,this._c=new G}trailFor(e,t){let n=this.trails.get(e);return n||(n=new tg(t),this.trails.set(e,n),this.scene.add(n.mesh)),n}clash(e,t){this.sparks.spawn(e,{count:30,speed:7.5,spread:1.4,size:.075,ttl:.55,color:this._c.setHex(16767392),gravity:11,drag:1.8,dir:t,colorJitter:.35}),this.flash.spawn(e,16773328,1.5,.13)}parryBurst(e){this.sparks.spawn(e,{count:54,speed:10,spread:1.6,size:.095,ttl:.75,color:this._c.setHex(16774344),gravity:9,drag:1.4,colorJitter:.3}),this.flash.spawn(e,16777215,2.9,.24)}bloodHit(e,t,n){this.sparks.spawn(e,{count:n?34:20,speed:n?5.2:3.6,spread:1.1,size:n?.1:.075,ttl:.75,color:this._c.setHex(9311252),gravity:13,drag:2.2,dir:t,colorJitter:.4}),this.flash.spawn(e,16733491,n?1.5:1,.12)}dust(e,t=10,n=1.6){Zh.set(0,1,0),this.sparks.spawn(e,{count:t,speed:n,spread:1.7,size:.16,ttl:.85,color:this._c.setHex(5260858),gravity:1.6,drag:3.4,dir:Zh,colorJitter:.25})}unblockableTell(e){this.sparks.spawn(e,{count:26,speed:2.2,spread:1.8,size:.11,ttl:.7,color:this._c.setHex(16742928),gravity:-1.4,drag:1.6,colorJitter:.2})}updateTrail(e,t){let n=this.trailFor(e,t);e.state===`attack`&&e.attack&&e.clipTime>e.attack.windup*.82&&e.clipTime<e.attack.strike+.22?n.push(e.rig.bladePoint(.58,Xh),e.rig.bladeTip(Zh),1):n.strength<=.02&&(n.clear(),n.push(e.rig.bladePoint(.58,Xh),e.rig.bladeTip(Zh),0))}update(e,t){this.sparks.update(e),this.flash.update(e,t);for(let t of this.trails.values())t.update(e)}},ig=1316383,ag=null;function og(){if(ag)return ag;let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.3,`rgba(255,196,120,0.62)`),n.addColorStop(1,`rgba(255,110,20,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),ag=new ba(e),ag.colorSpace=Ve,ag}function sg(){let e=new Aa(220,32,24),t=[],n=e.attributes.position,r=new G(658712),i=new G(2304573),a=new G(4864565),o=new G;for(let e=0;e<n.count;e++){let s=n.getY(e)/220;s>.05?o.copy(i).lerp(r,Math.min(1,s*1.5)):o.copy(a).lerp(i,Math.min(1,(s+.35)/.4)),t.push(o.r,o.g,o.b)}e.setAttribute(`color`,new vr(t,3));let s=new K(e,new oi({vertexColors:!0,side:1,fog:!1,depthWrite:!1}));return s.renderOrder=-1e3,s}function cg(){let e=new Float32Array(900*3),t=new Float32Array(900);for(let n=0;n<900;n++){let r=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),a=Math.abs(Math.cos(i))*190;e[n*3]=Math.sin(i)*Math.cos(r)*190,e[n*3+1]=a*.9+12,e[n*3+2]=Math.sin(i)*Math.sin(r)*190,t[n]=Math.random()<.08?2.6:1.2}let n=new Ar;n.setAttribute(`position`,new hr(e,3)),n.setAttribute(`aSize`,new hr(t,1));let r=new _a(n,new fa({color:12372192,size:1.1,sizeAttenuation:!1,transparent:!0,opacity:.75,fog:!1,depthWrite:!1}));return r.renderOrder=-999,r}function lg(e){let t=new In,n=new K(new Aa(40,16,12),new oi({color:4477035,side:1}));t.add(n);let r=new K(new Ta(38,24),new oi({color:1314828,side:2}));r.rotation.x=-Math.PI/2,r.position.y=-3,t.add(r);for(let e=0;e<5;e++){let n=e/5*Math.PI*2,r=new K(new Aa(2.4,8,6),new oi({color:11029012}));r.position.set(Math.cos(n)*18,.8,Math.sin(n)*18),t.add(r)}let i=new K(new Aa(5,12,10),new oi({color:13622517}));i.position.set(-14,24,-20),t.add(i);let a=new Is(e),o=a.fromScene(t,.04);return a.dispose(),o.texture}var ug=`
varying vec2 vUvS;
varying vec3 vNrmS;
varying vec3 vViewS;
void main() {
...
}`;function fg(e){let t=new Da(1.15,3.1,14,1,!0);return t.translate(0,1.55,0),new K(t,new Va({uniforms:{uColor:{value:new G(e)},uIntensity:{value:.5}},vertexShader:ug,fragmentShader:dg,transparent:!0,depthWrite:!1,blending:2,side:2}))}var pg=class{constructor(e){this.position=e.clone(),this.group=new Dn,this.group.position.copy(e),this.light=new Vo(16747066,34,24,2),this.light.position.y=.35,this.light.castShadow=!1,this.group.add(this.light);let t=new Float32Array(138);this.seeds=new Float32Array(138);for(let e=0;e<46;e++)this.seeds[e*3]=Math.random(),this.seeds[e*3+1]=.4+Math.random()*.9,this.seeds[e*3+2]=Math.random()*Math.PI*2;let n=new Ar;n.setAttribute(`position`,new hr(t,3)),this.flame=new _a(n,new fa({color:16753724,size:.3,transparent:!0,opacity:.8,map:og(),blending:2,depthWrite:!1,fog:!0})),this.group.add(this.flame),this.shaft=fg(16748354),this.shaft.position.y=.3,this.group.add(this.shaft),this.phase=Math.random()*20}update(e){let t=this.flame.geometry.attributes.position,n=this.seeds;for(let r=0;r<t.count;r++){let i=(e*n[r*3+1]*.75+n[r*3])%1,a=.16*(1-i)+.03,o=Math.sin(e*5+n[r*3+2])*.09*i;t.setXYZ(r,Math.cos(n[r*3+2])*a+o,i*.95+.1,Math.sin(n[r*3+2])*a+o*.6)}t.needsUpdate=!0;let r=.78+Math.sin(e*11+this.phase)*.12+Math.sin(e*27.3+this.phase*2)*.08;this.light.intensity=34*r,this.flame.material.opacity=.7+r*.22,this.shaft.material.uniforms.uIntensity.value=.34+r*.2,this.shaft.rotation.y=e*.15+this.phase}},mg=class{constructor(e=260,t=26,n=7){this.extent=t,this.height=n;let r=new Float32Array(e*3);this.drift=new Float32Array(e*3);for(let i=0;i<e;i++)r[i*3]=(Math.random()-.5)*t,r[i*3+1]=Math.random()*n,r[i*3+2]=(Math.random()-.5)*t,this.drift[i*3]=(Math.random()-.5)*.18,this.drift[i*3+1]=.02+Math.random()*.09,this.drift[i*3+2]=(Math.random()-.5)*.18;let i=new Ar;i.setAttribute(`position`,new hr(r,3)),i.boundingSphere=new Sr(new V,t),this.points=new _a(i,new fa({color:13154202,size:.035,transparent:!0,opacity:.5,depthWrite:!1,blending:2,fog:!0,map:og(),sizeAttenuation:!0})),this.points.frustumCulled=!1,this.centre=new V}update(e,t,n){let r=this.points.geometry.attributes.position,i=r.array,a=this.extent/2;t&&this.centre.set(t.x,0,t.z);for(let t=0;t<r.count;t++){let r=t*3;i[r]+=(this.drift[r]+Math.sin(n*.3+t)*.05)*e,i[r+1]+=this.drift[r+1]*e,i[r+2]+=(this.drift[r+2]+Math.cos(n*.24+t)*.05)*e,i[r+1]>this.height&&(i[r+1]-=this.height);let o=i[r]-this.centre.x,s=i[r+2]-this.centre.z;o>a?i[r]-=this.extent:o<-a&&(i[r]+=this.extent),s>a?i[r+2]-=this.extent:s<-a&&(i[r+2]+=this.extent)}r.needsUpdate=!0}};function hg(e,t){let n=new In;n.fog=new Fn(ig,.017),n.background=new G(ig),n.environment=lg(e),n.environmentIntensity=.85,n.add(sg()),n.add(cg());let r=new To(4610431,2760467,.98);n.add(r);let i=new Wo(11585260,2.15);i.position.set(-16,22,-13),i.castShadow=!0,i.shadow.mapSize.set(2048,2048);let a=i.shadow.camera;a.left=-14,a.right=14,a.top=14,a.bottom=-14,a.near=1,a.far=60,i.shadow.bias=-7e-4,i.shadow.normalBias=.022,i.shadow.radius=3.2,n.add(i),n.add(i.target);let o=new Wo(16757626,.5);o.position.set(11,5,9),n.add(o);let s=[];if(t){t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)});let e=[];t.traverse(t=>{/^Light_Brazier/.test(t.name)&&e.push(t)}),t.updateMatrixWorld(!0);for(let t of e){let e=new pg(new V().setFromMatrixPosition(t.matrixWorld));s.push(e),n.add(e.group)}n.add(t)}let c=new K(new Ta(60,48),new Ua({color:1775392,roughness:1}));c.rotation.x=-Math.PI/2,c.position.y=-.02,c.receiveShadow=!0,n.add(c);let l=new mg;n.add(l.points);let u=[];for(let e=0;e<1;e++){let e=new Vo(16747066,0,24,2);e.castShadow=!0,e.shadow.mapSize.set(512,512),e.shadow.bias=-.004,e.shadow.normalBias=.04,e.shadow.camera.near=.25,e.shadow.camera.far=18,e.visible=!1,n.add(e),u.push(e)}return{scene:n,moon:i,braziers:s,hemi:r,motes:l,fireShadows:u}}var gg={longsword:{file:`weapon_longsword.glb`,name:`Longsword`,lead:-.05,rear:-.16,tip:1.072,damageMul:1,trail:10470655},greatsword:{file:`weapon_greatsword.glb`,name:`Greatsword`,lead:-.075,rear:-.27,tip:1.2,damageMul:1.18,trail:13162239},daneaxe:{file:`weapon_daneaxe.glb`,name:`Dane Axe`,lead:0,rear:-.55,tip:.545,damageMul:1.12,trail:16757370},warhammer:{file:`weapon_warhammer.glb`,name:`War Hammer`,lead:.01,rear:-.42,tip:.52,damageMul:1.22,trail:16765066},spear:{file:`weapon_spear.glb`,name:`Winged Spear`,lead:.02,rear:-.4,tip:.86,damageMul:.9,trail:12576511},katana:{file:`weapon_katana.glb`,name:`Katana`,lead:-.06,rear:-.25,tip:.742,damageMul:1.05,trail:15267071}},_g={warden:{file:`knight_warden.glb`,name:`Warden`,health:130,speedMul:1,herald:/_accent$/},warden_heavy:{file:`knight_warden_heavy.glb`,name:`Warden — Plate`,health:152,speedMul:.9,herald:/_accent$/},warden_light:{file:`knight_warden_light.glb`,name:`Warden — Mail`,health:112,speedMul:1.1,herald:/_accent$/},raider:{file:`knight_raider.glb`,name:`Raider`,health:130,speedMul:1,herald:/_hide$/},raider_heavy:{file:`knight_raider_heavy.glb`,name:`Raider — Chieftain`,health:152,speedMul:.9,herald:/_hide$/},raider_light:{file:`knight_raider_light.glb`,name:`Raider — Berserker`,health:112,speedMul:1.1,herald:/_hide$/}},vg={compound:`models/compound.glb`,...Object.fromEntries(Object.entries(_g).map(([e,t])=>[`armour_${e}`,`models/${t.file}`])),...Object.fromEntries(Object.entries(gg).map(([e,t])=>[`weapon_${e}`,`models/${t.file}`]))},yg=new Set([`compound`]),bg=new V,xg=new V,Sg=new V;function Cg(){let e=Math.max(1,window.innerWidth||0),t=Math.max(1,window.innerHeight||0);return{w:e,h:t,aspect:e/t}}async function wg(){let e=new Fu;e.setMeshoptDecoder(Pd);let t=await Promise.all(Object.entries(vg).map(async([t,n])=>{try{return[t,await e.loadAsync(n)]}catch(e){if(yg.has(t))return console.warn(`[art-of-battle] ${n} missing — using stand-in`,e),[t,null];throw e}}));return Object.fromEntries(t)}var Tg=class{constructor(e,t,n){this.renderer=t,this.assets=e;let r=hg(t,e.compound?.scene??null);this.scene=r.scene,this.braziers=r.braziers,this.fireShadows=r.fireShadows||[],this._fireShadowOptIn=new URLSearchParams(location.search).has(`fireshadow`),this.motes=r.motes,this.moon=r.moon;let i=Cg();this.camera=new Lo(72,i.aspect,.1,400),this.camera.layers.set(0),this.viewCam=new Lo(45,i.aspect,.02,14),this.viewCam.layers.set(1),this.viewCamBack=1.15;let a=new Vo(16769724,14,8,2);a.position.set(.55,.75,.9),a.layers.set(1);let o=new To(10335448,2760728,1.6);o.layers.set(1),this.viewCam.add(a,o),this.scene.add(this.viewCam),this.duelCam=new fp(this.camera),this.fpCam=new gp(this.camera),this.lockedOn=!1,this.lockOverride=!1,this.lostSight=0,this.post=new rh({renderer:t,scene:this.scene,camera:this.camera,viewCam:this.viewCam}),this.score=new xh,this.compound=new Tp(this.scene,e.compound?.scene??null);let s=e.compound?.scene;if(s&&!new URLSearchParams(location.search).has(`nobatch`)){let e=new Set;for(let t of this.compound.surfaces)t.node&&e.add(t.node);for(let t of this.compound.openings.values())t.node&&e.add(t.node);let t=Jp(s),n=qp(s,e);this.scene.add(n.group);let r=Yp(e),i=new URLSearchParams(location.search),a={strength:i.has(`noao`)?0:parseFloat(i.get(`ao`)??`0.55`)},o=sm(s,this.compound.surfaces,a),c=sm(n.group,this.compound.surfaces,a);this.batchStats={...n,panels:r,fold:t,ao:o,aoBatch:c}}this.duelCam.collider=this.compound,this.vfx=new rg(this.scene),this.hud=new Hh(n),this.siegeHud=new qh(this.hud),this.audio=new Rd,this.score.attach(this.audio),this.input=new Gh(t.domElement),this.gadgets=new Ph(this.scene,this.compound),this._buildFighters(),this.siege=new tp({player:this.player,enemy:this.enemy,compound:this.compound,duel:this.duel}),this.nav=new Ch(this.compound),this.ai.siege=this.siege,this.ai.gadgets=this.gadgets,this.ai.compound=this.compound,this.ai.nav=this.nav,this.time=0,this.timeScale=1,this.slowmo=0,this.fx={damage:0,lowHealth:0,hitFlash:0,slowmo:0},this.started=!1,this.paused=!1,this._move={x:0,y:0},this._prepAngle=0,this._scout={yaw:0,pitch:.85,dist:23,focus:new V(0,.5,0),idle:0},this.creator=new vm({armours:Object.entries(_g).map(([e,t])=>({key:e,...t})),weapons:Object.entries(gg).map(([e,t])=>({key:e,...t}))}),this.mode=`create`,this.startMatch(),this.enterCreation()}_instance(e){let t=this.assets[e];return t?t.scene.clone(!0):null}_buildFighters(){let e=gg.longsword,t=gg.daneaxe,n=_g.warden_heavy,r=_g.raider_heavy;this.player=new jm({name:`Warden`,model:this._instance(`armour_warden_heavy`),weapon:this._instance(`weapon_longsword`),grip:e,profile:{damageMul:e.damageMul,leadHand:`R`,trail:e.trail,speedMul:n.speedMul},x:0,z:-14,yaw:0,health:n.health}),this.enemy=new jm({name:`Raider`,model:this._instance(`armour_raider_heavy`),weapon:this._instance(`weapon_daneaxe`),grip:t,profile:{damageMul:t.damageMul,leadHand:`R`,trail:t.trail,speedMul:r.speedMul},x:6,z:4,yaw:Math.PI,health:r.health}),this.player.collider=this.compound,this.enemy.collider=this.compound,this.player.rig.setFirstPerson(!0),this.player.freeLook=!0,this.scene.add(this.player.group,this.enemy.group),this.duel=new Sp(this.player,this.enemy),this.ai=new op(this.enemy,this.duel,`warrior`),this.fpCam.snap(this.player,this.enemy,!1)}enterCreation(){this.mode=`create`,this.siege.drain();let e=this.player;e.rig.setFirstPerson(!1),e.frozen=!0,e.freeLook=!0,e.pos.set(0,0,-15),e.velocity.set(0,0,0),e.setGuard(`right`),this.enemy.group.visible=!1,this.creator.dirty=!0}applyPlayerLoadout(){let e=this.creator,t=_g[e.armour.key],n=gg[e.weapon.key];this.player.setLoadout({model:this._instance(`armour_${e.armour.key}`),weapon:this._instance(`weapon_${e.weapon.key}`),grip:n,profile:{damageMul:n.damageMul,leadHand:`R`,trail:n.trail,speedMul:t.speedMul}}),ym(this.player.rig,e.herald.hex,t.herald),this.player.traits=dm(e.archetypeKey,e.perkKeys),this.player.archetypeName=e.archetype.name,this.player.maxHealth=Math.round(t.health*this.player.traits.healthMul),this.player.health=this.player.maxHealth,this.vfx.trails.delete(this.player)}beginMatch(){this.applyPlayerLoadout(),this.player.name=(this.creator.name||``).trim()||`Warden`,this.player.rig.setFirstPerson(!0),this.player.frozen=!1,this.enemy.group.visible=!0,this.mode=`match`,this.startMatch()}_updateCreate(e,t){this.creator.dirty&&(this.applyPlayerLoadout(),this.creator.dirty=!1);let n=this.creator.handle(t);this.creator.update(e),this.creator.poseCamera(this.camera,this.player),this.player.update(e,this.enemy),this.player.events.length=0,this._renderFrame(e),this.hud.ctx.clearRect(0,0,this.hud.w,this.hud.h),this.creator.draw(this.hud,this.player),n&&this.beginMatch()}_rollEnemyBuild(){let e=e=>e[Math.random()*e.length|0],t=e(fm),n=pm.filter(e=>e!==`none`),r=e(n),i=e(n);for(;i===r;)i=e(n);this.enemy.traits=dm(t,[r,i]),this.enemyArchetype=cm[t].name;let a=_g.raider_heavy.health;this.enemy.maxHealth=Math.round(a*this.enemy.traits.healthMul),this.enemy.health=this.enemy.maxHealth,this.enemy.archetypeName=this.enemyArchetype}startMatch(){this.duel.over=!1,this.duel.winner=null,this._rollEnemyBuild(),this.siege.startMatch(),this.hud.messages.length=0,this.hud.floats.length=0;for(let e of this.vfx.trails.values())e.clear()}_onRoundStart(){this.duel.over=!1,this.duel.winner=null,this.gadgets.resetFor([this.player,this.enemy],e=>this.siege.roleOf(e)),this.ai.reset?.(),this.fpCam.snap(this.player,this.enemy,!1)}enemyVisible(){let e=this.player.pos,t=this.enemy.pos;return!(this.compound.losBlocked(e.x,e.z,t.x,t.z)||this.gadgets.smokeBlocks(e.x,e.z,t.x,t.z))}_gadgetTarget(e){let t=this.player,n=t.pos.x+Math.sin(t.yaw)*1.5,r=t.pos.z+Math.cos(t.yaw)*1.5;if(e===`barricade`){let e=null,t=2.6;for(let[i,a]of this.compound.openings){if(a.barricade)continue;let o=Math.hypot(n-a.cx,r-a.cz);o<t&&(t=o,e=i)}return e?{openingId:e}:null}if(e===`reinforce`){let e=this.compound.nearestSurface(n,r,2.2,e=>e.kind===`panel`&&e.soft&&!e.reinforced);return e?{surface:e.surface}:null}if(e===`breach`){let e=this.compound.nearestSurface(n,r,2.2,e=>e.kind===`panel`);return e?{surface:e.surface}:null}return{}}_updateLockOn(e){let t=this.player.pos.distanceTo(this.enemy.pos)<5.2;this.enemyVisible()?this.lostSight=0:this.lostSight+=e;let n=this.siege.phase===Q.ACTION&&this.player.alive&&this.enemy.alive&&!this.lockOverride&&t&&this.lostSight<.45;this.lockedOn=n,this.input.lockedOn=n,this.player.freeLook=!n,n?this.input.yaw=this.player.yaw:this.player.yaw=this.input.yaw}_handleInput(e,t=1/60){let n=this.input.move(this._move),r=this.player,i=this.siege.phase;if(e.gadgetSlot!=null&&this._useGadget(e.gadgetSlot),e.toggleLock&&(this.lockOverride=!this.lockOverride,this.hud.say(this.lockOverride?`FREE LOOK`:`LOCK ON`,`#c9d2de`,.8)),i===Q.PREP){r.moveInput.set(0,0),this._scoutInput(e,n,t);return}if(i!==Q.ACTION||!r.alive){r.moveInput.set(0,0);return}r.moveInput.set(n.x,n.y),this.lockedOn&&(r.setGuard(this.input.guard),e.guardChanged&&this.audio.play(`ui_stance`,{volume:.5})),e.light&&r.startAttack(`light`),e.heavy&&(this.duel.tryParry(r)||r.startAttack(`heavy`)),e.heavyReleased&&r.releaseCharge(),e.feint&&r.feint(),e.gb&&r.startGuardBreak(),e.dodge&&r.startDodge(n.x,n.y)}_useGadget(e){let t=this.siege.phase===Q.PREP?`prep`:`action`,n=this.gadgets.inventory.get(this.player)||{},r=Object.keys(n)[e];if(!r)return;let i=Dh[r];if(i.phase!==`any`&&i.phase!==t){this.hud.say(`${i.label} — WRONG PHASE`,Vh.dim,.8);return}if(this.gadgets.remaining(this.player,r)<=0){this.hud.say(`NONE LEFT`,Vh.dim,.7);return}let a=this._gadgetTarget(r);if(!a){this.hud.say(`NOTHING TO USE IT ON`,Vh.dim,.9);return}this.gadgets.use(this.player,r,a)?this.hud.say(i.label.toUpperCase(),`#c9d2de`,.8):this.hud.say(`CANNOT PLACE THERE`,Vh.dim,.9)}_pan(e){xg.setFromMatrixColumn(this.camera.matrixWorld,0),bg.subVectors(e,this.camera.position);let t=Math.max(1,bg.length());return At.clamp(bg.dot(xg)/t*2.2,-1,1)}_processEvents(){let e=this.audio;for(let t of[this.player,this.enemy]){for(let n of t.events)switch(n.type){case`swing`:e.play(n.attack.type===`heavy`?`swing_heavy`:`swing_light`,{volume:.75,pan:this._pan(t.pos),rate:.94+Math.random()*.12});break;case`footstep`:{let r=t.feet[n.side];e.play(`footstep`,{volume:.28,pan:this._pan(r.world)}),t.velocity.lengthSq()>1.2&&this.vfx.dust(r.world,4,.8);break}case`dodge`:e.play(`dodge`,{volume:.6,pan:this._pan(t.pos)}),this.vfx.dust(bg.copy(t.pos).setY(.05),12,1.4);break;case`guardbreak`:e.play(`guardbreak`,{volume:.5,pan:this._pan(t.pos)});break;case`feint`:e.play(`ui_stance`,{volume:.7,rate:.7});break;case`unblockable`:this.vfx.unblockableTell(t.rig.bladeTip(bg)),e.play(`ui_stance`,{volume:.9,rate:.55}),t===this.enemy&&this.hud.say(`UNBLOCKABLE`,Vh.unblock,.9);break;case`exhausted`:e.play(`stamina_empty`,{volume:.7}),t===this.player&&this.hud.say(`EXHAUSTED`,Vh.staminaLow,1);break;case`death`:e.play(`death`,{volume:.9,pan:this._pan(t.pos)}),this.vfx.dust(bg.copy(t.pos).setY(.1),26,1.8);break}t.events.length=0}for(let t of this.duel.drain()){let n=t.point?this._pan(t.point):0;switch(t.type){case`hit`:t.defender===this.player?this.fx.damage=1:this.fx.hitFlash=1,e.play(`hit_flesh`,{volume:.95,pan:n}),bg.subVectors(t.defender.pos,t.attacker.pos).normalize(),this.vfx.bloodHit(t.point,bg,t.heavy),this.fpCam.kick(t.heavy?.55:.3,t.heavy?4:1.5),this.hud.float(t.point,`${t.damage}`,t.defender===this.player?`#ff6b5e`:`#ffe9c9`),e.duckMusic(.5,.4);break;case`block`:e.play(`hit_block`,{volume:.85,pan:n,rate:.92+Math.random()*.16}),bg.subVectors(t.defender.pos,t.attacker.pos).normalize(),this.vfx.clash(t.point,bg),this.fpCam.kick(t.heavy?.3:.16,t.heavy?1.5:0);break;case`parry`:this.fx.hitFlash=1,e.play(`parry`,{volume:1,pan:n}),this.vfx.parryBurst(t.point),this.fpCam.kick(.7,5),this.hud.say(`PARRY`,Vh.parry,1,!0),this.score.sting(`parry`),this.slowmo=.34,e.duckMusic(.8,.6);break;case`gbhit`:e.play(`guardbreak`,{volume:.95,pan:n}),this.fpCam.kick(.35,2),this.hud.say(`GUARD BROKEN`,`#e8d9b0`,.9),this.vfx.dust(bg.copy(t.defender.pos).setY(.05),14,1.5);break;case`gbcounter`:e.play(`parry`,{volume:.8,pan:n,rate:.8}),this.hud.say(`COUNTERED`,Vh.parry,.9),this.fpCam.kick(.4,2);break;case`whiff`:this._swingHitsWorld(t);break;case`dodged`:this.hud.say(`MISS`,`rgba(220,228,240,0.75)`,.6);break}}for(let t of this.gadgets.drain())switch(t.type){case`breached`:e.play(`hit_block`,{volume:1,rate:.45}),e.play(`death`,{volume:.55,rate:1.5}),this.fpCam.kick(.85,6),this.vfx.dust(t.pos,40,3.2),this.vfx.clash(t.pos,bg.set(0,1,0)),this.hud.say(`BREACH`,Vh.unblock,1,!0),this.score.sting(`breach`);break;case`alarm`:e.play(`ui_stance`,{volume:1,rate:1.8}),this.hud.say(t.fighter===this.player?`ALARM TRIPPED`:`ALARM — THEY ARE CLOSE`,Vh.unblock,1);break;case`caltrophit`:e.play(`hit_flesh`,{volume:.4,rate:1.6});break;case`gadget`:e.play(`ui_stance`,{volume:.6,rate:.9});break}for(let t of this.siege.drain())switch(t.type){case`roundstart`:this._onRoundStart(),this.hud.say(`ROUND ${t.round} — ${t.playerRole===Zf.ATTACK?`ATTACK`:`DEFEND`}`,t.playerRole===Zf.ATTACK?`#e08a3c`:`#6fb3ff`,2,!0);break;case`phase`:t.phase===Q.ACTION&&(this.hud.say(`FIGHT`,`#e8eef8`,1.2,!0),this.hud.showHints(),e.play(`victory`,{volume:.5,rate:.7}));break;case`objectivehit`:e.play(`hit_block`,{volume:.7,rate:.7}),this.vfx.clash(this.compound.objective.pos.clone().setY(1.4),bg.set(0,1,0)),t.broke&&(this.score.sting(`objective`),this.hud.say(`BANNER DOWN`,Vh.unblock,1.4,!0),this.fpCam.kick(.7,4));break;case`roundend`:this.score.sting(t.winner===`player`?`roundwin`:`roundloss`),e.play(t.winner===`player`?`victory`:`defeat`,{volume:.9}),this.slowmo=1;break;case`matchend`:e.play(t.winner===`player`?`victory`:`defeat`,{volume:1});break}}_swingHitsWorld(e){let t=e.attacker,n=t.rig.bladeTip(new V),r=e.heavy;if(this.siege.strikeObjective(t,r?22:10))return;let i=this.compound.damageAt(n.x,n.z,.85,r?46:18);if(i.length){this.audio.play(`hit_block`,{volume:.5,rate:1.25});for(let e of i){let t=this.compound.centre(e.surface,new V);e.broken?(this.vfx.dust(t,22,2.4),this.vfx.clash(t,bg.set(0,1,0)),this.fpCam.kick(.3,1.5)):this.vfx.dust(t,5,1.2)}}}update(e){let t=this.input.flush();this.time+=e;for(let e of this.braziers)e.update(this.time);if(this._followFireShadows(),this.motes?.update(e,this.player.pos,this.time),this.mode===`create`){this._updateCreate(e,t),this._driveScore(e);return}if(t.pause&&(this.paused=!this.paused),t.restart&&this.siege.phase===Q.MATCH_OVER&&(this.startMatch(),this.paused=!1),t.toggleHints){let e=this.hud.toggleHints();this.hud.say(e?`CONTROLS PINNED`:`CONTROLS HIDDEN`,`#c9d2de`,.9)}if(t.cycleQuality&&this.post){let e=[`high`,`medium`,`off`],t=e[(e.indexOf(this.post.quality)+1)%e.length];this.post.setQuality(t),this.post.enabled=t!==`off`,this.hud.say(`GRAPHICS — ${t.toUpperCase()}`,`#c9d2de`,1.2)}t.difficulty&&!this.started&&(this.ai.setDifficulty(t.difficulty),this.hud.say(t.difficulty.toUpperCase(),`#c9d2de`,1.1));let n=!this.started||this.paused;if(n)this.player.update(0,this.enemy),this.enemy.update(0,this.player);else{this._updateLockOn(e),this._handleInput(t,e),this.slowmo>0&&(this.slowmo-=e);let n=this.slowmo>0?.28:1;this.timeScale+=(n-this.timeScale)*Math.min(1,e*(this.slowmo>0?22:6));let r=e*this.timeScale;this.duel.hitStop>0&&(this.duel.hitStop-=e,r*=.06),this.siege.update(r),this.ai.update(r),this.player.update(r,this.enemy),this.enemy.update(r,this.player),this.siege.phase===Q.ACTION&&this.duel.update(),this.gadgets.update(r,[this.player,this.enemy],this.time)}this._processEvents(),this.fx.damage=Math.max(0,this.fx.damage-e*1.8),this.fx.hitFlash=Math.max(0,this.fx.hitFlash-e*6),this.fx.slowmo+=(+(this.slowmo>0)-this.fx.slowmo)*Math.min(1,e*8);let r=this.player.health/Math.max(1,this.player.maxHealth);this.fx.lowHealth+=(Math.max(0,1-r/.35)-this.fx.lowHealth)*Math.min(1,e*3),this.post&&(this.post.damage=this.fx.damage,this.post.lowHealth=this.fx.lowHealth,this.post.hitFlash=this.fx.hitFlash,this.post.slowmo=this.fx.slowmo),this._driveScore(e),this.vfx.updateTrail(this.player,this.player.profile.trail),this.vfx.updateTrail(this.enemy,this.enemy.profile.trail),this.vfx.update(e,this.camera),this._updateCamera(e),this.moon.target.position.lerp(bg.copy(this.player.pos).lerp(this.enemy.pos,.5),.1),this.moon.position.copy(this.moon.target.position).add(bg.set(-16,22,-13)),this._renderFrame(e);let i=this.enemyVisible();this.hud.draw(e,{player:this.player,enemy:this.enemy,camera:this.camera,duel:this.duel,paused:n,started:this.started,showIndicator:i&&this.siege.phase===Q.ACTION}),this.siegeHud.draw(e,{siege:this.siege,compound:this.compound,gadgets:this.gadgets,player:this.player,enemy:this.enemy,camera:this.camera,enemyVisible:i,time:this.time})}_driveScore(e){if(!this.score)return;let t=`menu`,n=.15;if(this.mode===`match`){let e=this.siege.phase;if(e===Q.PREP)t=`prep`,n=.3;else if(e===Q.ACTION){let e=this.player.pos.distanceTo(this.enemy.pos),r=this.lockedOn||e<6;t=r?`combat`:`stalk`;let i=1-this.player.health/Math.max(1,this.player.maxHealth),a=At.clamp(1-(e-2)/14,0,1);n=At.clamp((r?.55:.2)+a*.25+i*.3,0,1)}else(e===Q.RESOLVE||e===Q.MATCH_OVER)&&(t=this.siege.lastResult?.winner===`player`?`victory`:`defeat`,n=.4)}this.score.setState(t),this.score.setIntensity(n),this.score.update(e)}_renderFrame(e=.016){let t=!!this.player.rig.firstPerson;if(t&&(this.viewCam.position.copy(this.camera.position).addScaledVector(this.camera.getWorldDirection(Sg),-this.viewCamBack),this.viewCam.quaternion.copy(this.camera.quaternion),this.viewCam.updateMatrixWorld(!0)),this.post?.enabled){this.post.viewmodel=t,this.post.render(e);return}let n=this.renderer;if(n.render(this.scene,this.camera),!t)return;let r=this.scene.background;this.scene.background=null,n.autoClear=!1,n.clearDepth(),n.render(this.scene,this.viewCam),n.autoClear=!0,this.scene.background=r}_scoutInput(e,t,n){let r=this._scout,i=t.x||t.y,a=this.input.yaw,o=this.input.pitch;if(a!==r._lastYaw||o!==r._lastPitch?r.idle=0:r.idle+=n,r._lastYaw=a,r._lastPitch=o,r.yaw=a,r.pitch=At.clamp(.35+o*.9,.22,1.32),i){r.idle=0;let e=Math.cos(r.yaw),i=Math.sin(r.yaw),a=7*n;r.focus.x=At.clamp(r.focus.x-(t.x*e+t.y*i)*a,-16,16),r.focus.z=At.clamp(r.focus.z-(t.y*e-t.x*i)*a,-16,16)}(e.keys?.includes(`Enter`)||e.dodge)&&this.siege.skipPrep()&&this.hud.say(`THE HORN SOUNDS`,`#e0c45a`,1.2)}_followFireShadows(){if(!this.fireShadows.length)return;if(!this._fireShadowOptIn){for(let e of this.fireShadows)e.visible=!1;for(let e of this.braziers)e.light.visible=!0;return}let e=this.camera.position,t=null,n=null,r=1/0,i=1/0;for(let a of this.braziers){let o=a.position.distanceToSquared(e);o<r?(n=t,i=r,t=a,r=o):o<i&&(n=a,i=o)}let a=[t,n];for(let e of this.braziers)e.light.visible=!0;this.fireShadows.forEach((e,t)=>{let n=a[t];if(!n||r>400){e.visible=!1;return}e.visible=!0,e.position.copy(n.position).setY(n.position.y+.35),e.intensity=n.light.intensity,e.distance=n.light.distance,n.light.visible=!1})}_updateCamera(e){if(this.siege.phase===Q.PREP){let t=this._scout;t.idle>1.5&&(this._prepAngle+=e*.12);let n=t.yaw+this._prepAngle,r=t.dist*Math.cos(t.pitch*.55);bg.set(t.focus.x+Math.sin(n)*r,6+Math.sin(t.pitch)*19,t.focus.z+Math.cos(n)*r),this.camera.position.lerp(bg,1-Math.exp(-6*e)),this.camera.lookAt(t.focus.x,.5,t.focus.z);return}this.fpCam.update(e,this.player,this.enemy,this.lockedOn)}};async function Eg(){let e=document.getElementById(`view`),t=document.getElementById(`hud`),n=document.getElementById(`loading`),r=new ku({canvas:e,antialias:!0,powerPreference:`high-performance`});r.setPixelRatio(Math.min(2,window.devicePixelRatio));let i=Cg();r.setSize(i.w,i.h),r.shadowMap.enabled=!0,r.shadowMap.type=1,r.toneMapping=4,r.toneMappingExposure=1.12;let a;try{a=await wg()}catch(e){throw n.textContent=`Failed to load assets: ${e.message}`,e}{let e=0,t=new Set;for(let n of Object.values(a)){if(!n?.scene)continue;let r=Wp(n.scene);e+=r.matched,r.missed.forEach(e=>t.add(e))}t.size&&console.warn(`[art-of-battle] no surface family for: ${[...t].join(`, `)}`),console.info(`[art-of-battle] surface detail on ${e} materials`)}let o=new Tg(a,r,t);window.__game=o,n.classList.add(`gone`),e.addEventListener(`click`,()=>{o.audio.unlock(),o.audio.startAmbience(),o.score.start(),o.started=!0,o.paused=!1}),window.addEventListener(`resize`,()=>{let{w:e,h:t,aspect:n}=Cg();o.camera.aspect=n,o.camera.updateProjectionMatrix(),o.viewCam.aspect=n,o.viewCam.updateProjectionMatrix(),r.setSize(e,t),o.post?.setSize(e,t)});let s=performance.now();r.setAnimationLoop(e=>{let t=Math.min(.05,(e-s)/1e3);s=e,o.update(t)})}Eg();