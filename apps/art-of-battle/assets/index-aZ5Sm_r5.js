...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},im=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},am=new Ho(-1,1,1,-1,0,1),om=new class extends kr{constructor(){super(),this.setAttribute(`position`,new _r([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new _r([0,2,0,0,2,0],2))}},sm=class{constructor(e){this._mesh=new _i(om,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,am)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},cm=class extends im{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Va?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ra.clone(e.uniforms),this.material=new Va({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new sm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},lm=class extends im{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},um=class extends im{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},dm=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new V);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new cm(rm),this.copyPass.material.blending=0,this.timer=new Qo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}lm!==void 0&&(r instanceof lm?n=!0:r instanceof um&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new V);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},fm={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};pm.BlurDirectionX=new V(1,0),pm.BlurDirectionY=new V(0,1);var mm={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},_m={name:`SMAAWeightsShader`,defines:{SMAA_MAX_SEARCH_STEPS:`8`,SMAA_AREATEX_MAX_DISTANCE:`16`,SMAA_AREATEX_PIXEL_SIZE:`( 1.0 / vec2( 160.0, 560.0 ) )`,SMAA_AREATEX_SUBTEX_SIZE:`( 1.0 / 7.0 )`},uniforms:{tDiffuse:{value:null},tArea:{value:null},tSearch:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
		...
		}`},vm={name:`SMAABlendShader`,uniforms:{tDiffuse:{value:null},tColor:{value:null},resolution:{value:new V(1/1024,1/512)}},vertexShader:`
...
}`,Sh=class{constructor(){let e=new Float32Array(gh*3),t=new Float32Array(gh*3),n=new Float32Array(gh),r=new Float32Array(gh);this.vel=new Float32Array(gh*3),this.age=new Float32Array(gh),this.ttl=new Float32Array(gh),this.drag=new Float32Array(gh),this.gravity=new Float32Array(gh),this.head=0;let i=new kr;i.setAttribute(`position`,new mr(e,3)),i.setAttribute(`aColor`,new mr(t,3)),i.setAttribute(`aSize`,new mr(n,1)),i.setAttribute(`aLife`,new mr(r,1)),i.setDrawRange(0,gh),i.boundingSphere=new xr(new H,60),this.points=new _a(i,new Va({vertexShader:bh,fragmentShader:xh,transparent:!0,depthWrite:!1,blending:2})),this.points.frustumCulled=!1,this.geo=i}spawn(e,t){let{count:n=16,speed:r=5,spread:i=1,color:a=new K(16756821),size:o=.09,ttl:s=.5,gravity:c=9,drag:l=2.6,dir:u=null,colorJitter:d=.2}=t,f=this.geo.attributes.position.array,p=this.geo.attributes.aColor.array,m=this.geo.attributes.aSize.array,h=this.geo.attributes.aLife.array;for(let t=0;t<n;t++){let t=this.head;this.head=(this.head+1)%gh,f[t*3]=e.x,f[t*3+1]=e.y,f[t*3+2]=e.z,vh.set(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1),vh.lengthSq()<1e-5&&vh.set(0,1,0),vh.normalize(),u&&vh.lerp(u,1-i*.5).normalize();let n=r*(.35+Math.random()*.9);this.vel[t*3]=vh.x*n,this.vel[t*3+1]=vh.y*n,this.vel[t*3+2]=vh.z*n;let g=1+(Math.random()-.5)*d;p[t*3]=a.r*g,p[t*3+1]=a.g*g,p[t*3+2]=a.b*g,m[t]=o*(.6+Math.random()*.9),h[t]=1,this.age[t]=0,this.ttl[t]=s*(.65+Math.random()*.7),this.gravity[t]=c,this.drag[t]=l}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.aColor.needsUpdate=!0,this.geo.attributes.aSize.needsUpdate=!0,this.geo.attributes.aLife.needsUpdate=!0}update(e){let t=this.geo.attributes.position.array,n=this.geo.attributes.aLife.array,r=!1;for(let i=0;i<gh;i++){if(n[i]<=0)continue;r=!0,this.age[i]+=e;let a=this.age[i]/this.ttl[i];if(a>=1){n[i]=0;continue}n[i]=1-a*a;let o=Math.max(0,1-this.drag[i]*e);this.vel[i*3]*=o,this.vel[i*3+1]=this.vel[i*3+1]*o-this.gravity[i]*e,this.vel[i*3+2]*=o,t[i*3]+=this.vel[i*3]*e,t[i*3+1]+=this.vel[i*3+1]*e,t[i*3+2]+=this.vel[i*3+2]*e,t[i*3+1]<.02&&(t[i*3+1]=.02,this.vel[i*3+1]*=-.28,this.vel[i*3]*=.6,this.vel[i*3+2]*=.6)}r&&(this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.aLife.needsUpdate=!0)}},Ch=class{constructor(e){let t=new kr,n=new Float32Array(_h*2*3),r=new Float32Array(_h*2*4),i=[];for(let e=0;e<_h-1;e++){let t=e*2;i.push(t,t+1,t+2,t+1,t+3,t+2)}t.setAttribute(`position`,new mr(n,3)),t.setAttribute(`color`,new mr(r,4)),t.setIndex(i),t.boundingSphere=new xr(new H,60),this.mesh=new _i(t,new ai({vertexColors:!0,transparent:!0,depthWrite:!1,side:2,blending:2})),this.mesh.frustumCulled=!1,this.geo=t,this.color=new K(e),this.count=0,this.strength=0,this.tips=Array.from({length:_h},()=>new H),this.bases=Array.from({length:_h},()=>new H)}push(e,t,n){for(let e=_h-1;e>0;e--)this.tips[e].copy(this.tips[e-1]),this.bases[e].copy(this.bases[e-1]);this.tips[0].copy(t),this.bases[0].copy(e),this.count=Math.min(_h,this.count+1),this.strength=n}update(e){this.strength=Math.max(0,this.strength-e*5);let t=this.geo.attributes.position.array,n=this.geo.attributes.color.array,r=this.count;for(let e=0;e<_h;e++){let i=Math.min(e,Math.max(0,r-1)),a=this.bases[i],o=this.tips[i];t[e*6]=a.x,t[e*6+1]=a.y,t[e*6+2]=a.z,t[e*6+3]=o.x,t[e*6+4]=o.y,t[e*6+5]=o.z;let s=(e<r?(1-e/_h)**1.7:0)*this.strength;for(let t of[0,1]){let r=(e*2+t)*4;n[r]=this.color.r,n[r+1]=this.color.g,n[r+2]=this.color.b,n[r+3]=s*(t===1?.3:0)}}this.geo.attributes.position.needsUpdate=!0,this.geo.attributes.color.needsUpdate=!0,this.mesh.visible=this.strength>.01}clear(){this.count=0,this.strength=0}},wh=class{constructor(){this.sprites=[],this.group=new En;for(let e=0;e<8;e++){let e=new _i(new ka(1,1),new ai({color:16777215,transparent:!0,opacity:0,blending:2,depthWrite:!1,fog:!1}));e.visible=!1,this.group.add(e),this.sprites.push({mesh:e,age:0,ttl:0,size:1})}this.head=0}spawn(e,t,n,r=.16){let i=this.sprites[this.head];this.head=(this.head+1)%this.sprites.length,i.mesh.position.copy(e),i.mesh.material.color.set(t),i.age=0,i.ttl=r,i.size=n,i.mesh.visible=!0}update(e,t){for(let n of this.sprites){if(!n.mesh.visible)continue;n.age+=e;let r=n.age/n.ttl;if(r>=1){n.mesh.visible=!1,n.mesh.material.opacity=0;continue}let i=n.size*(.5+r*1.5);n.mesh.scale.set(i,i,i),n.mesh.material.opacity=(1-r)*(1-r)*.9,n.mesh.quaternion.copy(t.quaternion)}}},Th=class{constructor(e){this.scene=e,this.sparks=new Sh,this.flash=new wh,e.add(this.sparks.points),e.add(this.flash.group),this.trails=new Map,this._c=new K}trailFor(e,t){let n=this.trails.get(e);return n||(n=new Ch(t),this.trails.set(e,n),this.scene.add(n.mesh)),n}clash(e,t){this.sparks.spawn(e,{count:30,speed:7.5,spread:1.4,size:.075,ttl:.55,color:this._c.setHex(16767392),gravity:11,drag:1.8,dir:t,colorJitter:.35}),this.flash.spawn(e,16773328,1.5,.13)}parryBurst(e){this.sparks.spawn(e,{count:54,speed:10,spread:1.6,size:.095,ttl:.75,color:this._c.setHex(16774344),gravity:9,drag:1.4,colorJitter:.3}),this.flash.spawn(e,16777215,2.9,.24)}bloodHit(e,t,n){this.sparks.spawn(e,{count:n?34:20,speed:n?5.2:3.6,spread:1.1,size:n?.1:.075,ttl:.75,color:this._c.setHex(9311252),gravity:13,drag:2.2,dir:t,colorJitter:.4}),this.flash.spawn(e,16733491,n?1.5:1,.12)}dust(e,t=10,n=1.6){yh.set(0,1,0),this.sparks.spawn(e,{count:t,speed:n,spread:1.7,size:.16,ttl:.85,color:this._c.setHex(5260858),gravity:1.6,drag:3.4,dir:yh,colorJitter:.25})}unblockableTell(e){this.sparks.spawn(e,{count:26,speed:2.2,spread:1.8,size:.11,ttl:.7,color:this._c.setHex(16742928),gravity:-1.4,drag:1.6,colorJitter:.2})}updateTrail(e,t){let n=this.trailFor(e,t);e.state===`attack`&&e.attack&&e.clipTime>e.attack.windup*.82&&e.clipTime<e.attack.strike+.22?n.push(e.rig.bladePoint(.58,vh),e.rig.bladeTip(yh),1):n.strength<=.02&&(n.clear(),n.push(e.rig.bladePoint(.58,vh),e.rig.bladeTip(yh),0))}update(e,t){this.sparks.update(e),this.flash.update(e,t);for(let t of this.trails.values())t.update(e)}},Eh=1316383,Dh=null;function Oh(){if(Dh)return Dh;let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,0,32,32,32);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.3,`rgba(255,196,120,0.62)`),n.addColorStop(1,`rgba(255,110,20,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),Dh=new ba(e),Dh.colorSpace=Ve,Dh}function kh(){let e=new Aa(220,32,24),t=[],n=e.attributes.position,r=new K(658712),i=new K(2304573),a=new K(4864565),o=new K;for(let e=0;e<n.count;e++){let s=n.getY(e)/220;s>.05?o.copy(i).lerp(r,Math.min(1,s*1.5)):o.copy(a).lerp(i,Math.min(1,(s+.35)/.4)),t.push(o.r,o.g,o.b)}e.setAttribute(`color`,new _r(t,3));let s=new _i(e,new ai({vertexColors:!0,side:1,fog:!1,depthWrite:!1}));return s.renderOrder=-1e3,s}function Ah(){let e=new Float32Array(900*3),t=new Float32Array(900);for(let n=0;n<900;n++){let r=Math.random()*Math.PI*2,i=Math.acos(2*Math.random()-1),a=Math.abs(Math.cos(i))*190;e[n*3]=Math.sin(i)*Math.cos(r)*190,e[n*3+1]=a*.9+12,e[n*3+2]=Math.sin(i)*Math.sin(r)*190,t[n]=Math.random()<.08?2.6:1.2}let n=new kr;n.setAttribute(`position`,new mr(e,3)),n.setAttribute(`aSize`,new mr(t,1));let r=new _a(n,new fa({color:12372192,size:1.1,sizeAttenuation:!1,transparent:!0,opacity:.75,fog:!1,depthWrite:!1}));return r.renderOrder=-999,r}function jh(e){let t=new Fn,n=new _i(new Aa(40,16,12),new ai({color:4477035,side:1}));t.add(n);let r=new _i(new Ta(38,24),new ai({color:1314828,side:2}));r.rotation.x=-Math.PI/2,r.position.y=-3,t.add(r);for(let e=0;e<5;e++){let n=e/5*Math.PI*2,r=new _i(new Aa(2.4,8,6),new ai({color:11029012}));r.position.set(Math.cos(n)*18,.8,Math.sin(n)*18),t.add(r)}let i=new _i(new Aa(5,12,10),new ai({color:13622517}));i.position.set(-14,24,-20),t.add(i);let a=new Is(e),o=a.fromScene(t,.04);return a.dispose(),o.texture}var Mh=class{constructor(e){this.position=e.clone(),this.group=new En,this.group.position.copy(e),this.light=new Vo(16747066,34,24,2),this.light.position.y=.35,this.light.castShadow=!1,this.group.add(this.light);let t=new Float32Array(138);this.seeds=new Float32Array(138);for(let e=0;e<46;e++)this.seeds[e*3]=Math.random(),this.seeds[e*3+1]=.4+Math.random()*.9,this.seeds[e*3+2]=Math.random()*Math.PI*2;let n=new kr;n.setAttribute(`position`,new mr(t,3)),this.flame=new _a(n,new fa({color:16753724,size:.3,transparent:!0,opacity:.8,map:Oh(),blending:2,depthWrite:!1,fog:!0})),this.group.add(this.flame),this.phase=Math.random()*20}update(e){let t=this.flame.geometry.attributes.position,n=this.seeds;for(let r=0;r<t.count;r++){let i=(e*n[r*3+1]*.75+n[r*3])%1,a=.16*(1-i)+.03,o=Math.sin(e*5+n[r*3+2])*.09*i;t.setXYZ(r,Math.cos(n[r*3+2])*a+o,i*.95+.1,Math.sin(n[r*3+2])*a+o*.6)}t.needsUpdate=!0;let r=.78+Math.sin(e*11+this.phase)*.12+Math.sin(e*27.3+this.phase*2)*.08;this.light.intensity=34*r,this.flame.material.opacity=.7+r*.22}},Nh=class{constructor(e=260,t=26,n=7){this.extent=t,this.height=n;let r=new Float32Array(e*3);this.drift=new Float32Array(e*3);for(let i=0;i<e;i++)r[i*3]=(Math.random()-.5)*t,r[i*3+1]=Math.random()*n,r[i*3+2]=(Math.random()-.5)*t,this.drift[i*3]=(Math.random()-.5)*.18,this.drift[i*3+1]=.02+Math.random()*.09,this.drift[i*3+2]=(Math.random()-.5)*.18;let i=new kr;i.setAttribute(`position`,new mr(r,3)),i.boundingSphere=new xr(new H,t),this.points=new _a(i,new fa({color:13154202,size:.035,transparent:!0,opacity:.5,depthWrite:!1,blending:2,fog:!0,map:Oh(),sizeAttenuation:!0})),this.points.frustumCulled=!1,this.centre=new H}update(e,t,n){let r=this.points.geometry.attributes.position,i=r.array,a=this.extent/2;t&&this.centre.set(t.x,0,t.z);for(let t=0;t<r.count;t++){let r=t*3;i[r]+=(this.drift[r]+Math.sin(n*.3+t)*.05)*e,i[r+1]+=this.drift[r+1]*e,i[r+2]+=(this.drift[r+2]+Math.cos(n*.24+t)*.05)*e,i[r+1]>this.height&&(i[r+1]-=this.height);let o=i[r]-this.centre.x,s=i[r+2]-this.centre.z;o>a?i[r]-=this.extent:o<-a&&(i[r]+=this.extent),s>a?i[r+2]-=this.extent:s<-a&&(i[r+2]+=this.extent)}r.needsUpdate=!0}};function Ph(e,t){let n=new Fn;n.fog=new Pn(Eh,.017),n.background=new K(Eh),n.environment=jh(e),n.environmentIntensity=.85,n.add(kh()),n.add(Ah());let r=new To(4610431,2760467,.98);n.add(r);let i=new Wo(11585260,2.15);i.position.set(-16,22,-13),i.castShadow=!0,i.shadow.mapSize.set(2048,2048);let a=i.shadow.camera;a.left=-14,a.right=14,a.top=14,a.bottom=-14,a.near=1,a.far=60,i.shadow.bias=-7e-4,i.shadow.normalBias=.022,i.shadow.radius=3.2,n.add(i),n.add(i.target);let o=new Wo(16757626,.5);o.position.set(11,5,9),n.add(o);let s=[];if(t){t.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0)});let e=[];t.traverse(t=>{/^Light_Brazier/.test(t.name)&&e.push(t)}),t.updateMatrixWorld(!0);for(let t of e){let e=new Mh(new H().setFromMatrixPosition(t.matrixWorld));s.push(e),n.add(e.group)}n.add(t)}let c=new _i(new Ta(60,48),new Ua({color:1775392,roughness:1}));c.rotation.x=-Math.PI/2,c.position.y=-.02,c.receiveShadow=!0,n.add(c);let l=new Nh;return n.add(l.points),{scene:n,moon:i,braziers:s,hemi:r,motes:l}}var Fh={longsword:{file:`weapon_longsword.glb`,name:`Longsword`,lead:-.05,rear:-.16,tip:1.072,damageMul:1,trail:10470655},greatsword:{file:`weapon_greatsword.glb`,name:`Greatsword`,lead:-.075,rear:-.27,tip:1.2,damageMul:1.18,trail:13162239},daneaxe:{file:`weapon_daneaxe.glb`,name:`Dane Axe`,lead:0,rear:-.55,tip:.545,damageMul:1.12,trail:16757370},warhammer:{file:`weapon_warhammer.glb`,name:`War Hammer`,lead:.01,rear:-.42,tip:.52,damageMul:1.22,trail:16765066},spear:{file:`weapon_spear.glb`,name:`Winged Spear`,lead:.02,rear:-.4,tip:.86,damageMul:.9,trail:12576511},katana:{file:`weapon_katana.glb`,name:`Katana`,lead:-.06,rear:-.25,tip:.742,damageMul:1.05,trail:15267071}},Ih={warden:{file:`knight_warden.glb`,name:`Warden`,health:130,speedMul:1,herald:/_accent$/},warden_heavy:{file:`knight_warden_heavy.glb`,name:`Warden — Plate`,health:152,speedMul:.9,herald:/_accent$/},warden_light:{file:`knight_warden_light.glb`,name:`Warden — Mail`,health:112,speedMul:1.1,herald:/_accent$/},raider:{file:`knight_raider.glb`,name:`Raider`,health:130,speedMul:1,herald:/_hide$/},raider_heavy:{file:`knight_raider_heavy.glb`,name:`Raider — Chieftain`,health:152,speedMul:.9,herald:/_hide$/},raider_light:{file:`knight_raider_light.glb`,name:`Raider — Berserker`,health:112,speedMul:1.1,herald:/_hide$/}},Lh={compound:`models/compound.glb`,...Object.fromEntries(Object.entries(Ih).map(([e,t])=>[`armour_${e}`,`models/${t.file}`])),...Object.fromEntries(Object.entries(Fh).map(([e,t])=>[`weapon_${e}`,`models/${t.file}`]))},Rh=new Set([`compound`]),zh=new H,Bh=new H,Vh=new H;function Hh(){let e=Math.max(1,window.innerWidth||0),t=Math.max(1,window.innerHeight||0);return{w:e,h:t,aspect:e/t}}async function Uh(){let e=new Fu;e.setMeshoptDecoder(Pd);let t=await Promise.all(Object.entries(Lh).map(async([t,n])=>{try{return[t,await e.loadAsync(n)]}catch(e){if(Rh.has(t))return console.warn(`[art-of-battle] ${n} missing — using stand-in`,e),[t,null];throw e}}));return Object.fromEntries(t)}var Wh=class{constructor(e,t,n){this.renderer=t,this.assets=e;let r=Ph(t,e.compound?.scene??null);this.scene=r.scene,this.braziers=r.braziers,this.motes=r.motes,this.moon=r.moon;let i=Hh();this.camera=new Lo(72,i.aspect,.1,400),this.camera.layers.set(0),this.viewCam=new Lo(45,i.aspect,.02,14),this.viewCam.layers.set(1),this.viewCamBack=1.15;let a=new Vo(16769724,14,8,2);a.position.set(.55,.75,.9),a.layers.set(1);let o=new To(10335448,2760728,1.6);o.layers.set(1),this.viewCam.add(a,o),this.scene.add(this.viewCam),this.duelCam=new fp(this.camera),this.fpCam=new gp(this.camera),this.lockedOn=!1,this.lockOverride=!1,this.lostSight=0,this.post=new Tm({renderer:t,scene:this.scene,camera:this.camera,viewCam:this.viewCam}),this.score=new Um,this.compound=new Tp(this.scene,e.compound?.scene??null);let s=e.compound?.scene;if(s){let e=new Set;for(let t of this.compound.surfaces)t.node&&e.add(t.node);for(let t of this.compound.openings.values())t.node&&e.add(t.node);let t=kp(s,e);this.scene.add(t.group),this.batchStats=t}this.duelCam.collider=this.compound,this.vfx=new Th(this.scene),this.hud=new uh(n),this.siegeHud=new hh(this.hud),this.audio=new Rd,this.score.attach(this.audio),this.input=new ph(t.domElement),this.gadgets=new nh(this.scene,this.compound),this._buildFighters(),this.siege=new tp({player:this.player,enemy:this.enemy,compound:this.compound,duel:this.duel}),this.nav=new Gm(this.compound),this.ai.siege=this.siege,this.ai.gadgets=this.gadgets,this.ai.compound=this.compound,this.ai.nav=this.nav,this.time=0,this.timeScale=1,this.slowmo=0,this.fx={damage:0,lowHealth:0,hitFlash:0,slowmo:0},this.started=!1,this.paused=!1,this._move={x:0,y:0},this._prepAngle=0,this._scout={yaw:0,pitch:.85,dist:23,focus:new H(0,.5,0),idle:0},this.creator=new Bp({armours:Object.entries(Ih).map(([e,t])=>({key:e,...t})),weapons:Object.entries(Fh).map(([e,t])=>({key:e,...t}))}),this.mode=`create`,this.startMatch(),this.enterCreation()}_instance(e){let t=this.assets[e];return t?t.scene.clone(!0):null}_buildFighters(){let e=Fh.longsword,t=Fh.daneaxe,n=Ih.warden_heavy,r=Ih.raider_heavy;this.player=new $p({name:`Warden`,model:this._instance(`armour_warden_heavy`),weapon:this._instance(`weapon_longsword`),grip:e,profile:{damageMul:e.damageMul,leadHand:`R`,trail:e.trail,speedMul:n.speedMul},x:0,z:-14,yaw:0,health:n.health}),this.enemy=new $p({name:`Raider`,model:this._instance(`armour_raider_heavy`),weapon:this._instance(`weapon_daneaxe`),grip:t,profile:{damageMul:t.damageMul,leadHand:`R`,trail:t.trail,speedMul:r.speedMul},x:6,z:4,yaw:Math.PI,health:r.health}),this.player.collider=this.compound,this.enemy.collider=this.compound,this.player.rig.setFirstPerson(!0),this.player.freeLook=!0,this.scene.add(this.player.group,this.enemy.group),this.duel=new Sp(this.player,this.enemy),this.ai=new op(this.enemy,this.duel,`warrior`),this.fpCam.snap(this.player,this.enemy,!1)}enterCreation(){this.mode=`create`,this.siege.drain();let e=this.player;e.rig.setFirstPerson(!1),e.frozen=!0,e.freeLook=!0,e.pos.set(0,0,-15),e.velocity.set(0,0,0),e.setGuard(`right`),this.enemy.group.visible=!1,this.creator.dirty=!0}applyPlayerLoadout(){let e=this.creator,t=Ih[e.armour.key],n=Fh[e.weapon.key];this.player.setLoadout({model:this._instance(`armour_${e.armour.key}`),weapon:this._instance(`weapon_${e.weapon.key}`),grip:n,profile:{damageMul:n.damageMul,leadHand:`R`,trail:n.trail,speedMul:t.speedMul}}),Vp(this.player.rig,e.herald.hex,t.herald),this.player.traits=Np(e.archetypeKey,e.perkKeys),this.player.archetypeName=e.archetype.name,this.player.maxHealth=Math.round(t.health*this.player.traits.healthMul),this.player.health=this.player.maxHealth,this.vfx.trails.delete(this.player)}beginMatch(){this.applyPlayerLoadout(),this.player.name=(this.creator.name||``).trim()||`Warden`,this.player.rig.setFirstPerson(!0),this.player.frozen=!1,this.enemy.group.visible=!0,this.mode=`match`,this.startMatch()}_updateCreate(e,t){this.creator.dirty&&(this.applyPlayerLoadout(),this.creator.dirty=!1);let n=this.creator.handle(t);this.creator.update(e),this.creator.poseCamera(this.camera,this.player),this.player.update(e,this.enemy),this.player.events.length=0,this._renderFrame(e),this.hud.ctx.clearRect(0,0,this.hud.w,this.hud.h),this.creator.draw(this.hud,this.player),n&&this.beginMatch()}_rollEnemyBuild(){let e=e=>e[Math.random()*e.length|0],t=e(Pp),n=Fp.filter(e=>e!==`none`),r=e(n),i=e(n);for(;i===r;)i=e(n);this.enemy.traits=Np(t,[r,i]),this.enemyArchetype=Ap[t].name;let a=Ih.raider_heavy.health;this.enemy.maxHealth=Math.round(a*this.enemy.traits.healthMul),this.enemy.health=this.enemy.maxHealth,this.enemy.archetypeName=this.enemyArchetype}startMatch(){this.duel.over=!1,this.duel.winner=null,this._rollEnemyBuild(),this.siege.startMatch(),this.hud.messages.length=0,this.hud.floats.length=0;for(let e of this.vfx.trails.values())e.clear()}_onRoundStart(){this.duel.over=!1,this.duel.winner=null,this.gadgets.resetFor([this.player,this.enemy],e=>this.siege.roleOf(e)),this.ai.reset?.(),this.fpCam.snap(this.player,this.enemy,!1)}enemyVisible(){let e=this.player.pos,t=this.enemy.pos;return!(this.compound.losBlocked(e.x,e.z,t.x,t.z)||this.gadgets.smokeBlocks(e.x,e.z,t.x,t.z))}_gadgetTarget(e){let t=this.player,n=t.pos.x+Math.sin(t.yaw)*1.5,r=t.pos.z+Math.cos(t.yaw)*1.5;if(e===`barricade`){let e=null,t=2.6;for(let[i,a]of this.compound.openings){if(a.barricade)continue;let o=Math.hypot(n-a.cx,r-a.cz);o<t&&(t=o,e=i)}return e?{openingId:e}:null}if(e===`reinforce`){let e=this.compound.nearestSurface(n,r,2.2,e=>e.kind===`panel`&&e.soft&&!e.reinforced);return e?{surface:e.surface}:null}if(e===`breach`){let e=this.compound.nearestSurface(n,r,2.2,e=>e.kind===`panel`);return e?{surface:e.surface}:null}return{}}_updateLockOn(e){let t=this.player.pos.distanceTo(this.enemy.pos)<5.2;this.enemyVisible()?this.lostSight=0:this.lostSight+=e;let n=this.siege.phase===Q.ACTION&&this.player.alive&&this.enemy.alive&&!this.lockOverride&&t&&this.lostSight<.45;this.lockedOn=n,this.input.lockedOn=n,this.player.freeLook=!n,n?this.input.yaw=this.player.yaw:this.player.yaw=this.input.yaw}_handleInput(e,t=1/60){let n=this.input.move(this._move),r=this.player,i=this.siege.phase;if(e.gadgetSlot!=null&&this._useGadget(e.gadgetSlot),e.toggleLock&&(this.lockOverride=!this.lockOverride,this.hud.say(this.lockOverride?`FREE LOOK`:`LOCK ON`,`#c9d2de`,.8)),i===Q.PREP){r.moveInput.set(0,0),this._scoutInput(e,n,t);return}if(i!==Q.ACTION||!r.alive){r.moveInput.set(0,0);return}r.moveInput.set(n.x,n.y),this.lockedOn&&(r.setGuard(this.input.guard),e.guardChanged&&this.audio.play(`ui_stance`,{volume:.5})),e.light&&r.startAttack(`light`),e.heavy&&(this.duel.tryParry(r)||r.startAttack(`heavy`)),e.heavyReleased&&r.releaseCharge(),e.feint&&r.feint(),e.gb&&r.startGuardBreak(),e.dodge&&r.startDodge(n.x,n.y)}_useGadget(e){let t=this.siege.phase===Q.PREP?`prep`:`action`,n=this.gadgets.inventory.get(this.player)||{},r=Object.keys(n)[e];if(!r)return;let i=Ym[r];if(i.phase!==`any`&&i.phase!==t){this.hud.say(`${i.label} — WRONG PHASE`,lh.dim,.8);return}if(this.gadgets.remaining(this.player,r)<=0){this.hud.say(`NONE LEFT`,lh.dim,.7);return}let a=this._gadgetTarget(r);if(!a){this.hud.say(`NOTHING TO USE IT ON`,lh.dim,.9);return}this.gadgets.use(this.player,r,a)?this.hud.say(i.label.toUpperCase(),`#c9d2de`,.8):this.hud.say(`CANNOT PLACE THERE`,lh.dim,.9)}_pan(e){Bh.setFromMatrixColumn(this.camera.matrixWorld,0),zh.subVectors(e,this.camera.position);let t=Math.max(1,zh.length());return kt.clamp(zh.dot(Bh)/t*2.2,-1,1)}_processEvents(){let e=this.audio;for(let t of[this.player,this.enemy]){for(let n of t.events)switch(n.type){case`swing`:e.play(n.attack.type===`heavy`?`swing_heavy`:`swing_light`,{volume:.75,pan:this._pan(t.pos),rate:.94+Math.random()*.12});break;case`footstep`:{let r=t.feet[n.side];e.play(`footstep`,{volume:.28,pan:this._pan(r.world)}),t.velocity.lengthSq()>1.2&&this.vfx.dust(r.world,4,.8);break}case`dodge`:e.play(`dodge`,{volume:.6,pan:this._pan(t.pos)}),this.vfx.dust(zh.copy(t.pos).setY(.05),12,1.4);break;case`guardbreak`:e.play(`guardbreak`,{volume:.5,pan:this._pan(t.pos)});break;case`feint`:e.play(`ui_stance`,{volume:.7,rate:.7});break;case`unblockable`:this.vfx.unblockableTell(t.rig.bladeTip(zh)),e.play(`ui_stance`,{volume:.9,rate:.55}),t===this.enemy&&this.hud.say(`UNBLOCKABLE`,lh.unblock,.9);break;case`exhausted`:e.play(`stamina_empty`,{volume:.7}),t===this.player&&this.hud.say(`EXHAUSTED`,lh.staminaLow,1);break;case`death`:e.play(`death`,{volume:.9,pan:this._pan(t.pos)}),this.vfx.dust(zh.copy(t.pos).setY(.1),26,1.8);break}t.events.length=0}for(let t of this.duel.drain()){let n=t.point?this._pan(t.point):0;switch(t.type){case`hit`:t.defender===this.player?this.fx.damage=1:this.fx.hitFlash=1,e.play(`hit_flesh`,{volume:.95,pan:n}),zh.subVectors(t.defender.pos,t.attacker.pos).normalize(),this.vfx.bloodHit(t.point,zh,t.heavy),this.fpCam.kick(t.heavy?.55:.3,t.heavy?4:1.5),this.hud.float(t.point,`${t.damage}`,t.defender===this.player?`#ff6b5e`:`#ffe9c9`),e.duckMusic(.5,.4);break;case`block`:e.play(`hit_block`,{volume:.85,pan:n,rate:.92+Math.random()*.16}),zh.subVectors(t.defender.pos,t.attacker.pos).normalize(),this.vfx.clash(t.point,zh),this.fpCam.kick(t.heavy?.3:.16,t.heavy?1.5:0);break;case`parry`:this.fx.hitFlash=1,e.play(`parry`,{volume:1,pan:n}),this.vfx.parryBurst(t.point),this.fpCam.kick(.7,5),this.hud.say(`PARRY`,lh.parry,1,!0),this.score.sting(`parry`),this.slowmo=.34,e.duckMusic(.8,.6);break;case`gbhit`:e.play(`guardbreak`,{volume:.95,pan:n}),this.fpCam.kick(.35,2),this.hud.say(`GUARD BROKEN`,`#e8d9b0`,.9),this.vfx.dust(zh.copy(t.defender.pos).setY(.05),14,1.5);break;case`gbcounter`:e.play(`parry`,{volume:.8,pan:n,rate:.8}),this.hud.say(`COUNTERED`,lh.parry,.9),this.fpCam.kick(.4,2);break;case`whiff`:this._swingHitsWorld(t);break;case`dodged`:this.hud.say(`MISS`,`rgba(220,228,240,0.75)`,.6);break}}for(let t of this.gadgets.drain())switch(t.type){case`breached`:e.play(`hit_block`,{volume:1,rate:.45}),e.play(`death`,{volume:.55,rate:1.5}),this.fpCam.kick(.85,6),this.vfx.dust(t.pos,40,3.2),this.vfx.clash(t.pos,zh.set(0,1,0)),this.hud.say(`BREACH`,lh.unblock,1,!0),this.score.sting(`breach`);break;case`alarm`:e.play(`ui_stance`,{volume:1,rate:1.8}),this.hud.say(t.fighter===this.player?`ALARM TRIPPED`:`ALARM — THEY ARE CLOSE`,lh.unblock,1);break;case`caltrophit`:e.play(`hit_flesh`,{volume:.4,rate:1.6});break;case`gadget`:e.play(`ui_stance`,{volume:.6,rate:.9});break}for(let t of this.siege.drain())switch(t.type){case`roundstart`:this._onRoundStart(),this.hud.say(`ROUND ${t.round} — ${t.playerRole===Zf.ATTACK?`ATTACK`:`DEFEND`}`,t.playerRole===Zf.ATTACK?`#e08a3c`:`#6fb3ff`,2,!0);break;case`phase`:t.phase===Q.ACTION&&(this.hud.say(`FIGHT`,`#e8eef8`,1.2,!0),e.play(`victory`,{volume:.5,rate:.7}));break;case`objectivehit`:e.play(`hit_block`,{volume:.7,rate:.7}),this.vfx.clash(this.compound.objective.pos.clone().setY(1.4),zh.set(0,1,0)),t.broke&&(this.score.sting(`objective`),this.hud.say(`BANNER DOWN`,lh.unblock,1.4,!0),this.fpCam.kick(.7,4));break;case`roundend`:this.score.sting(t.winner===`player`?`roundwin`:`roundloss`),e.play(t.winner===`player`?`victory`:`defeat`,{volume:.9}),this.slowmo=1;break;case`matchend`:e.play(t.winner===`player`?`victory`:`defeat`,{volume:1});break}}_swingHitsWorld(e){let t=e.attacker,n=t.rig.bladeTip(new H),r=e.heavy;if(this.siege.strikeObjective(t,r?22:10))return;let i=this.compound.damageAt(n.x,n.z,.85,r?46:18);if(i.length){this.audio.play(`hit_block`,{volume:.5,rate:1.25});for(let e of i){let t=this.compound.centre(e.surface,new H);e.broken?(this.vfx.dust(t,22,2.4),this.vfx.clash(t,zh.set(0,1,0)),this.fpCam.kick(.3,1.5)):this.vfx.dust(t,5,1.2)}}}update(e){let t=this.input.flush();this.time+=e;for(let e of this.braziers)e.update(this.time);if(this.motes?.update(e,this.player.pos,this.time),this.mode===`create`){this._updateCreate(e,t),this._driveScore(e);return}if(t.pause&&(this.paused=!this.paused),t.restart&&this.siege.phase===Q.MATCH_OVER&&(this.startMatch(),this.paused=!1),t.cycleQuality&&this.post){let e=[`high`,`medium`,`off`],t=e[(e.indexOf(this.post.quality)+1)%e.length];this.post.setQuality(t),this.post.enabled=t!==`off`,this.hud.say(`GRAPHICS — ${t.toUpperCase()}`,`#c9d2de`,1.2)}t.difficulty&&!this.started&&(this.ai.setDifficulty(t.difficulty),this.hud.say(t.difficulty.toUpperCase(),`#c9d2de`,1.1));let n=!this.started||this.paused;if(n)this.player.update(0,this.enemy),this.enemy.update(0,this.player);else{this._updateLockOn(e),this._handleInput(t,e),this.slowmo>0&&(this.slowmo-=e);let n=this.slowmo>0?.28:1;this.timeScale+=(n-this.timeScale)*Math.min(1,e*(this.slowmo>0?22:6));let r=e*this.timeScale;this.duel.hitStop>0&&(this.duel.hitStop-=e,r*=.06),this.siege.update(r),this.ai.update(r),this.player.update(r,this.enemy),this.enemy.update(r,this.player),this.siege.phase===Q.ACTION&&this.duel.update(),this.gadgets.update(r,[this.player,this.enemy],this.time)}this._processEvents(),this.fx.damage=Math.max(0,this.fx.damage-e*1.8),this.fx.hitFlash=Math.max(0,this.fx.hitFlash-e*6),this.fx.slowmo+=(+(this.slowmo>0)-this.fx.slowmo)*Math.min(1,e*8);let r=this.player.health/Math.max(1,this.player.maxHealth);this.fx.lowHealth+=(Math.max(0,1-r/.35)-this.fx.lowHealth)*Math.min(1,e*3),this.post&&(this.post.damage=this.fx.damage,this.post.lowHealth=this.fx.lowHealth,this.post.hitFlash=this.fx.hitFlash,this.post.slowmo=this.fx.slowmo),this._driveScore(e),this.vfx.updateTrail(this.player,this.player.profile.trail),this.vfx.updateTrail(this.enemy,this.enemy.profile.trail),this.vfx.update(e,this.camera),this._updateCamera(e),this.moon.target.position.lerp(zh.copy(this.player.pos).lerp(this.enemy.pos,.5),.1),this.moon.position.copy(this.moon.target.position).add(zh.set(-16,22,-13)),this._renderFrame(e);let i=this.enemyVisible();this.hud.draw(e,{player:this.player,enemy:this.enemy,camera:this.camera,duel:this.duel,paused:n,started:this.started,showIndicator:i&&this.siege.phase===Q.ACTION}),this.siegeHud.draw(e,{siege:this.siege,compound:this.compound,gadgets:this.gadgets,player:this.player,enemy:this.enemy,camera:this.camera,enemyVisible:i,time:this.time})}_driveScore(e){if(!this.score)return;let t=`menu`,n=.15;if(this.mode===`match`){let e=this.siege.phase;if(e===Q.PREP)t=`prep`,n=.3;else if(e===Q.ACTION){let e=this.player.pos.distanceTo(this.enemy.pos),r=this.lockedOn||e<6;t=r?`combat`:`stalk`;let i=1-this.player.health/Math.max(1,this.player.maxHealth),a=kt.clamp(1-(e-2)/14,0,1);n=kt.clamp((r?.55:.2)+a*.25+i*.3,0,1)}else(e===Q.RESOLVE||e===Q.MATCH_OVER)&&(t=this.siege.lastResult?.winner===`player`?`victory`:`defeat`,n=.4)}this.score.setState(t),this.score.setIntensity(n),this.score.update(e)}_renderFrame(e=.016){let t=!!this.player.rig.firstPerson;if(t&&(this.viewCam.position.copy(this.camera.position).addScaledVector(this.camera.getWorldDirection(Vh),-this.viewCamBack),this.viewCam.quaternion.copy(this.camera.quaternion),this.viewCam.updateMatrixWorld(!0)),this.post?.enabled){this.post.viewmodel=t,this.post.render(e);return}let n=this.renderer;if(n.render(this.scene,this.camera),!t)return;let r=this.scene.background;this.scene.background=null,n.autoClear=!1,n.clearDepth(),n.render(this.scene,this.viewCam),n.autoClear=!0,this.scene.background=r}_scoutInput(e,t,n){let r=this._scout,i=t.x||t.y,a=this.input.yaw,o=this.input.pitch;if(a!==r._lastYaw||o!==r._lastPitch?r.idle=0:r.idle+=n,r._lastYaw=a,r._lastPitch=o,r.yaw=a,r.pitch=kt.clamp(.35+o*.9,.22,1.32),i){r.idle=0;let e=Math.cos(r.yaw),i=Math.sin(r.yaw),a=7*n;r.focus.x=kt.clamp(r.focus.x-(t.x*e+t.y*i)*a,-16,16),r.focus.z=kt.clamp(r.focus.z-(t.y*e-t.x*i)*a,-16,16)}(e.keys?.includes(`Enter`)||e.dodge)&&this.siege.skipPrep()&&this.hud.say(`THE HORN SOUNDS`,`#e0c45a`,1.2)}_updateCamera(e){if(this.siege.phase===Q.PREP){let t=this._scout;t.idle>1.5&&(this._prepAngle+=e*.12);let n=t.yaw+this._prepAngle,r=t.dist*Math.cos(t.pitch*.55);zh.set(t.focus.x+Math.sin(n)*r,6+Math.sin(t.pitch)*19,t.focus.z+Math.cos(n)*r),this.camera.position.lerp(zh,1-Math.exp(-6*e)),this.camera.lookAt(t.focus.x,.5,t.focus.z);return}this.fpCam.update(e,this.player,this.enemy,this.lockedOn)}};async function Gh(){let e=document.getElementById(`view`),t=document.getElementById(`hud`),n=document.getElementById(`loading`),r=new ku({canvas:e,antialias:!0,powerPreference:`high-performance`});r.setPixelRatio(Math.min(2,window.devicePixelRatio));let i=Hh();r.setSize(i.w,i.h),r.shadowMap.enabled=!0,r.shadowMap.type=1,r.toneMapping=4,r.toneMappingExposure=1.12;let a;try{a=await Uh()}catch(e){throw n.textContent=`Failed to load assets: ${e.message}`,e}let o=new Wh(a,r,t);window.__game=o,n.classList.add(`gone`),e.addEventListener(`click`,()=>{o.audio.unlock(),o.audio.startAmbience(),o.score.start(),o.started=!0,o.paused=!1}),window.addEventListener(`resize`,()=>{let{w:e,h:t,aspect:n}=Hh();o.camera.aspect=n,o.camera.updateProjectionMatrix(),o.viewCam.aspect=n,o.viewCam.updateProjectionMatrix(),r.setSize(e,t),o.post?.setSize(e,t)});let s=performance.now();r.setAnimationLoop(e=>{let t=Math.min(.05,(e-s)/1e3);s=e,o.update(t)})}Gh();